...
#ifdef MCAL_ENABLE_USER_MODE_SUPPORT
#ifndef __ICCARM__
/* Define the SVC handler in assembly, to ensure there is no extra PUSH instruction at the beginning
 * of the C handler.*/
...
/* stack pointer is passed to SVCHandler_main, it will be used to extract the parameter given to svc
 * call*/
...
void SVC_Handler(void)
{
    ASM_KEYWORD("tst lr, #4\n"
                ...
                "mrseq   r0, MSP\n"
                "mrsne   r0, PSP\n");
    /* stack pointer is passed to SVCHandler_main, it will be used to extract the parameter given to
     * svc call*/
    ASM_KEYWORD("b       SVCHandler_main");
}
#endif
...
{
    uint32
        svc_number; /* Stack contains:    * r0, r1, r2, r3, r12, r14, the return address and xPSR */
