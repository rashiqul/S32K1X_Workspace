...
#if (CDD_PLATFORM_SYSTEM_IP_TRUSTEDFUNCTIONS_VENDOR_ID !=                                          \
     CDD_PLATFORM_SYSTEM_IP_CFG_DEFINES_VENDOR_ID)
...
#if ((CDD_PLATFORM_SYSTEM_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION !=                                  \
      CDD_PLATFORM_SYSTEM_IP_CFG_DEFINES_SW_MAJOR_VERSION) ||                                      \
     (CDD_PLATFORM_SYSTEM_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION !=                                  \
      CDD_PLATFORM_SYSTEM_IP_CFG_DEFINES_SW_MINOR_VERSION) ||                                      \
     (CDD_PLATFORM_SYSTEM_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION !=                                  \
      CDD_PLATFORM_SYSTEM_IP_CFG_DEFINES_SW_PATCH_VERSION))
#error                                                                                             \
    "Software Version Numbers of System_Ip_TrustedFunctions.h and System_Ip_CfgDefines.h are different"
#endif
