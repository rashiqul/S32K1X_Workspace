...
#if (CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_VENDOR_ID !=                                         \
     CDD_PLATFORM_INTCTRL_IP_CFG_DEFINES_VENDOR_ID)
...
#if ((CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION !=                         \
      CDD_PLATFORM_INTCTRL_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION) ||                             \
     (CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION !=                         \
      CDD_PLATFORM_INTCTRL_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION) ||                             \
     (CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION !=                      \
      CDD_PLATFORM_INTCTRL_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION))
#error                                                                                             \
    "AutoSar Version Numbers of IntCtrl_Ip_TrustedFunctions.h and IntCtrl_Ip_CfgDefines.h are different"
#endif
/* Check if current file and IntCtrl_Ip_CfgDefines header file are of the same Software version */
#if ((CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION !=                                 \
      CDD_PLATFORM_INTCTRL_IP_CFG_DEFINES_SW_MAJOR_VERSION) ||                                     \
     (CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION !=                                 \
      CDD_PLATFORM_INTCTRL_IP_CFG_DEFINES_SW_MINOR_VERSION) ||                                     \
     (CDD_PLATFORM_INTCTRL_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION !=                                 \
      CDD_PLATFORM_INTCTRL_IP_CFG_DEFINES_SW_PATCH_VERSION))
#error                                                                                             \
    "Software Version Numbers of IntCtrl_Ip_TrustedFunctions.h and IntCtrl_Ip_CfgDefines.h are different"
#endif
...
#if ((STD_ON == INTCTRL_PLATFORM_ENABLE_USER_MODE_SUPPORT) &&                                      \
