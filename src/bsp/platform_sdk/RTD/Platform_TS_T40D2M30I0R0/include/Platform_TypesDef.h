...
#if ((CDD_PLATFORM_TYPESDEF_AR_RELEASE_MAJOR_VERSION !=                                            \
      CDD_PLATFORM_IPW_TYPESDEF_AR_RELEASE_MAJOR_VERSION) ||                                       \
     (CDD_PLATFORM_TYPESDEF_AR_RELEASE_MINOR_VERSION !=                                            \
      CDD_PLATFORM_IPW_TYPESDEF_AR_RELEASE_MINOR_VERSION) ||                                       \
     (CDD_PLATFORM_TYPESDEF_AR_RELEASE_REVISION_VERSION !=                                         \
