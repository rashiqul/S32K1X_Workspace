...
#if ((CDD_PLATFORM_MPU_IP_TYPES_DEF_AR_RELEASE_MAJOR_VERSION !=                                    \
      CDD_PLATFORM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION) ||                            \
     (CDD_PLATFORM_MPU_IP_TYPES_DEF_AR_RELEASE_MINOR_VERSION !=                                    \
      CDD_PLATFORM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION) ||                            \
     (CDD_PLATFORM_MPU_IP_TYPES_DEF_AR_RELEASE_REVISION_VERSION !=                                 \
      CDD_PLATFORM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION))
...
#if ((CDD_PLATFORM_MPU_IP_TYPES_DEF_SW_MAJOR_VERSION !=                                            \
      CDD_PLATFORM_MPU_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION) ||                                    \
     (CDD_PLATFORM_MPU_IP_TYPES_DEF_SW_MINOR_VERSION !=                                            \
      CDD_PLATFORM_MPU_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION) ||                                    \
     (CDD_PLATFORM_MPU_IP_TYPES_DEF_SW_PATCH_VERSION !=                                            \
      CDD_PLATFORM_MPU_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION))
...
#if ((CDD_PLATFORM_MPU_IP_CFG_AR_RELEASE_MAJOR_VERSION !=                                          \
      CDD_PLATFORM_MPU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION) ||                            \
...
#if ((CDD_PLATFORM_MPU_IP_CFG_SW_MAJOR_VERSION !=                                                  \
      CDD_PLATFORM_MPU_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION) ||                                    \
     (CDD_PLATFORM_MPU_IP_CFG_SW_MINOR_VERSION !=                                                  \
      CDD_PLATFORM_MPU_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION) ||                                    \
     (CDD_PLATFORM_MPU_IP_CFG_SW_PATCH_VERSION !=                                                  \
      CDD_PLATFORM_MPU_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION))
 ...
 */
extern void Mpu_Ip_SetRegionConfig_Privileged(const uint8 regionNumber,
 ...
 */
extern void Mpu_Ip_SetAccessMode_Privileged(uint8 u8RegionNum, Mpu_Ip_MasterType eMaster,
