 ...
 * @details        This type represents the slave error types that are detected during header
...
typedef enum {
    ...
    LINTRCV_WU_INTERNALLY, /**< @brief The transceiver has detected, that the network has been woken
                              up by the ECU via a request to NORMAL mode.*/
