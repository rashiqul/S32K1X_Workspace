...
#define RLM_REG_RMW8(address, mask, value)                                                         \
    (RLM_REG_WRITE8((address), ((RLM_REG_READ8(address) & ((uint8) ~(mask))) | (value))))
/**
...
#define RLM_REG_RMW16(address, mask, value)                                                        \
    (RLM_REG_WRITE16((address), ((RLM_REG_READ16(address) & ((uint16) ~(mask))) | (value))))
/**
...
#define RLM_REG_RMW32(address, mask, value)                                                        \
    (RLM_REG_WRITE32((address), ((RLM_REG_READ32(address) & ((uint32) ~(mask))) | (value))))
...
/* This will map the byte number with the offset, as the SLBR bytes are arranged in 3 2 1 0 order.
 * Replaces old expression (x%4 == 1 ? x+1 : (x%4 == 2 ? x-1 : (x%4 == 3 ? x-3 : x+3))) */
...
#define REG_SET_SOFT_LOCK8(baseAddr, regAddr, prot_mem)                                            \
    {                                                                                              \
        RLM_REG_WRITE8(SLBR_ADDR32((baseAddr), (regAddr), (prot_mem)),                             \
                       (uint8)(SLBR_SET_BIT_8BIT_REG_MASK_U8 >>                                    \
                               ((((regAddr) - (baseAddr)) & MODULO_4_BIT_MASK_U32) ^               \
                                SLBR_XOR_8BIT_REG_MASK_U8)));                                      \
    }
#else
#define REG_SET_SOFT_LOCK8(baseAddr, regAddr, prot_mem)
...
#define REG_SET_SOFT_LOCK16(baseAddr, regAddr, prot_mem)                                           \
    {                                                                                              \
        RLM_REG_WRITE8(SLBR_ADDR32((baseAddr), (regAddr), (prot_mem)),                             \
                       (uint8)(SLBR_SET_BIT_16BIT_REG_MASK_U8 >>                                   \
                               ((((regAddr) - (baseAddr)) & MODULO_4_BIT_MASK_U32) ^               \
                                SLBR_XOR_16BIT_REG_MASK_U8)));                                     \
    }
#else
#define REG_SET_SOFT_LOCK16(baseAddr, regAddr, prot_mem)
#endif /* (STD_ON == USER_MODE_REG_PROT_ENABLED) */
...
#define REG_SET_SOFT_LOCK32(baseAddr, regAddr, prot_mem)                                           \
    {                                                                                              \
        RLM_REG_WRITE8(SLBR_ADDR32((baseAddr), (regAddr), (prot_mem)),                             \
                       (uint8)(SLBR_SET_BIT_32BIT_REG_MASK_U8 >>                                   \
                               ((((regAddr) - (baseAddr)) & MODULO_4_BIT_MASK_U32) ^               \
                                SLBR_XOR_32BIT_REG_MASK_U8)));                                     \
    }
#else
#define REG_SET_SOFT_LOCK32(baseAddr, regAddr, prot_mem)
#endif /* (STD_ON == USER_MODE_REG_PROT_ENABLED) */
...
#define REG_CLR_SOFT_LOCK8(baseAddr, regAddr, prot_mem)                                            \
    {                                                                                              \
        RLM_REG_WRITE8(SLBR_ADDR32((baseAddr), (regAddr), (prot_mem)),                             \
                       (uint8)(SLBR_CLR_BIT_8BIT_REG_MASK_U8 >>                                    \
                               ((((regAddr) - (baseAddr)) & MODULO_4_BIT_MASK_U32) ^               \
                                SLBR_XOR_8BIT_REG_MASK_U8)));                                      \
    }
#else
...
#define REG_CLR_SOFT_LOCK16(baseAddr, regAddr, prot_mem)                                           \
    {                                                                                              \
        RLM_REG_WRITE8(SLBR_ADDR32((baseAddr), (regAddr), (prot_mem)),                             \
                       (uint8)(SLBR_CLR_BIT_16BIT_REG_MASK_U8 >>                                   \
                               ((((regAddr) - (baseAddr)) & MODULO_4_BIT_MASK_U32) ^               \
                                SLBR_XOR_16BIT_REG_MASK_U8)));                                     \
    }
#else
...
#define REG_CLR_SOFT_LOCK32(baseAddr, regAddr, prot_mem)                                           \
    {                                                                                              \
        RLM_REG_WRITE8(SLBR_ADDR32((baseAddr), (regAddr), (prot_mem)),                             \
                       (uint8)(SLBR_CLR_BIT_32BIT_REG_MASK_U8 >>                                   \
                               ((((regAddr) - (baseAddr)) & MODULO_4_BIT_MASK_U32) ^               \
                                SLBR_XOR_32BIT_REG_MASK_U8)));                                     \
    }
#else
...
#define REG_GET_SOFT_LOCK8(baseAddr, regAddr, prot_mem)                                            \
    ((uint8)((RLM_REG_READ8(SLBR_ADDR32((baseAddr), (regAddr), (prot_mem))) &                      \
              ((uint8)(SLBR_GET_BIT_8BIT_REG_MASK_U8 >>                                            \
                       ((((regAddr) - (baseAddr)) & MODULO_4_BIT_MASK_U32) ^                       \
                        SLBR_XOR_8BIT_REG_MASK_U8)))) != 0))
#else
...
#define REG_GET_SOFT_LOCK16(baseAddr, regAddr, prot_mem)                                           \
    ((uint8)((RLM_REG_READ8(SLBR_ADDR32((baseAddr), (regAddr), (prot_mem))) &                      \
              ((uint8)(SLBR_GET_BIT_16BIT_REG_MASK_U8 >>                                           \
                       ((((regAddr) - (baseAddr)) & MODULO_4_BIT_MASK_U32) ^                       \
                        SLBR_XOR_16BIT_REG_MASK_U8)))) != 0))
#else
...
#define REG_GET_SOFT_LOCK32(baseAddr, regAddr, prot_mem)                                           \
    ((uint8)((RLM_REG_READ8(SLBR_ADDR32((baseAddr), (regAddr), (prot_mem))) &                      \
              ((uint8)(SLBR_GET_BIT_32BIT_REG_MASK_U8 >>                                           \
                       ((((regAddr) - (baseAddr)) & MODULO_4_BIT_MASK_U32) ^                       \
                        SLBR_XOR_32BIT_REG_MASK_U8)))) != 0))
#else
...
#define REG_BIT_SET_LOCK8(baseAddr, regAddr, prot_mem, mask) RLM_REG_BIT_SET8((regAddr), (mask))
#endif /* (STD_ON == USER_MODE_REG_PROT_ENABLED) */
...
#define REG_BIT_SET_LOCK16(baseAddr, regAddr, prot_mem, mask) RLM_REG_BIT_SET16((regAddr), (mask))
#endif /* (STD_ON == USER_MODE_REG_PROT_ENABLED) */
...
#define REG_BIT_SET_LOCK32(baseAddr, regAddr, prot_mem, mask) RLM_REG_BIT_SET32((regAddr), (mask))
#endif /* (STD_ON == USER_MODE_REG_PROT_ENABLED) */
...
#define REG_BIT_CLEAR_LOCK8(baseAddr, regAddr, prot_mem, mask) RLM_REG_BIT_CLEAR8((regAddr), (mask))
#endif /* (STD_ON == USER_MODE_REG_PROT_ENABLED) */
...
#define REG_WRITE_LOCK8(baseAddr, regAddr, prot_mem, value) RLM_REG_WRITE8((regAddr), (value))
#endif /* (STD_ON == USER_MODE_REG_PROT_ENABLED) */
...
#define REG_WRITE_LOCK16(baseAddr, regAddr, prot_mem, value) RLM_REG_WRITE16((regAddr), (value))
#endif /* (STD_ON == USER_MODE_REG_PROT_ENABLED) */
...
#define REG_WRITE_LOCK32(baseAddr, regAddr, prot_mem, value) RLM_REG_WRITE32((regAddr), (value))
#endif /* (STD_ON == USER_MODE_REG_PROT_ENABLED) */
...
#define GET_HARD_LOCK(baseAddr, prot_mem)                                                          \
    ((uint8)(RLM_REG_BIT_GET32((baseAddr) + ((prot_mem)*GCR_OFFSET_U32),                           \
                               REGPROT_GCR_HLB_MASK_U32) >>                                        \
             REGPROT_GCR_HLB_POS_U32))
...
#define SET_USER_ACCESS_ALLOWED(baseAddr, prot_mem)                                                \
    RLM_REG_BIT_SET32(                                                                             \
        (baseAddr) + ((prot_mem) *                                                                 \
                      (((baseAddr) >= 0x55600000UL) ? (GCR_AE_OFFSET_U32) : (GCR_OFFSET_U32))),    \
        REGPROT_GCR_UAA_MASK_U32)
#else
...
#define GET_USER_ACCESS_ALLOWED(baseAddr, prot_mem)                                                \
    ((uint8)(RLM_REG_BIT_GET32(                                                                    \
                 (baseAddr) + ((prot_mem) * (((baseAddr) >= 0x55600000UL) ? (GCR_AE_OFFSET_U32)    \
                                                                          : (GCR_OFFSET_U32))),    \
                 REGPROT_GCR_UAA_MASK_U32) >>                                                      \
             REGPROT_GCR_UAA_POS_U32))
#else
