...
/*!
 * @file S32M24x_LPUART.h
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_LPUART
 *
...
#if !defined(S32M24x_LPUART_H_) /* Check if memory map has not been already included */
#define S32M24x_LPUART_H_
...
#define IP_LPUART_BASE_ADDRS                                                                       \
    {                                                                                              \
        IP_LPUART0_BASE, IP_LPUART1_BASE                                                           \
    }
/** Array initializer of LPUART peripheral base pointers */
#define IP_LPUART_BASE_PTRS                                                                        \
    {                                                                                              \
        IP_LPUART0, IP_LPUART1                                                                     \
    }
...
#endif /* #if !defined(S32M24x_LPUART_H_) */
