 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_WDOG
 *
...
#if !defined(S32M24x_WDOG_H_) /* Check if memory map has not been already included */
#define S32M24x_WDOG_H_
...
#define IP_WDOG_BASE_ADDRS                                                                         \
    {                                                                                              \
        IP_WDOG_BASE                                                                               \
    }
/** Array initializer of WDOG peripheral base pointers */
#define IP_WDOG_BASE_PTRS                                                                          \
    {                                                                                              \
        IP_WDOG                                                                                    \
    }
...
#endif /* #if !defined(S32M24x_WDOG_H_) */
