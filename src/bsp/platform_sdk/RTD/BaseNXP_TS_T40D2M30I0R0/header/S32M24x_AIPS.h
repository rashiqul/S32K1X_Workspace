 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_AIPS
 *
...
#if !defined(S32M24x_AIPS_H_) /* Check if memory map has not been already included */
#define S32M24x_AIPS_H_
...
#endif /* #if !defined(S32M24x_AIPS_H_) */
