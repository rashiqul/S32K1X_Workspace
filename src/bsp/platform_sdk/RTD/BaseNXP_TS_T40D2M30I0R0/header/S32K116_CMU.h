...
#define IP_CMU_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_CMU0_BASE, IP_CMU1_BASE                                                                 \
    }
/** Array initializer of CMU peripheral base pointers */
#define IP_CMU_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_CMU0, IP_CMU1                                                                           \
    }
...
#define CMU_RCCR_REF_CNT(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << CMU_RCCR_REF_CNT_SHIFT)) & CMU_RCCR_REF_CNT_MASK)
/*! @} */
...
#define CMU_HTCR_HFREF(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << CMU_HTCR_HFREF_SHIFT)) & CMU_HTCR_HFREF_MASK)
/*! @} */
...
#define CMU_LTCR_LFREF(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << CMU_LTCR_LFREF_SHIFT)) & CMU_LTCR_LFREF_MASK)
/*! @} */
...
#define CMU_IER_FLLAIE(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << CMU_IER_FLLAIE_SHIFT)) & CMU_IER_FLLAIE_MASK)

#define CMU_IER_FHHAIE_MASK (0x8U)
#define CMU_IER_FHHAIE_SHIFT (3U)
#define CMU_IER_FHHAIE_WIDTH (1U)
#define CMU_IER_FHHAIE(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << CMU_IER_FHHAIE_SHIFT)) & CMU_IER_FHHAIE_MASK)
/*! @} */
