 ...
 * @version 1.3
 * @date 2023-05-30
 * @brief Peripheral Access Layer for S32M24x_FTM
 *
...
#if !defined(S32M24x_FTM_H_) /* Check if memory map has not been already included */
#define S32M24x_FTM_H_
...
typedef struct {
    ...
    struct {           /* offset: 0xC, array step: 0x8 */
        __IO uint32_t
            CSC;          /**< Channel (n) Status And Control, array offset: 0xC, array step: 0x8 */
    ...
    __IO uint32_t QDCTRL;   /**< Quadrature Decoder Control And Status, offset: 0x80, available only
                               on: FTM1, FTM2 (missing on FTM0, FTM3) */
    ...
    __IO uint32_t MOD_MIRROR; /**< Mirror of Modulo Value, offset: 0x200, available only on: FTM1,
                                 FTM2 (missing on FTM0, FTM3) */
    __IO uint32_t CV_MIRROR[FTM_CV_MIRROR_COUNT]; /**< Mirror of Channel (n) Match Value, array
                                                     offset: 0x204, array step: 0x4, available only
                                                     on: FTM1, FTM2 (missing on FTM0, FTM3) */
...
#define IP_FTM_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_FTM0_BASE, IP_FTM1_BASE, IP_FTM2_BASE, IP_FTM3_BASE                                     \
    }
/** Array initializer of FTM peripheral base pointers */
#define IP_FTM_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_FTM0, IP_FTM1, IP_FTM2, IP_FTM3                                                         \
    }
...
#define FTM_CSC_TRIGMODE(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << FTM_CSC_TRIGMODE_SHIFT)) & FTM_CSC_TRIGMODE_MASK)
...
#endif /* #if !defined(S32M24x_FTM_H_) */
