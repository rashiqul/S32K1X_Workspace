...
/*!
 * @file S32M24x_LPTMR.h
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_LPTMR
 *
...
#if !defined(S32M24x_LPTMR_H_) /* Check if memory map has not been already included */
#define S32M24x_LPTMR_H_
...
#define IP_LPTMR_BASE_ADDRS                                                                        \
    {                                                                                              \
        IP_LPTMR0_BASE                                                                             \
    }
/** Array initializer of LPTMR peripheral base pointers */
#define IP_LPTMR_BASE_PTRS                                                                         \
    {                                                                                              \
        IP_LPTMR0                                                                                  \
    }
...
#endif /* #if !defined(S32M24x_LPTMR_H_) */
