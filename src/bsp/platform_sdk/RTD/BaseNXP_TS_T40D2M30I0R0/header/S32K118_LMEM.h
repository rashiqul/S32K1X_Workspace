 ...
 * @version 1.0
 * @date 2021-02-26
 * @brief Peripheral Access Layer for S32K118_LMEM
 *
...
#if !defined(S32K118_LMEM_H_) /* Check if memory map has not been already included */
#define S32K118_LMEM_H_
...
#endif /* #if !defined(S32K118_LMEM_H_) */
