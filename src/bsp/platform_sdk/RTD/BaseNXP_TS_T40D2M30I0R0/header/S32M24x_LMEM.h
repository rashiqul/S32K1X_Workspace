 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_LMEM
 *
...
#if !defined(S32M24x_LMEM_H_) /* Check if memory map has not been already included */
#define S32M24x_LMEM_H_
...
#define LMEM_PCCCR_ENCACHE(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << LMEM_PCCCR_ENCACHE_SHIFT)) & LMEM_PCCCR_ENCACHE_MASK)

#define LMEM_PCCCR_PCCR2_MASK (0x4U)
#define LMEM_PCCCR_PCCR2_SHIFT (2U)
#define LMEM_PCCCR_PCCR2_WIDTH (1U)
#define LMEM_PCCCR_PCCR2(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << LMEM_PCCCR_PCCR2_SHIFT)) & LMEM_PCCCR_PCCR2_MASK)

#define LMEM_PCCCR_PCCR3_MASK (0x8U)
#define LMEM_PCCCR_PCCR3_SHIFT (3U)
#define LMEM_PCCCR_PCCR3_WIDTH (1U)
#define LMEM_PCCCR_PCCR3(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << LMEM_PCCCR_PCCR3_SHIFT)) & LMEM_PCCCR_PCCR3_MASK)

#define LMEM_PCCCR_INVW0_MASK (0x1000000U)
#define LMEM_PCCCR_INVW0_SHIFT (24U)
#define LMEM_PCCCR_INVW0_WIDTH (1U)
#define LMEM_PCCCR_INVW0(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << LMEM_PCCCR_INVW0_SHIFT)) & LMEM_PCCCR_INVW0_MASK)

#define LMEM_PCCCR_PUSHW0_MASK (0x2000000U)
#define LMEM_PCCCR_PUSHW0_SHIFT (25U)
#define LMEM_PCCCR_PUSHW0_WIDTH (1U)
#define LMEM_PCCCR_PUSHW0(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << LMEM_PCCCR_PUSHW0_SHIFT)) & LMEM_PCCCR_PUSHW0_MASK)

#define LMEM_PCCCR_INVW1_MASK (0x4000000U)
#define LMEM_PCCCR_INVW1_SHIFT (26U)
#define LMEM_PCCCR_INVW1_WIDTH (1U)
#define LMEM_PCCCR_INVW1(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << LMEM_PCCCR_INVW1_SHIFT)) & LMEM_PCCCR_INVW1_MASK)

#define LMEM_PCCCR_PUSHW1_MASK (0x8000000U)
#define LMEM_PCCCR_PUSHW1_SHIFT (27U)
#define LMEM_PCCCR_PUSHW1_WIDTH (1U)
#define LMEM_PCCCR_PUSHW1(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << LMEM_PCCCR_PUSHW1_SHIFT)) & LMEM_PCCCR_PUSHW1_MASK)
...
#define LMEM_PCCLCR_LGO(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << LMEM_PCCLCR_LGO_SHIFT)) & LMEM_PCCLCR_LGO_MASK)
...
#define LMEM_PCCSAR_LGO(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << LMEM_PCCSAR_LGO_SHIFT)) & LMEM_PCCSAR_LGO_MASK)
...
#define LMEM_PCCCVR_DATA(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << LMEM_PCCCVR_DATA_SHIFT)) & LMEM_PCCCVR_DATA_MASK)
/*! @} */
...
#endif /* #if !defined(S32M24x_LMEM_H_) */
