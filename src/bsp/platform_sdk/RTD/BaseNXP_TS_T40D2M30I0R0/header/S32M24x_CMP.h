 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_CMP
 *
...
#if !defined(S32M24x_CMP_H_) /* Check if memory map has not been already included */
#define S32M24x_CMP_H_
...
#define IP_CMP_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_CMP0_BASE                                                                               \
    }
/** Array initializer of CMP peripheral base pointers */
#define IP_CMP_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_CMP0                                                                                    \
    }
...
#define CMP_C0_HYSTCTR(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << CMP_C0_HYSTCTR_SHIFT)) & CMP_C0_HYSTCTR_MASK)
...
#define CMP_C0_FILTER_CNT(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << CMP_C0_FILTER_CNT_SHIFT)) & CMP_C0_FILTER_CNT_MASK)
...
#define CMP_C2_INITMOD(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << CMP_C2_INITMOD_SHIFT)) & CMP_C2_INITMOD_MASK)
...
#endif /* #if !defined(S32M24x_CMP_H_) */
