 ...
 * @version 1.0
 * @date 2021-02-18
 * @brief Peripheral Access Layer for S32K116_NVIC
 *
...
#if !defined(S32K116_NVIC_H_) /* Check if memory map has not been already included */
#define S32K116_NVIC_H_
...
typedef struct {
    __IO uint32_t ISER[S32_NVIC_ISER_COUNT]; /**< Interrupt Set Enable Register, array offset: 0x0,
                                                array step: 0x4 */
    uint8_t RESERVED_0[124];
    __IO uint32_t ICER[S32_NVIC_ICER_COUNT]; /**< Interrupt Clear Enable Register, array offset:
                                                0x80, array step: 0x4 */
    uint8_t RESERVED_1[124];
    __IO uint32_t ISPR[S32_NVIC_ISPR_COUNT]; /**< Interrupt Set Pending Register, array offset:
                                                0x100, array step: 0x4 */
    uint8_t RESERVED_2[124];
    __IO uint32_t ICPR[S32_NVIC_ICPR_COUNT]; /**< Interrupt Clear Pending Register, array offset:
                                                0x180, array step: 0x4 */
    uint8_t RESERVED_3[380];
    __IO uint32_t IP[S32_NVIC_IPR_COUNT]; /**< Interrupt Priority Register n, array offset: 0x300,
                                             array step: 0x4 */
...
#define S32_NVIC_IPR_PRI_0(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << S32_NVIC_IPR_PRI_0_SHIFT)) & S32_NVIC_IPR_PRI_0_MASK)
#define S32_NVIC_IPR_PRI_1_MASK 0xFF00u
#define S32_NVIC_IPR_PRI_1_SHIFT 8u
#define S32_NVIC_IPR_PRI_1_WIDTH 8u
#define S32_NVIC_IPR_PRI_1(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << S32_NVIC_IPR_PRI_1_SHIFT)) & S32_NVIC_IPR_PRI_1_MASK)
#define S32_NVIC_IPR_PRI_2_MASK 0xFF0000u
#define S32_NVIC_IPR_PRI_2_SHIFT 16u
#define S32_NVIC_IPR_PRI_2_WIDTH 8u
#define S32_NVIC_IPR_PRI_2(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << S32_NVIC_IPR_PRI_2_SHIFT)) & S32_NVIC_IPR_PRI_2_MASK)
#define S32_NVIC_IPR_PRI_3_MASK 0xFF000000u
#define S32_NVIC_IPR_PRI_3_SHIFT 24u
#define S32_NVIC_IPR_PRI_3_WIDTH 8u
#define S32_NVIC_IPR_PRI_3(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << S32_NVIC_IPR_PRI_3_SHIFT)) & S32_NVIC_IPR_PRI_3_MASK)
...
#endif /* #if !defined(S32K116_NVIC_H_) */
