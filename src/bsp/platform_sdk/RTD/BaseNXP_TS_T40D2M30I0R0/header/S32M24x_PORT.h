 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_PORT
 *
...
#if !defined(S32M24x_PORT_H_) /* Check if memory map has not been already included */
#define S32M24x_PORT_H_
...
typedef struct {
    __IO uint32_t PCR[PORT_PCR_COUNT]; /**< Pin Control Register 0..Pin Control Register 31, array
...
#define IP_PORT_BASE_ADDRS                                                                         \
    {                                                                                              \
        IP_PORTA_BASE, IP_PORTB_BASE, IP_PORTC_BASE, IP_PORTD_BASE, IP_PORTE_BASE                  \
    }
/** Array initializer of PORT peripheral base pointers */
#define IP_PORT_BASE_PTRS                                                                          \
    {                                                                                              \
...
#define PORT_GICHR_GIWE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << PORT_GICHR_GIWE_SHIFT)) & PORT_GICHR_GIWE_MASK)

#define PORT_GICHR_GIWD_MASK (0xFFFF0000U)
#define PORT_GICHR_GIWD_SHIFT (16U)
#define PORT_GICHR_GIWD_WIDTH (16U)
#define PORT_GICHR_GIWD(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << PORT_GICHR_GIWD_SHIFT)) & PORT_GICHR_GIWD_MASK)
/*! @} */
...
#endif /* #if !defined(S32M24x_PORT_H_) */
