...
typedef struct {
    ...
    struct HVI_AE_UCTRL_ARRAY { /* offset: 0x14, array step: 0x4 */
        __IO uint16_t UCFG;     /**< Unit Configuration 0..Unit Configuration 1, array offset: 0x14,
                                   array step: 0x4 */
        __IO uint8_t
            UCTRL; /**< Unit Control 0..Unit Control 1, array offset: 0x16, array step: 0x4 */
        __IO uint8_t VMCFG; /**< Voltage Monitor Configuration 0, array offset: 0x17, array step:
                               0x4, valid indices: [0] */
...
#define IP_HVI_AE_BASE_ADDRS                                                                       \
    {                                                                                              \
        IP_HVI_AE_BASE                                                                             \
    }
/** Array initializer of HVI_AE peripheral base pointers */
#define IP_HVI_AE_BASE_PTRS                                                                        \
    {                                                                                              \
        IP_HVI_AE                                                                                  \
    }
...
#define HVI_AE_INTF_LDIF0(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_INTF_LDIF0_SHIFT)) & HVI_AE_INTF_LDIF0_MASK)

#define HVI_AE_INTF_HDIF0_MASK (0x100U)
#define HVI_AE_INTF_HDIF0_SHIFT (8U)
#define HVI_AE_INTF_HDIF0_WIDTH (1U)
#define HVI_AE_INTF_HDIF0(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_INTF_HDIF0_SHIFT)) & HVI_AE_INTF_HDIF0_MASK)

#define HVI_AE_INTF_DINIF0_MASK (0x10000U)
#define HVI_AE_INTF_DINIF0_SHIFT (16U)
#define HVI_AE_INTF_DINIF0_WIDTH (1U)
#define HVI_AE_INTF_DINIF0(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_INTF_DINIF0_SHIFT)) & HVI_AE_INTF_DINIF0_MASK)

#define HVI_AE_INTF_DINIF1_MASK (0x20000U)
#define HVI_AE_INTF_DINIF1_SHIFT (17U)
#define HVI_AE_INTF_DINIF1_WIDTH (1U)
#define HVI_AE_INTF_DINIF1(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_INTF_DINIF1_SHIFT)) & HVI_AE_INTF_DINIF1_MASK)
/*! @} */
...
#define HVI_AE_INTEN_LDIE0(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_INTEN_LDIE0_SHIFT)) & HVI_AE_INTEN_LDIE0_MASK)

#define HVI_AE_INTEN_HDIE0_MASK (0x100U)
#define HVI_AE_INTEN_HDIE0_SHIFT (8U)
#define HVI_AE_INTEN_HDIE0_WIDTH (1U)
#define HVI_AE_INTEN_HDIE0(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_INTEN_HDIE0_SHIFT)) & HVI_AE_INTEN_HDIE0_MASK)

#define HVI_AE_INTEN_DINIE0_MASK (0x10000U)
#define HVI_AE_INTEN_DINIE0_SHIFT (16U)
#define HVI_AE_INTEN_DINIE0_WIDTH (1U)
#define HVI_AE_INTEN_DINIE0(x)                                                                     \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_INTEN_DINIE0_SHIFT)) & HVI_AE_INTEN_DINIE0_MASK)

#define HVI_AE_INTEN_DINIE1_MASK (0x20000U)
#define HVI_AE_INTEN_DINIE1_SHIFT (17U)
#define HVI_AE_INTEN_DINIE1_WIDTH (1U)
#define HVI_AE_INTEN_DINIE1(x)                                                                     \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_INTEN_DINIE1_SHIFT)) & HVI_AE_INTEN_DINIE1_MASK)
/*! @} */
...
#define HVI_AE_STAT_LDS0(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_STAT_LDS0_SHIFT)) & HVI_AE_STAT_LDS0_MASK)

#define HVI_AE_STAT_HDS0_MASK (0x100U)
#define HVI_AE_STAT_HDS0_SHIFT (8U)
#define HVI_AE_STAT_HDS0_WIDTH (1U)
#define HVI_AE_STAT_HDS0(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_STAT_HDS0_SHIFT)) & HVI_AE_STAT_HDS0_MASK)

#define HVI_AE_STAT_DINS0_MASK (0x10000U)
#define HVI_AE_STAT_DINS0_SHIFT (16U)
#define HVI_AE_STAT_DINS0_WIDTH (1U)
#define HVI_AE_STAT_DINS0(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_STAT_DINS0_SHIFT)) & HVI_AE_STAT_DINS0_MASK)

#define HVI_AE_STAT_DINS1_MASK (0x20000U)
#define HVI_AE_STAT_DINS1_SHIFT (17U)
#define HVI_AE_STAT_DINS1_WIDTH (1U)
#define HVI_AE_STAT_DINS1(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_STAT_DINS1_SHIFT)) & HVI_AE_STAT_DINS1_MASK)
/*! @} */
...
#define HVI_AE_GCTRL_AINEN(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_GCTRL_AINEN_SHIFT)) & HVI_AE_GCTRL_AINEN_MASK)

#define HVI_AE_GCTRL_AINSEL_MASK (0x18U)
#define HVI_AE_GCTRL_AINSEL_SHIFT (3U)
#define HVI_AE_GCTRL_AINSEL_WIDTH (2U)
#define HVI_AE_GCTRL_AINSEL(x)                                                                     \
    (((uint32_t)(((uint32_t)(x)) << HVI_AE_GCTRL_AINSEL_SHIFT)) & HVI_AE_GCTRL_AINSEL_MASK)
/*! @} */
...
#define HVI_AE_UCFG_PDEN(x)                                                                        \
    (((uint16_t)(((uint16_t)(x)) << HVI_AE_UCFG_PDEN_SHIFT)) & HVI_AE_UCFG_PDEN_MASK)

#define HVI_AE_UCFG_PUEN_MASK (0x4U)
#define HVI_AE_UCFG_PUEN_SHIFT (2U)
#define HVI_AE_UCFG_PUEN_WIDTH (1U)
#define HVI_AE_UCFG_PUEN(x)                                                                        \
    (((uint16_t)(((uint16_t)(x)) << HVI_AE_UCFG_PUEN_SHIFT)) & HVI_AE_UCFG_PUEN_MASK)

#define HVI_AE_UCFG_DIVSEL_MASK (0x18U)
#define HVI_AE_UCFG_DIVSEL_SHIFT (3U)
#define HVI_AE_UCFG_DIVSEL_WIDTH (2U)
#define HVI_AE_UCFG_DIVSEL(x)                                                                      \
    (((uint16_t)(((uint16_t)(x)) << HVI_AE_UCFG_DIVSEL_SHIFT)) & HVI_AE_UCFG_DIVSEL_MASK)

#define HVI_AE_UCFG_DINEN_MASK (0x100U)
#define HVI_AE_UCFG_DINEN_SHIFT (8U)
#define HVI_AE_UCFG_DINEN_WIDTH (1U)
#define HVI_AE_UCFG_DINEN(x)                                                                       \
    (((uint16_t)(((uint16_t)(x)) << HVI_AE_UCFG_DINEN_SHIFT)) & HVI_AE_UCFG_DINEN_MASK)

#define HVI_AE_UCFG_DINPO_MASK (0x200U)
#define HVI_AE_UCFG_DINPO_SHIFT (9U)
#define HVI_AE_UCFG_DINPO_WIDTH (1U)
#define HVI_AE_UCFG_DINPO(x)                                                                       \
    (((uint16_t)(((uint16_t)(x)) << HVI_AE_UCFG_DINPO_SHIFT)) & HVI_AE_UCFG_DINPO_MASK)
/*! @} */
...
#define HVI_AE_UCTRL_EN(x)                                                                         \
    (((uint8_t)(((uint8_t)(x)) << HVI_AE_UCTRL_EN_SHIFT)) & HVI_AE_UCTRL_EN_MASK)

#define HVI_AE_UCTRL_CFGEN_MASK (0x2U)
#define HVI_AE_UCTRL_CFGEN_SHIFT (1U)
#define HVI_AE_UCTRL_CFGEN_WIDTH (1U)
#define HVI_AE_UCTRL_CFGEN(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << HVI_AE_UCTRL_CFGEN_SHIFT)) & HVI_AE_UCTRL_CFGEN_MASK)
/*! @} */
...
#define HVI_AE_VMCFG_LDEN(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << HVI_AE_VMCFG_LDEN_SHIFT)) & HVI_AE_VMCFG_LDEN_MASK)

#define HVI_AE_VMCFG_HDEN_MASK (0x2U)
#define HVI_AE_VMCFG_HDEN_SHIFT (1U)
#define HVI_AE_VMCFG_HDEN_WIDTH (1U)
#define HVI_AE_VMCFG_HDEN(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << HVI_AE_VMCFG_HDEN_SHIFT)) & HVI_AE_VMCFG_HDEN_MASK)

#define HVI_AE_VMCFG_LDREFSEL_MASK (0xCU)
#define HVI_AE_VMCFG_LDREFSEL_SHIFT (2U)
#define HVI_AE_VMCFG_LDREFSEL_WIDTH (2U)
#define HVI_AE_VMCFG_LDREFSEL(x)                                                                   \
    (((uint8_t)(((uint8_t)(x)) << HVI_AE_VMCFG_LDREFSEL_SHIFT)) & HVI_AE_VMCFG_LDREFSEL_MASK)

#define HVI_AE_VMCFG_HDREFSEL_MASK (0x20U)
#define HVI_AE_VMCFG_HDREFSEL_SHIFT (5U)
#define HVI_AE_VMCFG_HDREFSEL_WIDTH (1U)
#define HVI_AE_VMCFG_HDREFSEL(x)                                                                   \
    (((uint8_t)(((uint8_t)(x)) << HVI_AE_VMCFG_HDREFSEL_SHIFT)) & HVI_AE_VMCFG_HDREFSEL_MASK)

#define HVI_AE_VMCFG_VMINSEL_MASK (0x80U)
#define HVI_AE_VMCFG_VMINSEL_SHIFT (7U)
#define HVI_AE_VMCFG_VMINSEL_WIDTH (1U)
#define HVI_AE_VMCFG_VMINSEL(x)                                                                    \
    (((uint8_t)(((uint8_t)(x)) << HVI_AE_VMCFG_VMINSEL_SHIFT)) & HVI_AE_VMCFG_VMINSEL_MASK)
/*! @} */
