 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_ERM
 *
...
#if !defined(S32M24x_ERM_H_) /* Check if memory map has not been already included */
#define S32M24x_ERM_H_
...
typedef struct {
    ...
    struct ERM_EARn { /* offset: 0x100, array step: 0x10 */
        __I uint32_t
            EAR; /**< ERM Memory n Error Address Register, array offset: 0x100, array step: 0x10 */
        uint8_t RESERVED_0[12];
    } EARn[ERM_EARn_COUNT];
...
#define ERM_CR0_ENCIE1(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << ERM_CR0_ENCIE1_SHIFT)) & ERM_CR0_ENCIE1_MASK)

#define ERM_CR0_ESCIE1_MASK (0x8000000U)
#define ERM_CR0_ESCIE1_SHIFT (27U)
#define ERM_CR0_ESCIE1_WIDTH (1U)
#define ERM_CR0_ESCIE1(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << ERM_CR0_ESCIE1_SHIFT)) & ERM_CR0_ESCIE1_MASK)

#define ERM_CR0_ENCIE0_MASK (0x40000000U)
#define ERM_CR0_ENCIE0_SHIFT (30U)
#define ERM_CR0_ENCIE0_WIDTH (1U)
#define ERM_CR0_ENCIE0(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << ERM_CR0_ENCIE0_SHIFT)) & ERM_CR0_ENCIE0_MASK)

#define ERM_CR0_ESCIE0_MASK (0x80000000U)
#define ERM_CR0_ESCIE0_SHIFT (31U)
#define ERM_CR0_ESCIE0_WIDTH (1U)
#define ERM_CR0_ESCIE0(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << ERM_CR0_ESCIE0_SHIFT)) & ERM_CR0_ESCIE0_MASK)
/*! @} */
...
#endif /* #if !defined(S32M24x_ERM_H_) */
