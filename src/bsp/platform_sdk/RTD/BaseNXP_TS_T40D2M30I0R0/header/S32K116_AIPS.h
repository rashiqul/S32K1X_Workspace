...
#define AIPS_PACRB_TP7(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << AIPS_PACRB_TP7_SHIFT)) & AIPS_PACRB_TP7_MASK)

#define AIPS_PACRB_WP7_MASK (0x2U)
#define AIPS_PACRB_WP7_SHIFT (1U)
#define AIPS_PACRB_WP7_WIDTH (1U)
#define AIPS_PACRB_WP7(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << AIPS_PACRB_WP7_SHIFT)) & AIPS_PACRB_WP7_MASK)

#define AIPS_PACRB_SP7_MASK (0x4U)
#define AIPS_PACRB_SP7_SHIFT (2U)
#define AIPS_PACRB_SP7_WIDTH (1U)
#define AIPS_PACRB_SP7(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << AIPS_PACRB_SP7_SHIFT)) & AIPS_PACRB_SP7_MASK)
