 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_MSCM
 *
...
#if !defined(S32M24x_MSCM_H_) /* Check if memory map has not been already included */
#define S32M24x_MSCM_H_
...
typedef struct {
    ...
    __IO uint32_t OCMDR[MSCM_OCMDR_COUNT]; /**< On-Chip Memory Descriptor Register, array offset:
                                              0x400, array step: 0x4 */
...
#define MSCM_OCMDR_OCM1(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR_OCM1_SHIFT)) & MSCM_OCMDR_OCM1_MASK)

#define MSCM_OCMDR_OCMPU_MASK (0x1000U)
#define MSCM_OCMDR_OCMPU_SHIFT (12U)
#define MSCM_OCMDR_OCMPU_WIDTH (1U)
#define MSCM_OCMDR_OCMPU(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR_OCMPU_SHIFT)) & MSCM_OCMDR_OCMPU_MASK)

#define MSCM_OCMDR_OCMT_MASK (0xE000U)
#define MSCM_OCMDR_OCMT_SHIFT (13U)
#define MSCM_OCMDR_OCMT_WIDTH (3U)
#define MSCM_OCMDR_OCMT(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR_OCMT_SHIFT)) & MSCM_OCMDR_OCMT_MASK)
...
#define MSCM_OCMDR_OCMW(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR_OCMW_SHIFT)) & MSCM_OCMDR_OCMW_MASK)

#define MSCM_OCMDR_OCMSZ_MASK (0xF000000U)
#define MSCM_OCMDR_OCMSZ_SHIFT (24U)
#define MSCM_OCMDR_OCMSZ_WIDTH (4U)
#define MSCM_OCMDR_OCMSZ(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR_OCMSZ_SHIFT)) & MSCM_OCMDR_OCMSZ_MASK)

#define MSCM_OCMDR_OCMSZH_MASK (0x10000000U)
#define MSCM_OCMDR_OCMSZH_SHIFT (28U)
#define MSCM_OCMDR_OCMSZH_WIDTH (1U)
#define MSCM_OCMDR_OCMSZH(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << MSCM_OCMDR_OCMSZH_SHIFT)) & MSCM_OCMDR_OCMSZH_MASK)
...
#endif /* #if !defined(S32M24x_MSCM_H_) */
