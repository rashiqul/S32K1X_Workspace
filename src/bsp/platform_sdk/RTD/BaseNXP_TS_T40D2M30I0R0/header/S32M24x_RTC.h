 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_RTC
 *
...
#if !defined(S32M24x_RTC_H_) /* Check if memory map has not been already included */
#define S32M24x_RTC_H_
...
#define IP_RTC_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_RTC_BASE                                                                                \
    }
/** Array initializer of RTC peripheral base pointers */
#define IP_RTC_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_RTC                                                                                     \
    }
...
#endif /* #if !defined(S32M24x_RTC_H_) */
