 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_MPU
 *
...
#if !defined(S32M24x_MPU_H_) /* Check if memory map has not been already included */
#define S32M24x_MPU_H_
...
typedef struct {
    ...
    struct MPU_EAR_EDR {  /* offset: 0x10, array step: 0x8 */
        __I uint32_t EAR; /**< Error Address Register, slave port 0..Error Address Register, slave
                             port 3, array offset: 0x10, array step: 0x8 */
        __I uint32_t EDR; /**< Error Detail Register, slave port 0..Error Detail Register, slave
                             port 3, array offset: 0x14, array step: 0x8 */
    } EAR_EDR[MPU_EAR_EDR_COUNT];
    uint8_t RESERVED_1[976];
    struct MPU_RGD {         /* offset: 0x400, array step: 0x10 */
        __IO uint32_t WORD0; /**< Region Descriptor 0, Word 0..Region Descriptor 7, Word 0, array
                                offset: 0x400, array step: 0x10 */
        __IO uint32_t WORD1; /**< Region Descriptor 0, Word 1..Region Descriptor 7, Word 1, array
                                offset: 0x404, array step: 0x10 */
        __IO uint32_t WORD2; /**< Region Descriptor 0, Word 2..Region Descriptor 7, Word 2, array
                                offset: 0x408, array step: 0x10 */
        __IO uint32_t WORD3; /**< Region Descriptor 0, Word 3..Region Descriptor 7, Word 3, array
                                offset: 0x40C, array step: 0x10 */
    } RGD[MPU_RGD_COUNT];
    uint8_t RESERVED_2[896];
    __IO uint32_t RGDAAC[MPU_RGDAAC_COUNT]; /**< Region Descriptor Alternate Access Control
                                               0..Region Descriptor Alternate Access Control 7,
                                               array offset: 0x800, array step: 0x4 */
...
#define IP_MPU_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_MPU_BASE                                                                                \
    }
/** Array initializer of MPU peripheral base pointers */
#define IP_MPU_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_MPU                                                                                     \
    }
...
#define MPU_CESR_SPERR3(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_CESR_SPERR3_SHIFT)) & MPU_CESR_SPERR3_MASK)

#define MPU_CESR_SPERR2_MASK (0x20000000U)
#define MPU_CESR_SPERR2_SHIFT (29U)
#define MPU_CESR_SPERR2_WIDTH (1U)
#define MPU_CESR_SPERR2(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_CESR_SPERR2_SHIFT)) & MPU_CESR_SPERR2_MASK)

#define MPU_CESR_SPERR1_MASK (0x40000000U)
#define MPU_CESR_SPERR1_SHIFT (30U)
#define MPU_CESR_SPERR1_WIDTH (1U)
#define MPU_CESR_SPERR1(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_CESR_SPERR1_SHIFT)) & MPU_CESR_SPERR1_MASK)

#define MPU_CESR_SPERR0_MASK (0x80000000U)
#define MPU_CESR_SPERR0_SHIFT (31U)
#define MPU_CESR_SPERR0_WIDTH (1U)
#define MPU_CESR_SPERR0(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_CESR_SPERR0_SHIFT)) & MPU_CESR_SPERR0_MASK)
/*! @} */
...
#define MPU_RGD_WORD2_M0UM(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGD_WORD2_M0UM_SHIFT)) & MPU_RGD_WORD2_M0UM_MASK)
...
#define MPU_RGD_WORD2_M0SM(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGD_WORD2_M0SM_SHIFT)) & MPU_RGD_WORD2_M0SM_MASK)
...
#define MPU_RGD_WORD2_M4WE(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGD_WORD2_M4WE_SHIFT)) & MPU_RGD_WORD2_M4WE_MASK)
...
#define MPU_RGD_WORD3_VLD(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGD_WORD3_VLD_SHIFT)) & MPU_RGD_WORD3_VLD_MASK)
...
#define MPU_RGD_WORD3_PID(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGD_WORD3_PID_SHIFT)) & MPU_RGD_WORD3_PID_MASK)
/*! @} */

/*! @name RGDAAC - Region Descriptor Alternate Access Control 0..Region Descriptor Alternate Access
 * Control 7 */
/*! @{ */
...
#define MPU_RGDAAC_M0UM(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M0UM_SHIFT)) & MPU_RGDAAC_M0UM_MASK)

#define MPU_RGDAAC_M0SM_MASK (0x18U)
#define MPU_RGDAAC_M0SM_SHIFT (3U)
#define MPU_RGDAAC_M0SM_WIDTH (2U)
#define MPU_RGDAAC_M0SM(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M0SM_SHIFT)) & MPU_RGDAAC_M0SM_MASK)

#define MPU_RGDAAC_M0PE_MASK (0x20U)
#define MPU_RGDAAC_M0PE_SHIFT (5U)
#define MPU_RGDAAC_M0PE_WIDTH (1U)
#define MPU_RGDAAC_M0PE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M0PE_SHIFT)) & MPU_RGDAAC_M0PE_MASK)

#define MPU_RGDAAC_M1UM_MASK (0x1C0U)
#define MPU_RGDAAC_M1UM_SHIFT (6U)
#define MPU_RGDAAC_M1UM_WIDTH (3U)
#define MPU_RGDAAC_M1UM(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M1UM_SHIFT)) & MPU_RGDAAC_M1UM_MASK)

#define MPU_RGDAAC_M1SM_MASK (0x600U)
#define MPU_RGDAAC_M1SM_SHIFT (9U)
#define MPU_RGDAAC_M1SM_WIDTH (2U)
#define MPU_RGDAAC_M1SM(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M1SM_SHIFT)) & MPU_RGDAAC_M1SM_MASK)

#define MPU_RGDAAC_M1PE_MASK (0x800U)
#define MPU_RGDAAC_M1PE_SHIFT (11U)
#define MPU_RGDAAC_M1PE_WIDTH (1U)
#define MPU_RGDAAC_M1PE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M1PE_SHIFT)) & MPU_RGDAAC_M1PE_MASK)

#define MPU_RGDAAC_M2UM_MASK (0x7000U)
#define MPU_RGDAAC_M2UM_SHIFT (12U)
#define MPU_RGDAAC_M2UM_WIDTH (3U)
#define MPU_RGDAAC_M2UM(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M2UM_SHIFT)) & MPU_RGDAAC_M2UM_MASK)

#define MPU_RGDAAC_M2SM_MASK (0x18000U)
#define MPU_RGDAAC_M2SM_SHIFT (15U)
#define MPU_RGDAAC_M2SM_WIDTH (2U)
#define MPU_RGDAAC_M2SM(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M2SM_SHIFT)) & MPU_RGDAAC_M2SM_MASK)

#define MPU_RGDAAC_M3UM_MASK (0x1C0000U)
#define MPU_RGDAAC_M3UM_SHIFT (18U)
#define MPU_RGDAAC_M3UM_WIDTH (3U)
#define MPU_RGDAAC_M3UM(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M3UM_SHIFT)) & MPU_RGDAAC_M3UM_MASK)

#define MPU_RGDAAC_M3SM_MASK (0x600000U)
#define MPU_RGDAAC_M3SM_SHIFT (21U)
#define MPU_RGDAAC_M3SM_WIDTH (2U)
#define MPU_RGDAAC_M3SM(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M3SM_SHIFT)) & MPU_RGDAAC_M3SM_MASK)

#define MPU_RGDAAC_M4WE_MASK (0x1000000U)
#define MPU_RGDAAC_M4WE_SHIFT (24U)
#define MPU_RGDAAC_M4WE_WIDTH (1U)
#define MPU_RGDAAC_M4WE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M4WE_SHIFT)) & MPU_RGDAAC_M4WE_MASK)

#define MPU_RGDAAC_M4RE_MASK (0x2000000U)
#define MPU_RGDAAC_M4RE_SHIFT (25U)
#define MPU_RGDAAC_M4RE_WIDTH (1U)
#define MPU_RGDAAC_M4RE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M4RE_SHIFT)) & MPU_RGDAAC_M4RE_MASK)

#define MPU_RGDAAC_M5WE_MASK (0x4000000U)
#define MPU_RGDAAC_M5WE_SHIFT (26U)
#define MPU_RGDAAC_M5WE_WIDTH (1U)
#define MPU_RGDAAC_M5WE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M5WE_SHIFT)) & MPU_RGDAAC_M5WE_MASK)

#define MPU_RGDAAC_M5RE_MASK (0x8000000U)
#define MPU_RGDAAC_M5RE_SHIFT (27U)
#define MPU_RGDAAC_M5RE_WIDTH (1U)
#define MPU_RGDAAC_M5RE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M5RE_SHIFT)) & MPU_RGDAAC_M5RE_MASK)

#define MPU_RGDAAC_M6WE_MASK (0x10000000U)
#define MPU_RGDAAC_M6WE_SHIFT (28U)
#define MPU_RGDAAC_M6WE_WIDTH (1U)
#define MPU_RGDAAC_M6WE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M6WE_SHIFT)) & MPU_RGDAAC_M6WE_MASK)

#define MPU_RGDAAC_M6RE_MASK (0x20000000U)
#define MPU_RGDAAC_M6RE_SHIFT (29U)
#define MPU_RGDAAC_M6RE_WIDTH (1U)
#define MPU_RGDAAC_M6RE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M6RE_SHIFT)) & MPU_RGDAAC_M6RE_MASK)

#define MPU_RGDAAC_M7WE_MASK (0x40000000U)
#define MPU_RGDAAC_M7WE_SHIFT (30U)
#define MPU_RGDAAC_M7WE_WIDTH (1U)
#define MPU_RGDAAC_M7WE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M7WE_SHIFT)) & MPU_RGDAAC_M7WE_MASK)

#define MPU_RGDAAC_M7RE_MASK (0x80000000U)
#define MPU_RGDAAC_M7RE_SHIFT (31U)
#define MPU_RGDAAC_M7RE_WIDTH (1U)
#define MPU_RGDAAC_M7RE(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_RGDAAC_M7RE_SHIFT)) & MPU_RGDAAC_M7RE_MASK)
/*! @} */
...
#endif /* #if !defined(S32M24x_MPU_H_) */
