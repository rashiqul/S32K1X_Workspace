...
/*!
 * @file S32M24x_SYSTICK.h
 * @version 1.0
 * @date 2021-02-18
 * @brief Peripheral Access Layer for S32M24x_SYSTICK
 *
...
#if !defined(S32M24x_SYSTICK_H_) /* Check if memory map has not been already included */
#define S32M24x_SYSTICK_H_
...
#define S32_SysTick_CSR_CLKSOURCE(x)                                                               \
    (((uint32_t)(((uint32_t)(x)) << S32_SysTick_CSR_CLKSOURCE_SHIFT)) &                            \
...
#define S32_SysTick_CSR_COUNTFLAG(x)                                                               \
    (((uint32_t)(((uint32_t)(x)) << S32_SysTick_CSR_COUNTFLAG_SHIFT)) &                            \
...
#endif /* #if !defined(S32M24x_SYSTICK_H_) */
