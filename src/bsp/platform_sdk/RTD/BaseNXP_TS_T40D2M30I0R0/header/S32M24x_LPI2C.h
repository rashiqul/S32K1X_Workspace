...
/*!
 * @file S32M24x_LPI2C.h
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_LPI2C
 *
...
#if !defined(S32M24x_LPI2C_H_) /* Check if memory map has not been already included */
#define S32M24x_LPI2C_H_
...
#define IP_LPI2C_BASE_ADDRS                                                                        \
    {                                                                                              \
        IP_LPI2C0_BASE                                                                             \
    }
/** Array initializer of LPI2C peripheral base pointers */
#define IP_LPI2C_BASE_PTRS                                                                         \
    {                                                                                              \
        IP_LPI2C0                                                                                  \
    }
...
#endif /* #if !defined(S32M24x_LPI2C_H_) */
