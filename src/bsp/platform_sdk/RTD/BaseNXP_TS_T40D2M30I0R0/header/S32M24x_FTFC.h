 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_FTFC
 *
...
#if !defined(S32M24x_FTFC_H_) /* Check if memory map has not been already included */
#define S32M24x_FTFC_H_
...
typedef struct {
    ...
    __IO uint8_t FCCOB[FTFC_FCCOB_COUNT]; /**< Flash Common Command Object Registers, array offset:
                                             0x4, array step: 0x1 */
    __IO uint8_t FPROT[FTFC_FPROT_COUNT]; /**< Program Flash Protection Registers, array offset:
                                             0x10, array step: 0x1 */
...
#define FTFC_FSEC_FSLACC(x)                                                                        \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FSEC_FSLACC_SHIFT)) & FTFC_FSEC_FSLACC_MASK)

#define FTFC_FSEC_MEEN_MASK (0x30U)
#define FTFC_FSEC_MEEN_SHIFT (4U)
#define FTFC_FSEC_MEEN_WIDTH (2U)
#define FTFC_FSEC_MEEN(x)                                                                          \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FSEC_MEEN_SHIFT)) & FTFC_FSEC_MEEN_MASK)

#define FTFC_FSEC_KEYEN_MASK (0xC0U)
#define FTFC_FSEC_KEYEN_SHIFT (6U)
#define FTFC_FSEC_KEYEN_WIDTH (2U)
#define FTFC_FSEC_KEYEN(x)                                                                         \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FSEC_KEYEN_SHIFT)) & FTFC_FSEC_KEYEN_MASK)
/*! @} */
...
#define FTFC_FPROT_PROT(x)                                                                         \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FPROT_PROT_SHIFT)) & FTFC_FPROT_PROT_MASK)
/*! @} */
...
#define FTFC_FEPROT_EPROT(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FEPROT_EPROT_SHIFT)) & FTFC_FEPROT_EPROT_MASK)
/*! @} */
...
#define FTFC_FDPROT_DPROT(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FDPROT_DPROT_SHIFT)) & FTFC_FDPROT_DPROT_MASK)
/*! @} */
...
#define FTFC_FCSESTAT_BSY(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FCSESTAT_BSY_SHIFT)) & FTFC_FCSESTAT_BSY_MASK)

#define FTFC_FCSESTAT_SB_MASK (0x2U)
#define FTFC_FCSESTAT_SB_SHIFT (1U)
#define FTFC_FCSESTAT_SB_WIDTH (1U)
#define FTFC_FCSESTAT_SB(x)                                                                        \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FCSESTAT_SB_SHIFT)) & FTFC_FCSESTAT_SB_MASK)

#define FTFC_FCSESTAT_BIN_MASK (0x4U)
#define FTFC_FCSESTAT_BIN_SHIFT (2U)
#define FTFC_FCSESTAT_BIN_WIDTH (1U)
#define FTFC_FCSESTAT_BIN(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FCSESTAT_BIN_SHIFT)) & FTFC_FCSESTAT_BIN_MASK)

#define FTFC_FCSESTAT_BFN_MASK (0x8U)
#define FTFC_FCSESTAT_BFN_SHIFT (3U)
#define FTFC_FCSESTAT_BFN_WIDTH (1U)
#define FTFC_FCSESTAT_BFN(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FCSESTAT_BFN_SHIFT)) & FTFC_FCSESTAT_BFN_MASK)

#define FTFC_FCSESTAT_BOK_MASK (0x10U)
#define FTFC_FCSESTAT_BOK_SHIFT (4U)
#define FTFC_FCSESTAT_BOK_WIDTH (1U)
#define FTFC_FCSESTAT_BOK(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FCSESTAT_BOK_SHIFT)) & FTFC_FCSESTAT_BOK_MASK)

#define FTFC_FCSESTAT_RIN_MASK (0x20U)
#define FTFC_FCSESTAT_RIN_SHIFT (5U)
#define FTFC_FCSESTAT_RIN_WIDTH (1U)
#define FTFC_FCSESTAT_RIN(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FCSESTAT_RIN_SHIFT)) & FTFC_FCSESTAT_RIN_MASK)

#define FTFC_FCSESTAT_EDB_MASK (0x40U)
#define FTFC_FCSESTAT_EDB_SHIFT (6U)
#define FTFC_FCSESTAT_EDB_WIDTH (1U)
#define FTFC_FCSESTAT_EDB(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FCSESTAT_EDB_SHIFT)) & FTFC_FCSESTAT_EDB_MASK)

#define FTFC_FCSESTAT_IDB_MASK (0x80U)
#define FTFC_FCSESTAT_IDB_SHIFT (7U)
#define FTFC_FCSESTAT_IDB_WIDTH (1U)
#define FTFC_FCSESTAT_IDB(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FCSESTAT_IDB_SHIFT)) & FTFC_FCSESTAT_IDB_MASK)
/*! @} */
...
#define FTFC_FERSTAT_DFDIF(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FERSTAT_DFDIF_SHIFT)) & FTFC_FERSTAT_DFDIF_MASK)
/*! @} */
...
#define FTFC_FERCNFG_DFDIE(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FERCNFG_DFDIE_SHIFT)) & FTFC_FERCNFG_DFDIE_MASK)

#define FTFC_FERCNFG_FDFD_MASK (0x20U)
#define FTFC_FERCNFG_FDFD_SHIFT (5U)
#define FTFC_FERCNFG_FDFD_WIDTH (1U)
#define FTFC_FERCNFG_FDFD(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFC_FERCNFG_FDFD_SHIFT)) & FTFC_FERCNFG_FDFD_MASK)
/*! @} */
...
#endif /* #if !defined(S32M24x_FTFC_H_) */
