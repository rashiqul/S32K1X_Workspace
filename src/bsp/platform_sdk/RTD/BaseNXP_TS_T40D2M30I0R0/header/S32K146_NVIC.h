 ...
 * @version 1.0
 * @date 2021-02-18
 * @brief Peripheral Access Layer for S32K146_NVIC
 *
...
#if !defined(S32K146_NVIC_H_) /* Check if memory map has not been already included */
#define S32K146_NVIC_H_
...
#endif /* #if !defined(S32K146_NVIC_H_) */
