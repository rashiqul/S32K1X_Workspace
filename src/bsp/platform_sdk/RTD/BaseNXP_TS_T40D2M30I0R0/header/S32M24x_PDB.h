...
typedef struct {
    ...
    struct PDB_CH {       /* offset: 0x10, array step: 0x28 */
        __IO uint32_t C1; /**< Channel n Control register 1, array offset: 0x10, array step: 0x28,
                             available only on: PDB0 (missing on PDB1) */
        __IO uint32_t S;  /**< Channel n Status register, array offset: 0x14, array step: 0x28,
                             available only on: PDB0 (missing on PDB1) */
        __IO uint32_t
            DLY[PDB_DLY_COUNT]; /**< Channel n Delay 0 register..Channel n Delay 1 register, array
                                   offset: 0x18, array step: index*0x28, index2*0x4, available only
                                   on: PDB0 (missing on PDB1) */
    ...
    union {                             /* offset: 0x194, array step: 0x4 */
        ...
        __IO uint32_t
            PODLY; /**< Pulse-Out n Delay register, array offset: 0x194, array step: 0x4 */
...
#define IP_PDB_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_PDB0_BASE, IP_PDB1_BASE                                                                 \
    }
/** Array initializer of PDB peripheral base pointers */
#define IP_PDB_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_PDB0, IP_PDB1                                                                           \
    }
...
#define PDB_SC_PRESCALER(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << PDB_SC_PRESCALER_SHIFT)) & PDB_SC_PRESCALER_MASK)
