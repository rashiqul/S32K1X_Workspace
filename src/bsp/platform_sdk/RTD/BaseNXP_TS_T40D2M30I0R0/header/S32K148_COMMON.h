...
typedef enum {
    ...
    ENET_Timer_IRQn = 72, /**< 1588 Timer Interrupt - synchronous, Period EventTimer Overflow, Time
                             stamp available */
    ENET_TX_Buffer_IRQn = 73, /**< Data transfer done, Transmit Buffer Done for Ring/Queue 0,
                                 Transmit Frame Done for Ring/Queue 0 */
    ENET_RX_Buffer_IRQn =
        74, /**< Receive Buffer Done for Ring/Queue 0, Receive Frame Done for Ring/Queue 0 */
    ENET_PRE_IRQn = 75,   /**< Payload receive error, Collision retry limit reached, Late collision
                             detected, AXI Bus Error detected, Babbling transmit error, Babbling
                             receive error, Transmit FIFO underrun */
