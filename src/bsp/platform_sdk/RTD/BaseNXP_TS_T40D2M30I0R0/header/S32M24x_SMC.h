 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_SMC
 *
...
#if !defined(S32M24x_SMC_H_) /* Check if memory map has not been already included */
#define S32M24x_SMC_H_
...
#define IP_SMC_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_SMC_BASE                                                                                \
    }
/** Array initializer of SMC peripheral base pointers */
#define IP_SMC_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_SMC                                                                                     \
    }
...
#define SMC_PARAM_ELLS(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SMC_PARAM_ELLS_SHIFT)) & SMC_PARAM_ELLS_MASK)

#define SMC_PARAM_ELLS2_MASK (0x20U)
#define SMC_PARAM_ELLS2_SHIFT (5U)
#define SMC_PARAM_ELLS2_WIDTH (1U)
#define SMC_PARAM_ELLS2(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << SMC_PARAM_ELLS2_SHIFT)) & SMC_PARAM_ELLS2_MASK)

#define SMC_PARAM_EVLLS0_MASK (0x40U)
#define SMC_PARAM_EVLLS0_SHIFT (6U)
#define SMC_PARAM_EVLLS0_WIDTH (1U)
#define SMC_PARAM_EVLLS0(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << SMC_PARAM_EVLLS0_SHIFT)) & SMC_PARAM_EVLLS0_MASK)
/*! @} */
...
#endif /* #if !defined(S32M24x_SMC_H_) */
