...
/*!
 * @file S32K144W_NVIC.h
 * @version 1.0
 * @date 2021-02-18
 * @brief Peripheral Access Layer for S32K144W_NVIC
 *
...
#if !defined(S32K144W_NVIC_H_) /* Check if memory map has not been already included */
#define S32K144W_NVIC_H_
...
#endif /* #if !defined(S32K144W_NVIC_H_) */
