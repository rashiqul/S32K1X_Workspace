 ...
 * @version 1.0
 * @date 2021-02-18
 * @brief Peripheral Access Layer for S32K116_SCB
 *
...
#if !defined(S32K116_SCB_H_) /* Check if memory map has not been already included */
#define S32K116_SCB_H_
...
#endif /* #if !defined(S32K116_SCB_H_) */
