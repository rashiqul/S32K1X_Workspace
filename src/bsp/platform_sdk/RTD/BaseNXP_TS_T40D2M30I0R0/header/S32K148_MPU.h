...
typedef struct {
    ...
    struct {              /* offset: 0x10, array step: 0x8 */
        __I uint32_t EAR; /**< Error Address Register, slave port 0..Error Address Register, slave
                             port 4, array offset: 0x10, array step: 0x8 */
        __I uint32_t EDR; /**< Error Detail Register, slave port 0..Error Detail Register, slave
                             port 4, array offset: 0x14, array step: 0x8 */
    } EAR_EDR[MPU_EAR_EDR_COUNT];
    uint8_t RESERVED_1[968];
    struct {                 /* offset: 0x400, array step: 0x10 */
        __IO uint32_t WORD0; /**< Region Descriptor 0, Word 0..Region Descriptor 15, Word 0, array
                                offset: 0x400, array step: 0x10 */
        __IO uint32_t WORD1; /**< Region Descriptor 0, Word 1..Region Descriptor 15, Word 1, array
                                offset: 0x404, array step: 0x10 */
        __IO uint32_t WORD2; /**< Region Descriptor 0, Word 2..Region Descriptor 15, Word 2, array
                                offset: 0x408, array step: 0x10 */
        __IO uint32_t WORD3; /**< Region Descriptor 0, Word 3..Region Descriptor 15, Word 3, array
    ...
    __IO uint32_t RGDAAC[MPU_RGDAAC_COUNT]; /**< Region Descriptor Alternate Access Control
                                               0..Region Descriptor Alternate Access Control 15,
...
#define MPU_CESR_SPERR4(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << MPU_CESR_SPERR4_SHIFT)) & MPU_CESR_SPERR4_MASK)
