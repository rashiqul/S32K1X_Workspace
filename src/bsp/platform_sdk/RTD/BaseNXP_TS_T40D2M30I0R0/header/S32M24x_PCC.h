 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_PCC
 *
...
#if !defined(S32M24x_PCC_H_) /* Check if memory map has not been already included */
#define S32M24x_PCC_H_
...
typedef struct {
    __IO uint32_t
        PCCn[PCC_PCCn_COUNT]; /**< PCC FTFM Register..PCC CMP0 Register, array offset: 0x0, array
                                 step: 0x4, valid indices: [32-33, 36-39, 44-46, 49-50, 54-59, 61,
                                 64, 73-77, 90, 97, 102, 106-108, 115] */
...
#endif /* #if !defined(S32M24x_PCC_H_) */
