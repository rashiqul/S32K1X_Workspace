 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_SCG
 *
...
#if !defined(S32M24x_SCG_H_) /* Check if memory map has not been already included */
#define S32M24x_SCG_H_
...
#define IP_SCG_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_SCG_BASE                                                                                \
    }
/** Array initializer of SCG peripheral base pointers */
#define IP_SCG_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_SCG                                                                                     \
    }
...
#define SCG_SOSCCFG_EREFS(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << SCG_SOSCCFG_EREFS_SHIFT)) & SCG_SOSCCFG_EREFS_MASK)
...
#define SCG_SOSCCFG_RANGE(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << SCG_SOSCCFG_RANGE_SHIFT)) & SCG_SOSCCFG_RANGE_MASK)
/*! @} */
...
#define SCG_SPLLCSR_SPLLEN(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << SCG_SPLLCSR_SPLLEN_SHIFT)) & SCG_SPLLCSR_SPLLEN_MASK)

#define SCG_SPLLCSR_SPLLCM_MASK (0x10000U)
#define SCG_SPLLCSR_SPLLCM_SHIFT (16U)
#define SCG_SPLLCSR_SPLLCM_WIDTH (1U)
#define SCG_SPLLCSR_SPLLCM(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << SCG_SPLLCSR_SPLLCM_SHIFT)) & SCG_SPLLCSR_SPLLCM_MASK)
...
#define SCG_SPLLCSR_LK(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SCG_SPLLCSR_LK_SHIFT)) & SCG_SPLLCSR_LK_MASK)
...
#define SCG_SPLLCFG_SOURCE(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << SCG_SPLLCFG_SOURCE_SHIFT)) & SCG_SPLLCFG_SOURCE_MASK)
...
#define SCG_SPLLCFG_PREDIV(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << SCG_SPLLCFG_PREDIV_SHIFT)) & SCG_SPLLCFG_PREDIV_MASK)
...
#define SCG_SPLLCFG_MULT(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << SCG_SPLLCFG_MULT_SHIFT)) & SCG_SPLLCFG_MULT_MASK)
/*! @} */
...
#endif /* #if !defined(S32M24x_SCG_H_) */
