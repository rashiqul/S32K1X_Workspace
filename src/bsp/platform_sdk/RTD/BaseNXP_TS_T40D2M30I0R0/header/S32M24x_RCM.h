 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_RCM
 *
...
#if !defined(S32M24x_RCM_H_) /* Check if memory map has not been already included */
#define S32M24x_RCM_H_
...
#define IP_RCM_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_RCM_BASE                                                                                \
    }
/** Array initializer of RCM peripheral base pointers */
#define IP_RCM_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_RCM                                                                                     \
    }
...
#endif /* #if !defined(S32M24x_RCM_H_) */
