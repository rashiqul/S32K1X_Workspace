 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_GPIO
 *
...
#if !defined(S32M24x_GPIO_H_) /* Check if memory map has not been already included */
#define S32M24x_GPIO_H_
...
#define IP_GPIO_BASE_ADDRS                                                                         \
    {                                                                                              \
        IP_PTA_BASE, IP_PTB_BASE, IP_PTC_BASE, IP_PTD_BASE, IP_PTE_BASE                            \
    }
/** Array initializer of GPIO peripheral base pointers */
#define IP_GPIO_BASE_PTRS                                                                          \
    {                                                                                              \
...
#endif /* #if !defined(S32M24x_GPIO_H_) */
