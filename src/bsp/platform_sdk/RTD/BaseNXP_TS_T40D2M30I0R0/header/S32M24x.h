...
**
**  - rev. 1.4 Navdeep Singh 17-Oct-23  1)Initial release based on RM Rev 2.			                  
**										2)Names are added in all the
**										nested structures.
**								  		3)MEM_OTP_AE-							  
**								  		-ERROR register:						  
**								   		 -RDTRIES bitfield is removed.		  
**								  		4)PDB-	
**										-PDB_DLY_COUNT is changed form 8 to 2.
**										-PDB_CH_COUNT is changed from 4 to 2.							  	  
**								  		5)RCM-								  
**								  		-PARAM register:						  
**								   		 -ECMU_LOC bitfield is removed.         
**								  		-SRS register:						  
**								   		 -CMU_LOC bitfield is removed.          
** 							  			-SSRS register:						  
**								 		 -SCMU_LOC bitfield is removed.         
**								 		-SRIE register:						  
**								 		 -CMU_LOC bitfield is removed.
**
**     - rev. 1.5 Taru Shree 01-Aug-24  1)Initial release based on 
**                                      RM Rev.4.	
**                                      2)AEC_AE-                               
**                                      -LINPHY_MONITOR register:               
**                                       CXPI_ARBIT_FL, CXPI_ARBIT_MON and      
**                                       CXPI_ARBIT_EN bitfields are removed.   	
**
** ###################################################################
*/
