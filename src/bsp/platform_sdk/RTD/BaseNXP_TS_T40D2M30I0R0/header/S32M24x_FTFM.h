...
typedef struct {
    ...
    __IO uint8_t FCCOB[FTFM_FCCOB_COUNT]; /**< Flash Common Command Object Registers, array offset:
                                             0x4, array step: 0x1 */
    __IO uint8_t FPROT[FTFM_FPROT_COUNT]; /**< Program Flash Protection Registers, array offset:
                                             0x10, array step: 0x1 */
...
#define FTFM_FSTAT_MGSTAT0(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSTAT_MGSTAT0_SHIFT)) & FTFM_FSTAT_MGSTAT0_MASK)

#define FTFM_FSTAT_MGSTAT1_MASK (0x2U)
#define FTFM_FSTAT_MGSTAT1_SHIFT (1U)
#define FTFM_FSTAT_MGSTAT1_WIDTH (1U)
#define FTFM_FSTAT_MGSTAT1(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSTAT_MGSTAT1_SHIFT)) & FTFM_FSTAT_MGSTAT1_MASK)

#define FTFM_FSTAT_MGSTAT2_MASK (0x4U)
#define FTFM_FSTAT_MGSTAT2_SHIFT (2U)
#define FTFM_FSTAT_MGSTAT2_WIDTH (1U)
#define FTFM_FSTAT_MGSTAT2(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSTAT_MGSTAT2_SHIFT)) & FTFM_FSTAT_MGSTAT2_MASK)

#define FTFM_FSTAT_MGSTAT3_MASK (0x8U)
#define FTFM_FSTAT_MGSTAT3_SHIFT (3U)
#define FTFM_FSTAT_MGSTAT3_WIDTH (1U)
#define FTFM_FSTAT_MGSTAT3(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSTAT_MGSTAT3_SHIFT)) & FTFM_FSTAT_MGSTAT3_MASK)

#define FTFM_FSTAT_FPVIOL_MASK (0x10U)
#define FTFM_FSTAT_FPVIOL_SHIFT (4U)
#define FTFM_FSTAT_FPVIOL_WIDTH (1U)
#define FTFM_FSTAT_FPVIOL(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSTAT_FPVIOL_SHIFT)) & FTFM_FSTAT_FPVIOL_MASK)

#define FTFM_FSTAT_ACCERR_MASK (0x20U)
#define FTFM_FSTAT_ACCERR_SHIFT (5U)
#define FTFM_FSTAT_ACCERR_WIDTH (1U)
#define FTFM_FSTAT_ACCERR(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSTAT_ACCERR_SHIFT)) & FTFM_FSTAT_ACCERR_MASK)

#define FTFM_FSTAT_RDCOLERR_MASK (0x40U)
#define FTFM_FSTAT_RDCOLERR_SHIFT (6U)
#define FTFM_FSTAT_RDCOLERR_WIDTH (1U)
#define FTFM_FSTAT_RDCOLERR(x)                                                                     \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSTAT_RDCOLERR_SHIFT)) & FTFM_FSTAT_RDCOLERR_MASK)

#define FTFM_FSTAT_CCIF_MASK (0x80U)
#define FTFM_FSTAT_CCIF_SHIFT (7U)
#define FTFM_FSTAT_CCIF_WIDTH (1U)
#define FTFM_FSTAT_CCIF(x)                                                                         \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSTAT_CCIF_SHIFT)) & FTFM_FSTAT_CCIF_MASK)
/*! @} */
...
#define FTFM_FCNFG_EEERDY(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCNFG_EEERDY_SHIFT)) & FTFM_FCNFG_EEERDY_MASK)

#define FTFM_FCNFG_RAMRDY_MASK (0x2U)
#define FTFM_FCNFG_RAMRDY_SHIFT (1U)
#define FTFM_FCNFG_RAMRDY_WIDTH (1U)
#define FTFM_FCNFG_RAMRDY(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCNFG_RAMRDY_SHIFT)) & FTFM_FCNFG_RAMRDY_MASK)

#define FTFM_FCNFG_ERSSUSP_MASK (0x10U)
#define FTFM_FCNFG_ERSSUSP_SHIFT (4U)
#define FTFM_FCNFG_ERSSUSP_WIDTH (1U)
#define FTFM_FCNFG_ERSSUSP(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCNFG_ERSSUSP_SHIFT)) & FTFM_FCNFG_ERSSUSP_MASK)

#define FTFM_FCNFG_ERSAREQ_MASK (0x20U)
#define FTFM_FCNFG_ERSAREQ_SHIFT (5U)
#define FTFM_FCNFG_ERSAREQ_WIDTH (1U)
#define FTFM_FCNFG_ERSAREQ(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCNFG_ERSAREQ_SHIFT)) & FTFM_FCNFG_ERSAREQ_MASK)

#define FTFM_FCNFG_RDCOLLIE_MASK (0x40U)
#define FTFM_FCNFG_RDCOLLIE_SHIFT (6U)
#define FTFM_FCNFG_RDCOLLIE_WIDTH (1U)
#define FTFM_FCNFG_RDCOLLIE(x)                                                                     \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCNFG_RDCOLLIE_SHIFT)) & FTFM_FCNFG_RDCOLLIE_MASK)

#define FTFM_FCNFG_CCIE_MASK (0x80U)
#define FTFM_FCNFG_CCIE_SHIFT (7U)
#define FTFM_FCNFG_CCIE_WIDTH (1U)
#define FTFM_FCNFG_CCIE(x)                                                                         \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCNFG_CCIE_SHIFT)) & FTFM_FCNFG_CCIE_MASK)
/*! @} */
...
#define FTFM_FSEC_FSLACC(x)                                                                        \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSEC_FSLACC_SHIFT)) & FTFM_FSEC_FSLACC_MASK)

#define FTFM_FSEC_MEEN_MASK (0x30U)
#define FTFM_FSEC_MEEN_SHIFT (4U)
#define FTFM_FSEC_MEEN_WIDTH (2U)
#define FTFM_FSEC_MEEN(x)                                                                          \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSEC_MEEN_SHIFT)) & FTFM_FSEC_MEEN_MASK)

#define FTFM_FSEC_KEYEN_MASK (0xC0U)
#define FTFM_FSEC_KEYEN_SHIFT (6U)
#define FTFM_FSEC_KEYEN_WIDTH (2U)
#define FTFM_FSEC_KEYEN(x)                                                                         \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FSEC_KEYEN_SHIFT)) & FTFM_FSEC_KEYEN_MASK)
/*! @} */
...
#define FTFM_FCCOB_CCOBn(x)                                                                        \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCCOB_CCOBn_SHIFT)) & FTFM_FCCOB_CCOBn_MASK)
/*! @} */
...
#define FTFM_FPROT_PROT(x)                                                                         \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FPROT_PROT_SHIFT)) & FTFM_FPROT_PROT_MASK)
/*! @} */
...
#define FTFM_FEPROT_EPROT(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FEPROT_EPROT_SHIFT)) & FTFM_FEPROT_EPROT_MASK)
/*! @} */
...
#define FTFM_FDPROT_DPROT(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FDPROT_DPROT_SHIFT)) & FTFM_FDPROT_DPROT_MASK)
/*! @} */
...
#define FTFM_FCSESTAT1_BSY(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCSESTAT1_BSY_SHIFT)) & FTFM_FCSESTAT1_BSY_MASK)

#define FTFM_FCSESTAT1_SB_MASK (0x2U)
#define FTFM_FCSESTAT1_SB_SHIFT (1U)
#define FTFM_FCSESTAT1_SB_WIDTH (1U)
#define FTFM_FCSESTAT1_SB(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCSESTAT1_SB_SHIFT)) & FTFM_FCSESTAT1_SB_MASK)

#define FTFM_FCSESTAT1_BIN_MASK (0x4U)
#define FTFM_FCSESTAT1_BIN_SHIFT (2U)
#define FTFM_FCSESTAT1_BIN_WIDTH (1U)
#define FTFM_FCSESTAT1_BIN(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCSESTAT1_BIN_SHIFT)) & FTFM_FCSESTAT1_BIN_MASK)

#define FTFM_FCSESTAT1_BFN_MASK (0x8U)
#define FTFM_FCSESTAT1_BFN_SHIFT (3U)
#define FTFM_FCSESTAT1_BFN_WIDTH (1U)
#define FTFM_FCSESTAT1_BFN(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCSESTAT1_BFN_SHIFT)) & FTFM_FCSESTAT1_BFN_MASK)

#define FTFM_FCSESTAT1_BOK_MASK (0x10U)
#define FTFM_FCSESTAT1_BOK_SHIFT (4U)
#define FTFM_FCSESTAT1_BOK_WIDTH (1U)
#define FTFM_FCSESTAT1_BOK(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCSESTAT1_BOK_SHIFT)) & FTFM_FCSESTAT1_BOK_MASK)

#define FTFM_FCSESTAT1_RIN_MASK (0x20U)
#define FTFM_FCSESTAT1_RIN_SHIFT (5U)
#define FTFM_FCSESTAT1_RIN_WIDTH (1U)
#define FTFM_FCSESTAT1_RIN(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCSESTAT1_RIN_SHIFT)) & FTFM_FCSESTAT1_RIN_MASK)

#define FTFM_FCSESTAT1_EDB_MASK (0x40U)
#define FTFM_FCSESTAT1_EDB_SHIFT (6U)
#define FTFM_FCSESTAT1_EDB_WIDTH (1U)
#define FTFM_FCSESTAT1_EDB(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCSESTAT1_EDB_SHIFT)) & FTFM_FCSESTAT1_EDB_MASK)

#define FTFM_FCSESTAT1_IDB_MASK (0x80U)
#define FTFM_FCSESTAT1_IDB_SHIFT (7U)
#define FTFM_FCSESTAT1_IDB_WIDTH (1U)
#define FTFM_FCSESTAT1_IDB(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCSESTAT1_IDB_SHIFT)) & FTFM_FCSESTAT1_IDB_MASK)
/*! @} */
...
#define FTFM_FCSESTAT0_CMDTYPE(x)                                                                  \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCSESTAT0_CMDTYPE_SHIFT)) & FTFM_FCSESTAT0_CMDTYPE_MASK)

#define FTFM_FCSESTAT0_MEMERR_MASK (0x4U)
#define FTFM_FCSESTAT0_MEMERR_SHIFT (2U)
#define FTFM_FCSESTAT0_MEMERR_WIDTH (1U)
#define FTFM_FCSESTAT0_MEMERR(x)                                                                   \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FCSESTAT0_MEMERR_SHIFT)) & FTFM_FCSESTAT0_MEMERR_MASK)
/*! @} */
...
#define FTFM_FERSTAT_PDFDIF(x)                                                                     \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERSTAT_PDFDIF_SHIFT)) & FTFM_FERSTAT_PDFDIF_MASK)

#define FTFM_FERSTAT_DFDIF_MASK (0x2U)
#define FTFM_FERSTAT_DFDIF_SHIFT (1U)
#define FTFM_FERSTAT_DFDIF_WIDTH (1U)
#define FTFM_FERSTAT_DFDIF(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERSTAT_DFDIF_SHIFT)) & FTFM_FERSTAT_DFDIF_MASK)

#define FTFM_FERSTAT_EDFDIF_MASK (0x4U)
#define FTFM_FERSTAT_EDFDIF_SHIFT (2U)
#define FTFM_FERSTAT_EDFDIF_WIDTH (1U)
#define FTFM_FERSTAT_EDFDIF(x)                                                                     \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERSTAT_EDFDIF_SHIFT)) & FTFM_FERSTAT_EDFDIF_MASK)

#define FTFM_FERSTAT_CDFDIF_MASK (0x8U)
#define FTFM_FERSTAT_CDFDIF_SHIFT (3U)
#define FTFM_FERSTAT_CDFDIF_WIDTH (1U)
#define FTFM_FERSTAT_CDFDIF(x)                                                                     \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERSTAT_CDFDIF_SHIFT)) & FTFM_FERSTAT_CDFDIF_MASK)
/*! @} */
...
#define FTFM_FERCNFG_PDFDIE(x)                                                                     \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERCNFG_PDFDIE_SHIFT)) & FTFM_FERCNFG_PDFDIE_MASK)

#define FTFM_FERCNFG_DFDIE_MASK (0x2U)
#define FTFM_FERCNFG_DFDIE_SHIFT (1U)
#define FTFM_FERCNFG_DFDIE_WIDTH (1U)
#define FTFM_FERCNFG_DFDIE(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERCNFG_DFDIE_SHIFT)) & FTFM_FERCNFG_DFDIE_MASK)

#define FTFM_FERCNFG_EDFDIE_MASK (0x4U)
#define FTFM_FERCNFG_EDFDIE_SHIFT (2U)
#define FTFM_FERCNFG_EDFDIE_WIDTH (1U)
#define FTFM_FERCNFG_EDFDIE(x)                                                                     \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERCNFG_EDFDIE_SHIFT)) & FTFM_FERCNFG_EDFDIE_MASK)

#define FTFM_FERCNFG_CDFDIE_MASK (0x8U)
#define FTFM_FERCNFG_CDFDIE_SHIFT (3U)
#define FTFM_FERCNFG_CDFDIE_WIDTH (1U)
#define FTFM_FERCNFG_CDFDIE(x)                                                                     \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERCNFG_CDFDIE_SHIFT)) & FTFM_FERCNFG_CDFDIE_MASK)

#define FTFM_FERCNFG_PFDFD_MASK (0x10U)
#define FTFM_FERCNFG_PFDFD_SHIFT (4U)
#define FTFM_FERCNFG_PFDFD_WIDTH (1U)
#define FTFM_FERCNFG_PFDFD(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERCNFG_PFDFD_SHIFT)) & FTFM_FERCNFG_PFDFD_MASK)

#define FTFM_FERCNFG_FDFD_MASK (0x20U)
#define FTFM_FERCNFG_FDFD_SHIFT (5U)
#define FTFM_FERCNFG_FDFD_WIDTH (1U)
#define FTFM_FERCNFG_FDFD(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERCNFG_FDFD_SHIFT)) & FTFM_FERCNFG_FDFD_MASK)

#define FTFM_FERCNFG_EFDFD_MASK (0x40U)
#define FTFM_FERCNFG_EFDFD_SHIFT (6U)
#define FTFM_FERCNFG_EFDFD_WIDTH (1U)
#define FTFM_FERCNFG_EFDFD(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERCNFG_EFDFD_SHIFT)) & FTFM_FERCNFG_EFDFD_MASK)

#define FTFM_FERCNFG_CFDFD_MASK (0x80U)
#define FTFM_FERCNFG_CFDFD_SHIFT (7U)
#define FTFM_FERCNFG_CFDFD_WIDTH (1U)
#define FTFM_FERCNFG_CFDFD(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << FTFM_FERCNFG_CFDFD_SHIFT)) & FTFM_FERCNFG_CFDFD_MASK)
/*! @} */
