 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_MCM
 *
...
#if !defined(S32M24x_MCM_H_) /* Check if memory map has not been already included */
#define S32M24x_MCM_H_
...
typedef struct {
    ...
    __IO uint32_t LMDR[MCM_LMDR_COUNT]; /**< Local Memory Descriptor Register, array offset: 0x400,
                                           array step: 0x4 */
...
#define IP_MCM_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_MCM_BASE                                                                                \
    }
/** Array initializer of MCM peripheral base pointers */
#define IP_MCM_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_MCM                                                                                     \
    }
...
#define MCM_CPCR_AXBS_HLTD(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << MCM_CPCR_AXBS_HLTD_SHIFT)) & MCM_CPCR_AXBS_HLTD_MASK)
...
#define MCM_CPCR_SRAMUAP(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << MCM_CPCR_SRAMUAP_SHIFT)) & MCM_CPCR_SRAMUAP_MASK)

#define MCM_CPCR_SRAMUWP_MASK (0x4000000U)
#define MCM_CPCR_SRAMUWP_SHIFT (26U)
#define MCM_CPCR_SRAMUWP_WIDTH (1U)
#define MCM_CPCR_SRAMUWP(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << MCM_CPCR_SRAMUWP_SHIFT)) & MCM_CPCR_SRAMUWP_MASK)

#define MCM_CPCR_SRAMLAP_MASK (0x30000000U)
#define MCM_CPCR_SRAMLAP_SHIFT (28U)
#define MCM_CPCR_SRAMLAP_WIDTH (2U)
#define MCM_CPCR_SRAMLAP(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << MCM_CPCR_SRAMLAP_SHIFT)) & MCM_CPCR_SRAMLAP_MASK)

#define MCM_CPCR_SRAMLWP_MASK (0x40000000U)
#define MCM_CPCR_SRAMLWP_SHIFT (30U)
#define MCM_CPCR_SRAMLWP_WIDTH (1U)
#define MCM_CPCR_SRAMLWP(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << MCM_CPCR_SRAMLWP_SHIFT)) & MCM_CPCR_SRAMLWP_MASK)
/*! @} */
...
#define MCM_LMDR_LMSZH(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << MCM_LMDR_LMSZH_SHIFT)) & MCM_LMDR_LMSZH_MASK)
...
#define MCM_LMDR2_LOCK(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << MCM_LMDR2_LOCK_SHIFT)) & MCM_LMDR2_LOCK_MASK)
...
#define MCM_LMPECR_ERNCR(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << MCM_LMPECR_ERNCR_SHIFT)) & MCM_LMPECR_ERNCR_MASK)

#define MCM_LMPECR_ER1BR_MASK (0x100U)
#define MCM_LMPECR_ER1BR_SHIFT (8U)
#define MCM_LMPECR_ER1BR_WIDTH (1U)
#define MCM_LMPECR_ER1BR(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << MCM_LMPECR_ER1BR_SHIFT)) & MCM_LMPECR_ER1BR_MASK)
...
#define MCM_LMPEIR_ENC(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << MCM_LMPEIR_ENC_SHIFT)) & MCM_LMPEIR_ENC_MASK)

#define MCM_LMPEIR_E1B_MASK (0xFF00U)
#define MCM_LMPEIR_E1B_SHIFT (8U)
#define MCM_LMPEIR_E1B_WIDTH (8U)
#define MCM_LMPEIR_E1B(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << MCM_LMPEIR_E1B_SHIFT)) & MCM_LMPEIR_E1B_MASK)
...
#define MCM_LMFATR_PEFMST(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << MCM_LMFATR_PEFMST_SHIFT)) & MCM_LMFATR_PEFMST_MASK)
...
#endif /* #if !defined(S32M24x_MCM_H_) */
