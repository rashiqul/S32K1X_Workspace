 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_EWM
 *
...
#if !defined(S32M24x_EWM_H_) /* Check if memory map has not been already included */
#define S32M24x_EWM_H_
...
#define IP_EWM_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_EWM_BASE                                                                                \
    }
/** Array initializer of EWM peripheral base pointers */
#define IP_EWM_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_EWM                                                                                     \
    }
...
#endif /* #if !defined(S32M24x_EWM_H_) */
