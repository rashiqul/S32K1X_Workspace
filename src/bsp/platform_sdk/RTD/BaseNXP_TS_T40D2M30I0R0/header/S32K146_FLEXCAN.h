...
#define IP_FLEXCAN_BASE_ADDRS                                                                      \
    {                                                                                              \
        IP_FLEXCAN0_BASE, IP_FLEXCAN1_BASE, IP_FLEXCAN2_BASE                                       \
    }
/** Array initializer of FLEXCAN peripheral base pointers */
#define IP_FLEXCAN_BASE_PTRS                                                                       \
    {                                                                                              \
        IP_FLEXCAN0, IP_FLEXCAN1, IP_FLEXCAN2                                                      \
    }
...
#define FLEXCAN_MCR_DOZE(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << FLEXCAN_MCR_DOZE_SHIFT)) & FLEXCAN_MCR_DOZE_MASK)
...
#define FLEXCAN_IMASK1_BUF15TO0M(x)                                                                \
    (((uint32_t)(((uint32_t)(x)) << FLEXCAN_IMASK1_BUF15TO0M_SHIFT)) &                             \
     FLEXCAN_IMASK1_BUF15TO0M_MASK)
...
#define FLEXCAN_IFLAG1_BUF15TO8I(x)                                                                \
    (((uint32_t)(((uint32_t)(x)) << FLEXCAN_IFLAG1_BUF15TO8I_SHIFT)) &                             \
     FLEXCAN_IFLAG1_BUF15TO8I_MASK)
...
#define FLEXCAN_CBT_ERJW_MASK                                                                      \
    (0x1F0000U) /* Merged from fields with different position or width, of widths (4, 5), largest  \
                   definition used */
#define FLEXCAN_CBT_ERJW_SHIFT (16U)
#define FLEXCAN_CBT_ERJW_WIDTH (5U)
#define FLEXCAN_CBT_ERJW(x)                                                                        \
    (((uint32_t)(((uint32_t)(x)) << FLEXCAN_CBT_ERJW_SHIFT)) &                                     \
     FLEXCAN_CBT_ERJW_MASK) /* Merged from fields with different position or width, of widths (4,  \
                               5), largest definition used */
