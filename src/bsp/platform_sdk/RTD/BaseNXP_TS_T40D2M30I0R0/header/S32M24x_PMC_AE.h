...
#define IP_PMC_AE_BASE_ADDRS                                                                       \
    {                                                                                              \
        IP_PMC_AE_BASE                                                                             \
    }
/** Array initializer of PMC_AE peripheral base pointers */
#define IP_PMC_AE_BASE_PTRS                                                                        \
    {                                                                                              \
        IP_PMC_AE                                                                                  \
    }
...
#define PMC_AE_CONFIG_VDDSEL5V(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_CONFIG_VDDSEL5V_SHIFT)) & PMC_AE_CONFIG_VDDSEL5V_MASK)

#define PMC_AE_CONFIG_VPREINT_MASK (0x2U)
#define PMC_AE_CONFIG_VPREINT_SHIFT (1U)
#define PMC_AE_CONFIG_VPREINT_WIDTH (1U)
#define PMC_AE_CONFIG_VPREINT(x)                                                                   \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_CONFIG_VPREINT_SHIFT)) & PMC_AE_CONFIG_VPREINT_MASK)

#define PMC_AE_CONFIG_VPREEXT_MASK (0x4U)
#define PMC_AE_CONFIG_VPREEXT_SHIFT (2U)
#define PMC_AE_CONFIG_VPREEXT_WIDTH (1U)
#define PMC_AE_CONFIG_VPREEXT(x)                                                                   \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_CONFIG_VPREEXT_SHIFT)) & PMC_AE_CONFIG_VPREEXT_MASK)

#define PMC_AE_CONFIG_VDDCEN_MASK (0x8U)
#define PMC_AE_CONFIG_VDDCEN_SHIFT (3U)
#define PMC_AE_CONFIG_VDDCEN_WIDTH (1U)
#define PMC_AE_CONFIG_VDDCEN(x)                                                                    \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_CONFIG_VDDCEN_SHIFT)) & PMC_AE_CONFIG_VDDCEN_MASK)

#define PMC_AE_CONFIG_LINSUPSEL_MASK (0x10U)
#define PMC_AE_CONFIG_LINSUPSEL_SHIFT (4U)
#define PMC_AE_CONFIG_LINSUPSEL_WIDTH (1U)
#define PMC_AE_CONFIG_LINSUPSEL(x)                                                                 \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_CONFIG_LINSUPSEL_SHIFT)) & PMC_AE_CONFIG_LINSUPSEL_MASK)

#define PMC_AE_CONFIG_LVDVLSSEL_MASK (0x20U)
#define PMC_AE_CONFIG_LVDVLSSEL_SHIFT (5U)
#define PMC_AE_CONFIG_LVDVLSSEL_WIDTH (1U)
#define PMC_AE_CONFIG_LVDVLSSEL(x)                                                                 \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_CONFIG_LVDVLSSEL_SHIFT)) & PMC_AE_CONFIG_LVDVLSSEL_MASK)

#define PMC_AE_CONFIG_LINSUPEN_MASK (0x40U)
#define PMC_AE_CONFIG_LINSUPEN_SHIFT (6U)
#define PMC_AE_CONFIG_LINSUPEN_WIDTH (1U)
#define PMC_AE_CONFIG_LINSUPEN(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_CONFIG_LINSUPEN_SHIFT)) & PMC_AE_CONFIG_LINSUPEN_MASK)
/*! @} */
...
#define PMC_AE_MONITOR_HVD15F(x)                                                                   \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_HVD15F_SHIFT)) & PMC_AE_MONITOR_HVD15F_MASK)

#define PMC_AE_MONITOR_HVDINTF_MASK (0x2U)
#define PMC_AE_MONITOR_HVDINTF_SHIFT (1U)
#define PMC_AE_MONITOR_HVDINTF_WIDTH (1U)
#define PMC_AE_MONITOR_HVDINTF(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_HVDINTF_SHIFT)) & PMC_AE_MONITOR_HVDINTF_MASK)

#define PMC_AE_MONITOR_HVDVDDF_MASK (0x4U)
#define PMC_AE_MONITOR_HVDVDDF_SHIFT (2U)
#define PMC_AE_MONITOR_HVDVDDF_WIDTH (1U)
#define PMC_AE_MONITOR_HVDVDDF(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_HVDVDDF_SHIFT)) & PMC_AE_MONITOR_HVDVDDF_MASK)

#define PMC_AE_MONITOR_LVDCF_MASK (0x8U)
#define PMC_AE_MONITOR_LVDCF_SHIFT (3U)
#define PMC_AE_MONITOR_LVDCF_WIDTH (1U)
#define PMC_AE_MONITOR_LVDCF(x)                                                                    \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_LVDCF_SHIFT)) & PMC_AE_MONITOR_LVDCF_MASK)

#define PMC_AE_MONITOR_LVDVLSF_MASK (0x10U)
#define PMC_AE_MONITOR_LVDVLSF_SHIFT (4U)
#define PMC_AE_MONITOR_LVDVLSF_WIDTH (1U)
#define PMC_AE_MONITOR_LVDVLSF(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_LVDVLSF_SHIFT)) & PMC_AE_MONITOR_LVDVLSF_MASK)

#define PMC_AE_MONITOR_LVR15F_MASK (0x20U)
#define PMC_AE_MONITOR_LVR15F_SHIFT (5U)
#define PMC_AE_MONITOR_LVR15F_WIDTH (1U)
#define PMC_AE_MONITOR_LVR15F(x)                                                                   \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_LVR15F_SHIFT)) & PMC_AE_MONITOR_LVR15F_MASK)

#define PMC_AE_MONITOR_LVRINTF_MASK (0x40U)
#define PMC_AE_MONITOR_LVRINTF_SHIFT (6U)
#define PMC_AE_MONITOR_LVRINTF_WIDTH (1U)
#define PMC_AE_MONITOR_LVRINTF(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_LVRINTF_SHIFT)) & PMC_AE_MONITOR_LVRINTF_MASK)

#define PMC_AE_MONITOR_PORF_MASK (0x80U)
#define PMC_AE_MONITOR_PORF_SHIFT (7U)
#define PMC_AE_MONITOR_PORF_WIDTH (1U)
#define PMC_AE_MONITOR_PORF(x)                                                                     \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_PORF_SHIFT)) & PMC_AE_MONITOR_PORF_MASK)

#define PMC_AE_MONITOR_IHVD15F_MASK (0x100U)
#define PMC_AE_MONITOR_IHVD15F_SHIFT (8U)
#define PMC_AE_MONITOR_IHVD15F_WIDTH (1U)
#define PMC_AE_MONITOR_IHVD15F(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_IHVD15F_SHIFT)) & PMC_AE_MONITOR_IHVD15F_MASK)

#define PMC_AE_MONITOR_IHVDINTF_MASK (0x200U)
#define PMC_AE_MONITOR_IHVDINTF_SHIFT (9U)
#define PMC_AE_MONITOR_IHVDINTF_WIDTH (1U)
#define PMC_AE_MONITOR_IHVDINTF(x)                                                                 \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_IHVDINTF_SHIFT)) & PMC_AE_MONITOR_IHVDINTF_MASK)
...
#define PMC_AE_MONITOR_IHVDVDDF(x)                                                                 \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_IHVDVDDF_SHIFT)) & PMC_AE_MONITOR_IHVDVDDF_MASK)

#define PMC_AE_MONITOR_ILVR15F_MASK (0x2000U)
#define PMC_AE_MONITOR_ILVR15F_SHIFT (13U)
#define PMC_AE_MONITOR_ILVR15F_WIDTH (1U)
#define PMC_AE_MONITOR_ILVR15F(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_ILVR15F_SHIFT)) & PMC_AE_MONITOR_ILVR15F_MASK)
...
#define PMC_AE_MONITOR_ILVRINTF(x)                                                                 \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_ILVRINTF_SHIFT)) & PMC_AE_MONITOR_ILVRINTF_MASK)

#define PMC_AE_MONITOR_HVD15S_MASK (0x10000U)
#define PMC_AE_MONITOR_HVD15S_SHIFT (16U)
#define PMC_AE_MONITOR_HVD15S_WIDTH (1U)
#define PMC_AE_MONITOR_HVD15S(x)                                                                   \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_HVD15S_SHIFT)) & PMC_AE_MONITOR_HVD15S_MASK)

#define PMC_AE_MONITOR_HVDINTS_MASK (0x20000U)
#define PMC_AE_MONITOR_HVDINTS_SHIFT (17U)
#define PMC_AE_MONITOR_HVDINTS_WIDTH (1U)
#define PMC_AE_MONITOR_HVDINTS(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_HVDINTS_SHIFT)) & PMC_AE_MONITOR_HVDINTS_MASK)

#define PMC_AE_MONITOR_HVDVDDS_MASK (0x40000U)
#define PMC_AE_MONITOR_HVDVDDS_SHIFT (18U)
#define PMC_AE_MONITOR_HVDVDDS_WIDTH (1U)
#define PMC_AE_MONITOR_HVDVDDS(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_HVDVDDS_SHIFT)) & PMC_AE_MONITOR_HVDVDDS_MASK)

#define PMC_AE_MONITOR_LVDCS_MASK (0x80000U)
#define PMC_AE_MONITOR_LVDCS_SHIFT (19U)
#define PMC_AE_MONITOR_LVDCS_WIDTH (1U)
#define PMC_AE_MONITOR_LVDCS(x)                                                                    \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_LVDCS_SHIFT)) & PMC_AE_MONITOR_LVDCS_MASK)
...
#define PMC_AE_MONITOR_LVDVLSS(x)                                                                  \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_LVDVLSS_SHIFT)) & PMC_AE_MONITOR_LVDVLSS_MASK)
...
#define PMC_AE_MONITOR_HVDINT15IE(x)                                                               \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_HVDINT15IE_SHIFT)) &                            \
...
#define PMC_AE_MONITOR_HVDVDDIE(x)                                                                 \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_HVDVDDIE_SHIFT)) & PMC_AE_MONITOR_HVDVDDIE_MASK)

#define PMC_AE_MONITOR_LVDCIE_MASK (0x8000000U)
#define PMC_AE_MONITOR_LVDCIE_SHIFT (27U)
#define PMC_AE_MONITOR_LVDCIE_WIDTH (1U)
#define PMC_AE_MONITOR_LVDCIE(x)                                                                   \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_LVDCIE_SHIFT)) & PMC_AE_MONITOR_LVDCIE_MASK)
...
#define PMC_AE_MONITOR_LVDVLSIE(x)                                                                 \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONITOR_LVDVLSIE_SHIFT)) & PMC_AE_MONITOR_LVDVLSIE_MASK)
/*! @} */
...
#define PMC_AE_MONCHECK_DONEF(x)                                                                   \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONCHECK_DONEF_SHIFT)) & PMC_AE_MONCHECK_DONEF_MASK)
...
#define PMC_AE_MONCHECK_TRIGGER(x)                                                                 \
    (((uint32_t)(((uint32_t)(x)) << PMC_AE_MONCHECK_TRIGGER_SHIFT)) & PMC_AE_MONCHECK_TRIGGER_MASK)
/*! @} */
