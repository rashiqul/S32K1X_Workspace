 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_LPIT
 *
...
#if !defined(S32M24x_LPIT_H_) /* Check if memory map has not been already included */
#define S32M24x_LPIT_H_
...
typedef struct {
    ...
    struct LPIT_TMR {        /* offset: 0x20, array step: 0x10 */
...
#define IP_LPIT_BASE_ADDRS                                                                         \
    {                                                                                              \
        IP_LPIT0_BASE                                                                              \
    }
/** Array initializer of LPIT peripheral base pointers */
#define IP_LPIT_BASE_PTRS                                                                          \
    {                                                                                              \
        IP_LPIT0                                                                                   \
    }
...
#define LPIT_TMR_CVAL_TMR_CUR_VAL(x)                                                               \
    (((uint32_t)(((uint32_t)(x)) << LPIT_TMR_CVAL_TMR_CUR_VAL_SHIFT)) &                            \
...
#endif /* #if !defined(S32M24x_LPIT_H_) */
