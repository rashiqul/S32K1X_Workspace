/*
** ###################################################################
**     Processor:           S32M24x_M4
**     Compiler:            Keil ARM C/C++ Compiler
**     Reference manual:    S32M24x RM Rev.1 Draft F
**     Version:             rev. 1.0, 2021-02-18
**     Build:               b210218
**
**     Abstract:
**         Peripheral Access Layer for S32M24x_M4
**
 ...
 * @version 1.0
 * @date 2021-02-18
 * @brief Peripheral Access Layer for S32M24x_NVIC
 *
...
#if !defined(S32M24x_NVIC_H_) /* Check if memory map has not been already included */
#define S32M24x_NVIC_H_
...
typedef struct {
    __IO uint32_t ISER[S32_NVIC_ISER_COUNT]; /**< Interrupt Set Enable Register n, array offset:
                                                0x0, array step: 0x4 */
    uint8_t RESERVED_0[96];
    __IO uint32_t ICER[S32_NVIC_ICER_COUNT]; /**< Interrupt Clear Enable Register n, array offset:
                                                0x80, array step: 0x4 */
    uint8_t RESERVED_1[96];
    __IO uint32_t ISPR[S32_NVIC_ISPR_COUNT]; /**< Interrupt Set Pending Register n, array offset:
                                                0x100, array step: 0x4 */
    uint8_t RESERVED_2[96];
    __IO uint32_t ICPR[S32_NVIC_ICPR_COUNT]; /**< Interrupt Clear Pending Register n, array offset:
                                                0x180, array step: 0x4 */
    uint8_t RESERVED_3[96];
    __IO uint32_t IABR[S32_NVIC_IABR_COUNT]; /**< Interrupt Active bit Register n, array offset:
                                                0x200, array step: 0x4 */
    uint8_t RESERVED_4[224];
    __IO uint8_t IP[S32_NVIC_IP_COUNT]; /**< Interrupt Priority Register n, array offset: 0x300,
                                           array step: 0x1 */
...
#endif /* #if !defined(S32M24x_NVIC_H_) */
