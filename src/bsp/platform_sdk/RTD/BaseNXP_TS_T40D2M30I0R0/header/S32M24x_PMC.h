...
#define IP_PMC_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_PMC_BASE                                                                                \
    }
/** Array initializer of PMC peripheral base pointers */
#define IP_PMC_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_PMC                                                                                     \
    }
...
#define PMC_LVDSC2_LVWACK(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << PMC_LVDSC2_LVWACK_SHIFT)) & PMC_LVDSC2_LVWACK_MASK)
...
#define PMC_REGSC_BIASEN(x)                                                                        \
    (((uint8_t)(((uint8_t)(x)) << PMC_REGSC_BIASEN_SHIFT)) & PMC_REGSC_BIASEN_MASK)
...
#define PMC_REGSC_REGFPM(x)                                                                        \
    (((uint8_t)(((uint8_t)(x)) << PMC_REGSC_REGFPM_SHIFT)) & PMC_REGSC_REGFPM_MASK)

#define PMC_REGSC_LPOSTAT_MASK (0x40U)
#define PMC_REGSC_LPOSTAT_SHIFT (6U)
#define PMC_REGSC_LPOSTAT_WIDTH (1U)
#define PMC_REGSC_LPOSTAT(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << PMC_REGSC_LPOSTAT_SHIFT)) & PMC_REGSC_LPOSTAT_MASK)
...
#define PMC_REGSC_LPODIS(x)                                                                        \
    (((uint8_t)(((uint8_t)(x)) << PMC_REGSC_LPODIS_SHIFT)) & PMC_REGSC_LPODIS_MASK)
/*! @} */
...
#define PMC_LVRFLG_LVRF(x)                                                                         \
    (((uint8_t)(((uint8_t)(x)) << PMC_LVRFLG_LVRF_SHIFT)) & PMC_LVRFLG_LVRF_MASK)

#define PMC_LVRFLG_LVRLPF_MASK (0x2U)
#define PMC_LVRFLG_LVRLPF_SHIFT (1U)
#define PMC_LVRFLG_LVRLPF_WIDTH (1U)
#define PMC_LVRFLG_LVRLPF(x)                                                                       \
    (((uint8_t)(((uint8_t)(x)) << PMC_LVRFLG_LVRLPF_SHIFT)) & PMC_LVRFLG_LVRLPF_MASK)

#define PMC_LVRFLG_LVRXF_MASK (0x4U)
#define PMC_LVRFLG_LVRXF_SHIFT (2U)
#define PMC_LVRFLG_LVRXF_WIDTH (1U)
#define PMC_LVRFLG_LVRXF(x)                                                                        \
    (((uint8_t)(((uint8_t)(x)) << PMC_LVRFLG_LVRXF_SHIFT)) & PMC_LVRFLG_LVRXF_MASK)

#define PMC_LVRFLG_LVRXLPF_MASK (0x8U)
#define PMC_LVRFLG_LVRXLPF_SHIFT (3U)
#define PMC_LVRFLG_LVRXLPF_WIDTH (1U)
#define PMC_LVRFLG_LVRXLPF(x)                                                                      \
    (((uint8_t)(((uint8_t)(x)) << PMC_LVRFLG_LVRXLPF_SHIFT)) & PMC_LVRFLG_LVRXLPF_MASK)

#define PMC_LVRFLG_LVR3F_MASK (0x10U)
#define PMC_LVRFLG_LVR3F_SHIFT (4U)
#define PMC_LVRFLG_LVR3F_WIDTH (1U)
#define PMC_LVRFLG_LVR3F(x)                                                                        \
    (((uint8_t)(((uint8_t)(x)) << PMC_LVRFLG_LVR3F_SHIFT)) & PMC_LVRFLG_LVR3F_MASK)

#define PMC_LVRFLG_LVR3FLSF_MASK (0x20U)
#define PMC_LVRFLG_LVR3FLSF_SHIFT (5U)
#define PMC_LVRFLG_LVR3FLSF_WIDTH (1U)
#define PMC_LVRFLG_LVR3FLSF(x)                                                                     \
    (((uint8_t)(((uint8_t)(x)) << PMC_LVRFLG_LVR3FLSF_SHIFT)) & PMC_LVRFLG_LVR3FLSF_MASK)

#define PMC_LVRFLG_PORF_MASK (0x80U)
#define PMC_LVRFLG_PORF_SHIFT (7U)
#define PMC_LVRFLG_PORF_WIDTH (1U)
#define PMC_LVRFLG_PORF(x)                                                                         \
    (((uint8_t)(((uint8_t)(x)) << PMC_LVRFLG_PORF_SHIFT)) & PMC_LVRFLG_PORF_MASK)
/*! @} */
...
#define PMC_LPOTRIM_LPOTRIM(x)                                                                     \
    (((uint8_t)(((uint8_t)(x)) << PMC_LPOTRIM_LPOTRIM_SHIFT)) & PMC_LPOTRIM_LPOTRIM_MASK)
/*! @} */
