...
typedef struct {
    ...
    __O uint32_t
        TDR[SAI_TDR_COUNT]; /**< SAI Transmit Data Register, array offset: 0x20, array step: 0x4 */
    uint8_t RESERVED_0[16];
    __I uint32_t
        TFR[SAI_TFR_COUNT]; /**< SAI Transmit FIFO Register, array offset: 0x40, array step: 0x4 */
    ...
    __I uint32_t
        RDR[SAI_RDR_COUNT]; /**< SAI Receive Data Register, array offset: 0xA0, array step: 0x4 */
    uint8_t RESERVED_3[16];
    __I uint32_t
        RFR[SAI_RFR_COUNT]; /**< SAI Receive FIFO Register, array offset: 0xC0, array step: 0x4 */
...
#define IP_SAI_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_SAI0_BASE, IP_SAI1_BASE                                                                 \
    }
/** Array initializer of SAI peripheral base pointers */
#define IP_SAI_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_SAI0, IP_SAI1                                                                           \
    }
...
#define SAI_VERID_FEATURE(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << SAI_VERID_FEATURE_SHIFT)) & SAI_VERID_FEATURE_MASK)

#define SAI_VERID_MINOR_MASK (0xFF0000U)
#define SAI_VERID_MINOR_SHIFT (16U)
#define SAI_VERID_MINOR_WIDTH (8U)
#define SAI_VERID_MINOR(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << SAI_VERID_MINOR_SHIFT)) & SAI_VERID_MINOR_MASK)

#define SAI_VERID_MAJOR_MASK (0xFF000000U)
#define SAI_VERID_MAJOR_SHIFT (24U)
#define SAI_VERID_MAJOR_WIDTH (8U)
#define SAI_VERID_MAJOR(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << SAI_VERID_MAJOR_SHIFT)) & SAI_VERID_MAJOR_MASK)
/*! @} */
...
#define SAI_PARAM_DATALINE(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << SAI_PARAM_DATALINE_SHIFT)) & SAI_PARAM_DATALINE_MASK)

#define SAI_PARAM_FIFO_MASK (0xF00U)
#define SAI_PARAM_FIFO_SHIFT (8U)
#define SAI_PARAM_FIFO_WIDTH (4U)
#define SAI_PARAM_FIFO(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SAI_PARAM_FIFO_SHIFT)) & SAI_PARAM_FIFO_MASK)

#define SAI_PARAM_FRAME_MASK (0xF0000U)
#define SAI_PARAM_FRAME_SHIFT (16U)
#define SAI_PARAM_FRAME_WIDTH (4U)
#define SAI_PARAM_FRAME(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << SAI_PARAM_FRAME_SHIFT)) & SAI_PARAM_FRAME_MASK)
/*! @} */
...
#define SAI_TCR3_TCE_MASK                                                                          \
    (0xF0000U) /* Merged from fields with different position or width, of widths (1, 4), largest   \
                  definition used */
#define SAI_TCR3_TCE_SHIFT (16U)
#define SAI_TCR3_TCE_WIDTH (4U)
#define SAI_TCR3_TCE(x)                                                                            \
    (((uint32_t)(((uint32_t)(x)) << SAI_TCR3_TCE_SHIFT)) &                                         \
     SAI_TCR3_TCE_MASK) /* Merged from fields with different position or width, of widths (1, 4),  \
...
#define SAI_TCR4_ONDEM(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SAI_TCR4_ONDEM_SHIFT)) & SAI_TCR4_ONDEM_MASK)
...
#define SAI_TCR4_CHMOD(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SAI_TCR4_CHMOD_SHIFT)) & SAI_TCR4_CHMOD_MASK)
...
#define SAI_TCR4_FPACK(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SAI_TCR4_FPACK_SHIFT)) & SAI_TCR4_FPACK_MASK)
...
#define SAI_TCR4_FCOMB(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SAI_TCR4_FCOMB_SHIFT)) & SAI_TCR4_FCOMB_MASK)
...
#define SAI_TCR4_FCONT(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SAI_TCR4_FCONT_SHIFT)) & SAI_TCR4_FCONT_MASK)
/*! @} */
...
#define SAI_RCR3_RCE_MASK                                                                          \
    (0xF0000U) /* Merged from fields with different position or width, of widths (1, 4), largest   \
                  definition used */
#define SAI_RCR3_RCE_SHIFT (16U)
#define SAI_RCR3_RCE_WIDTH (4U)
#define SAI_RCR3_RCE(x)                                                                            \
    (((uint32_t)(((uint32_t)(x)) << SAI_RCR3_RCE_SHIFT)) &                                         \
     SAI_RCR3_RCE_MASK) /* Merged from fields with different position or width, of widths (1, 4),  \
                           largest definition used */
...
#define SAI_RCR4_ONDEM(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SAI_RCR4_ONDEM_SHIFT)) & SAI_RCR4_ONDEM_MASK)
...
#define SAI_RCR4_FPACK(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SAI_RCR4_FPACK_SHIFT)) & SAI_RCR4_FPACK_MASK)
...
#define SAI_RCR4_FCOMB(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SAI_RCR4_FCOMB_SHIFT)) & SAI_RCR4_FCOMB_MASK)
...
#define SAI_RCR4_FCONT(x)                                                                          \
    (((uint32_t)(((uint32_t)(x)) << SAI_RCR4_FCONT_SHIFT)) & SAI_RCR4_FCONT_MASK)
/*! @} */
