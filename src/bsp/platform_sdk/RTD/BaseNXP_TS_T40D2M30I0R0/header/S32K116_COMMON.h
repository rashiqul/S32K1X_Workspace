...
typedef enum {
    ...
    PORT_IRQn =
        9, /**< PORTA Interrupt,PORTB Interrupt,PORTC Interrupt,PORTD Interrupt,PORTE Interrupt */
    CAN0_ORed_IRQn =
        10, /**< CAN0 OR'ed Bus in Off State,Interrupt indicating Transmit Error Counter transition
               from less than 96 to greater and equal to 96,Interrupt indicating Receive Error
               Counter transition from less than 96 to greater and equal to 96,Interrupt indicating
               that errors were detected on the CAN bus, Interrupt indicating that errors were
               detected on the CAN bus for FD messages in the Fast Bit Rate region,Interrupt
               asserted when Pretended Networking operation is enabled, and a valid message matches
               the selected filter criteria during Low Power mode */
    CAN0_ORed_0_31_MB_IRQn =
        11, /**< CAN0 OR'ed Message buffer (0-15),CAN0 OR'ed Message buffer (16-31) */
    ...
    PMC_SCG_CMU_IRQn = 21, /**< PMC Low voltage detect interrupt, SCG bus interrupt request,CMU loss
                              of range interrupt */
