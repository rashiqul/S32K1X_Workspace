...
/*!
 * @file S32M24x_LPSPI.h
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_LPSPI
 *
...
#if !defined(S32M24x_LPSPI_H_) /* Check if memory map has not been already included */
#define S32M24x_LPSPI_H_
...
typedef struct {
    ...
    __IO uint32_t FCR; /**< The FIFO Control register contains the RXWATER and TXWATER control
                          fields., offset: 0x58 */
...
#define IP_LPSPI_BASE_ADDRS                                                                        \
    {                                                                                              \
        IP_LPSPI0_BASE, IP_LPSPI1_BASE, IP_LPSPI2_BASE                                             \
    }
/** Array initializer of LPSPI peripheral base pointers */
#define IP_LPSPI_BASE_PTRS                                                                         \
    {                                                                                              \
        IP_LPSPI0, IP_LPSPI1, IP_LPSPI2                                                            \
    }
...
#endif /* #if !defined(S32M24x_LPSPI_H_) */
