...
/*!
 * @file S32M24x_DMAMUX.h
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_DMAMUX
 *
...
#if !defined(S32M24x_DMAMUX_H_) /* Check if memory map has not been already included */
#define S32M24x_DMAMUX_H_
...
typedef struct {
    __IO uint8_t CHCFG[DMAMUX_CHCFG_COUNT]; /**< Channel Configuration register, array offset: 0x0,
                                               array step: 0x1 */
...
#define IP_DMAMUX_BASE_ADDRS                                                                       \
    {                                                                                              \
        IP_DMAMUX_BASE                                                                             \
    }
/** Array initializer of DMAMUX peripheral base pointers */
#define IP_DMAMUX_BASE_PTRS                                                                        \
    {                                                                                              \
        IP_DMAMUX                                                                                  \
    }
...
#endif /* #if !defined(S32M24x_DMAMUX_H_) */
