...
/*!
 * @file S32K142W_SYSTICK.h
 * @version 1.0
 * @date 2021-02-18
 * @brief Peripheral Access Layer for S32K142W_SYSTICK
 *
...
#if !defined(S32K142W_SYSTICK_H_) /* Check if memory map has not been already included */
#define S32K142W_SYSTICK_H_
...
#endif /* #if !defined(S32K142W_SYSTICK_H_) */
