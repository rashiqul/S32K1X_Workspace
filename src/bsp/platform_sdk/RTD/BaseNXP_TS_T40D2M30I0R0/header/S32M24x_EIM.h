 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_EIM
 *
...
#if !defined(S32M24x_EIM_H_) /* Check if memory map has not been already included */
#define S32M24x_EIM_H_
...
typedef struct {
    ...
    struct EIM_EICHDn {      /* offset: 0x100, array step: 0x40 */
        __IO uint32_t WORD0; /**< Error Injection Channel Descriptor n, Word0, array offset: 0x100,
                                array step: 0x40 */
        __IO uint32_t WORD1; /**< Error Injection Channel Descriptor n, Word1, array offset: 0x104,
                                array step: 0x40 */
...
#define IP_EIM_BASE_ADDRS                                                                          \
    {                                                                                              \
        IP_EIM_BASE                                                                                \
    }
/** Array initializer of EIM peripheral base pointers */
#define IP_EIM_BASE_PTRS                                                                           \
    {                                                                                              \
        IP_EIM                                                                                     \
    }
...
#define EIM_EIMCR_GEIEN(x)                                                                         \
    (((uint32_t)(((uint32_t)(x)) << EIM_EIMCR_GEIEN_SHIFT)) & EIM_EIMCR_GEIEN_MASK)
/*! @} */
...
#define EIM_EICHEN_EICH1EN(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << EIM_EICHEN_EICH1EN_SHIFT)) & EIM_EICHEN_EICH1EN_MASK)

#define EIM_EICHEN_EICH0EN_MASK (0x80000000U)
#define EIM_EICHEN_EICH0EN_SHIFT (31U)
#define EIM_EICHEN_EICH0EN_WIDTH (1U)
#define EIM_EICHEN_EICH0EN(x)                                                                      \
    (((uint32_t)(((uint32_t)(x)) << EIM_EICHEN_EICH0EN_SHIFT)) & EIM_EICHEN_EICH0EN_MASK)
/*! @} */
...
#define EIM_EICHDn_WORD0_CHKBIT_MASK(x)                                                            \
    (((uint32_t)(((uint32_t)(x)) << EIM_EICHDn_WORD0_CHKBIT_MASK_SHIFT)) &                         \
...
#define EIM_EICHDn_WORD1_B0_3DATA_MASK(x)                                                          \
    (((uint32_t)(((uint32_t)(x)) << EIM_EICHDn_WORD1_B0_3DATA_MASK_SHIFT)) &                       \
...
#endif /* #if !defined(S32M24x_EIM_H_) */
