...
#define IP_MEM_OTP_AE_BASE_ADDRS                                                                   \
    {                                                                                              \
        IP_MEM_OTP_AE_BASE                                                                         \
    }
/** Array initializer of MEM_OTP_AE peripheral base pointers */
#define IP_MEM_OTP_AE_BASE_PTRS                                                                    \
    {                                                                                              \
        IP_MEM_OTP_AE                                                                              \
    }
...
#define MEM_OTP_AE_CTRL_CMD_CMD(x)                                                                 \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_CTRL_CMD_CMD_SHIFT)) & MEM_OTP_AE_CTRL_CMD_CMD_MASK)
/*! @} */
...
#define MEM_OTP_AE_STRT_STP_START(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STRT_STP_START_SHIFT)) &                            \
     MEM_OTP_AE_STRT_STP_START_MASK)
...
#define MEM_OTP_AE_STRT_STP_STOP(x)                                                                \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STRT_STP_STOP_SHIFT)) &                             \
     MEM_OTP_AE_STRT_STP_STOP_MASK)
/*! @} */
...
#define MEM_OTP_AE_DATAOUT_OUTPUT(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_DATAOUT_OUTPUT_SHIFT)) &                            \
     MEM_OTP_AE_DATAOUT_OUTPUT_MASK)
...
#define MEM_OTP_AE_DATAOUT_MIRRD(x)                                                                \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_DATAOUT_MIRRD_SHIFT)) &                             \
     MEM_OTP_AE_DATAOUT_MIRRD_MASK)
/*! @} */
...
#define MEM_OTP_AE_STATUS_SECTCRCOK0(x)                                                            \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTCRCOK0_SHIFT)) &                         \
     MEM_OTP_AE_STATUS_SECTCRCOK0_MASK)
...
#define MEM_OTP_AE_STATUS_SECTCRCOK1(x)                                                            \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTCRCOK1_SHIFT)) &                         \
     MEM_OTP_AE_STATUS_SECTCRCOK1_MASK)
...
#define MEM_OTP_AE_STATUS_SECTCRCOK2(x)                                                            \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTCRCOK2_SHIFT)) &                         \
     MEM_OTP_AE_STATUS_SECTCRCOK2_MASK)
...
#define MEM_OTP_AE_STATUS_SECTCRCOK3(x)                                                            \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTCRCOK3_SHIFT)) &                         \
     MEM_OTP_AE_STATUS_SECTCRCOK3_MASK)
...
#define MEM_OTP_AE_STATUS_SECTWP0(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTWP0_SHIFT)) &                            \
     MEM_OTP_AE_STATUS_SECTWP0_MASK)
...
#define MEM_OTP_AE_STATUS_SECTWP1(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTWP1_SHIFT)) &                            \
     MEM_OTP_AE_STATUS_SECTWP1_MASK)
...
#define MEM_OTP_AE_STATUS_SECTWP2(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTWP2_SHIFT)) &                            \
     MEM_OTP_AE_STATUS_SECTWP2_MASK)
...
#define MEM_OTP_AE_STATUS_SECTWP3(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTWP3_SHIFT)) &                            \
     MEM_OTP_AE_STATUS_SECTWP3_MASK)
...
#define MEM_OTP_AE_STATUS_SECTBE0(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTBE0_SHIFT)) &                            \
     MEM_OTP_AE_STATUS_SECTBE0_MASK)
...
#define MEM_OTP_AE_STATUS_SECTBE1(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTBE1_SHIFT)) &                            \
     MEM_OTP_AE_STATUS_SECTBE1_MASK)
...
#define MEM_OTP_AE_STATUS_SECTBE2(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTBE2_SHIFT)) &                            \
     MEM_OTP_AE_STATUS_SECTBE2_MASK)
...
#define MEM_OTP_AE_STATUS_SECTBE3(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_STATUS_SECTBE3_SHIFT)) &                            \
     MEM_OTP_AE_STATUS_SECTBE3_MASK)
/*! @} */
...
#define MEM_OTP_AE_ERROR_CTRLBUSY(x)                                                               \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_ERROR_CTRLBUSY_SHIFT)) &                            \
     MEM_OTP_AE_ERROR_CTRLBUSY_MASK)
...
#define MEM_OTP_AE_ERROR_CTRLERR(x)                                                                \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_ERROR_CTRLERR_SHIFT)) &                             \
...
#define MEM_OTP_AE_ERROR_ECC1ERR(x)                                                                \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_ERROR_ECC1ERR_SHIFT)) &                             \
...
#define MEM_OTP_AE_ERROR_ECC2ERR(x)                                                                \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_ERROR_ECC2ERR_SHIFT)) &                             \
...
#define MEM_OTP_AE_ERROR_BOOTERR(x)                                                                \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_ERROR_BOOTERR_SHIFT)) &                             \
...
#define MEM_OTP_AE_MODE_SECTCRCCOMP0(x)                                                            \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_MODE_SECTCRCCOMP0_SHIFT)) &                         \
     MEM_OTP_AE_MODE_SECTCRCCOMP0_MASK)
...
#define MEM_OTP_AE_MODE_SECTCRCCOMP1(x)                                                            \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_MODE_SECTCRCCOMP1_SHIFT)) &                         \
     MEM_OTP_AE_MODE_SECTCRCCOMP1_MASK)
...
#define MEM_OTP_AE_MODE_SECTCRCCOMP2(x)                                                            \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_MODE_SECTCRCCOMP2_SHIFT)) &                         \
     MEM_OTP_AE_MODE_SECTCRCCOMP2_MASK)
...
#define MEM_OTP_AE_MODE_SECTCRCCOMP3(x)                                                            \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_MODE_SECTCRCCOMP3_SHIFT)) &                         \
     MEM_OTP_AE_MODE_SECTCRCCOMP3_MASK)

#define MEM_OTP_AE_MODE_TSTIC_MASK (0x100U)
#define MEM_OTP_AE_MODE_TSTIC_SHIFT (8U)
#define MEM_OTP_AE_MODE_TSTIC_WIDTH (1U)
#define MEM_OTP_AE_MODE_TSTIC(x)                                                                   \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_MODE_TSTIC_SHIFT)) & MEM_OTP_AE_MODE_TSTIC_MASK)
...
#define MEM_OTP_AE_MODE_SUPERUSR(x)                                                                \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_MODE_SUPERUSR_SHIFT)) &                             \
     MEM_OTP_AE_MODE_SUPERUSR_MASK)

#define MEM_OTP_AE_MODE_VERID_MASK (0xF000U)
#define MEM_OTP_AE_MODE_VERID_SHIFT (12U)
#define MEM_OTP_AE_MODE_VERID_WIDTH (4U)
#define MEM_OTP_AE_MODE_VERID(x)                                                                   \
    (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_MODE_VERID_SHIFT)) & MEM_OTP_AE_MODE_VERID_MASK)
/*! @} */
