...
typedef struct {
    ...
    struct { /* offset: 0x20, array step: 0x10 */
        __IO uint32_t
            COMP; /**< MTB_DWT Comparator Register, array offset: 0x20, array step: 0x10 */
        __IO uint32_t
            MASK; /**< MTB_DWT Comparator Mask Register, array offset: 0x24, array step: 0x10 */
        __IO uint32_t FCT; /**< MTB_DWT Comparator Function Register 0..MTB_DWT Comparator Function
                              Register 1, array offset: 0x28, array step: 0x10 */
    ...
    __I uint32_t PERIPHID[MTB_DWT_PERIPHID_COUNT]; /**< Peripheral ID Register, array offset: 0xFD0,
                                                      array step: 0x4 */
    __I uint32_t COMPID[MTB_DWT_COMPID_COUNT];     /**< Component ID Register, array offset: 0xFF0,
                                                      array step: 0x4 */
...
#define IP_MTB_DWT_BASE_ADDRS                                                                      \
    {                                                                                              \
        IP_MTB_DWT_BASE                                                                            \
    }
/** Array initializer of MTB_DWT peripheral base pointers */
#define IP_MTB_DWT_BASE_PTRS                                                                       \
    {                                                                                              \
        IP_MTB_DWT                                                                                 \
    }
...
#define MTB_DWT_CTRL_NUMCMP(x)                                                                     \
    (((uint32_t)(((uint32_t)(x)) << MTB_DWT_CTRL_NUMCMP_SHIFT)) & MTB_DWT_CTRL_NUMCMP_MASK)
/*! @} */
...
#define MTB_DWT_COMP_COMP(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << MTB_DWT_COMP_COMP_SHIFT)) & MTB_DWT_COMP_COMP_MASK)
/*! @} */
...
#define MTB_DWT_MASK_MASK(x)                                                                       \
    (((uint32_t)(((uint32_t)(x)) << MTB_DWT_MASK_MASK_SHIFT)) & MTB_DWT_MASK_MASK_MASK)
/*! @} */
...
#define MTB_DWT_FCT_MATCHED(x)                                                                     \
    (((uint32_t)(((uint32_t)(x)) << MTB_DWT_FCT_MATCHED_SHIFT)) & MTB_DWT_FCT_MATCHED_MASK)
/*! @} */
...
#define MTB_DWT_DEVICECFG_DEVICECFG(x)                                                             \
    (((uint32_t)(((uint32_t)(x)) << MTB_DWT_DEVICECFG_DEVICECFG_SHIFT)) &                          \
     MTB_DWT_DEVICECFG_DEVICECFG_MASK)
/*! @} */
...
#define MTB_DWT_DEVICETYPID_DEVICETYPID(x)                                                         \
    (((uint32_t)(((uint32_t)(x)) << MTB_DWT_DEVICETYPID_DEVICETYPID_SHIFT)) &                      \
     MTB_DWT_DEVICETYPID_DEVICETYPID_MASK)
/*! @} */
...
#define MTB_DWT_PERIPHID_PERIPHID(x)                                                               \
    (((uint32_t)(((uint32_t)(x)) << MTB_DWT_PERIPHID_PERIPHID_SHIFT)) &                            \
     MTB_DWT_PERIPHID_PERIPHID_MASK)
/*! @} */
