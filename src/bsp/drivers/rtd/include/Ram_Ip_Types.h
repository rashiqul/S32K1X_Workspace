 ...
 * @details          This is the Ram State data type returned by the function Mcu_GetRamState() of
 * the Mcu module.
...
/**
 * @brief            The Ram_Ip_RamSectionType specifies the identification (ID) for a RAM section,
 ...
 *                   The definitions for each RAM section within the structure Ram_Ip_ConfigType
 * shall contain:
