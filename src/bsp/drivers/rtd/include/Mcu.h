 ...
 *
 * This function performs a microcontroller reset by using the hardware feature of the
 * microcontroller. In case the function returns, the user must reset the platform using an
 ...
 * @details          Disable Last Mile to switch to Boot regulator to provide a lower voltage to
 * core and flash.
 *
 * @return           void
 *
