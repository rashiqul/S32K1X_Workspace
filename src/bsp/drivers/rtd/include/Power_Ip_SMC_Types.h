...
/* Check if Power_Ip_SMC_Types.h file and Power_Ip_Cfg_Defines.h file are of the same Autosar
 * version */
#if ((POWER_IP_SMC_TYPES_AR_RELEASE_MAJOR_VERSION !=                                               \
      POWER_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION) ||                                            \
     (POWER_IP_SMC_TYPES_AR_RELEASE_MINOR_VERSION !=                                               \
...
/* Check if Power_Ip_SMC_Types.h file and Power_Ip_Cfg_Defines.h file are of the same Software
 * version */
...
typedef enum { POWER_IP_MODE_OK = 0, POWER_IP_MODE_NOT_OK } Power_Ip_SMC_ModeStatusType;

#ifdef POWER_IP_VLPSA_NOTIFICATION
typedef enum { POWER_IP_STOP_SUCCESSFUL = 0, POWER_IP_STOP_ABORTED } Power_Ip_SMC_VLPSA_StatusType;
#endif
