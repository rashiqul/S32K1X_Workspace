...
/* Check if Power_Ip_Types.h file and Power_Ip_SMC_Types.h file are of the same Autosar version */
     ...
     (POWER_IP_TYPES_AR_RELEASE_REVISION_VERSION !=                                                \
      POWER_IP_SMC_TYPES_AR_RELEASE_REVISION_VERSION))
...
/* Check if Power_Ip_Types.h file and Power_Ip_RCM_Types.h file are of the same Autosar version */
     ...
     (POWER_IP_TYPES_AR_RELEASE_REVISION_VERSION !=                                                \
      POWER_IP_RCM_TYPES_AR_RELEASE_REVISION_VERSION))
...
/* Check if Power_Ip_Types.h file and Power_Ip_AEC_Types.h file are of the same Autosar version */
     ...
     (POWER_IP_TYPES_AR_RELEASE_REVISION_VERSION !=                                                \
      POWER_IP_AEC_TYPES_AR_RELEASE_REVISION_VERSION))
...
==================================================================================================*/
/**
 * @brief            The Power_Ip_ModeType specifies the identification (ID) for a MCU mode,
 * configured via configuration structure.
...
typedef enum {
    ...
    POWER_IP_ISR_VOLTAGE_HVD_VDDINT_DETECT =
        5U, /**< @brief Report the Voltage on VDDINT is high-voltage detected. */
    POWER_IP_ISR_VOLTAGE_HVD_15_DETECT =
        6U, /**< @brief Report the Voltage on VDD15 is high-voltage detected. */
    POWER_IP_ISR_VOLTAGE_HVD_VDD_DETECT =
        7U, /**< @brief Report the Voltage on VDD is high-voltage detected. */
    POWER_IP_ISR_VOLTAGE_LVD_VDDC_DETECT =
        8U, /**< @brief Report the Voltage on VDDC is low-voltage detected. */
    POWER_IP_ISR_VOLTAGE_LVD_VLS_DETECT =
        9U, /**< @brief Report the Voltage on VLS is low-voltage detected. */
