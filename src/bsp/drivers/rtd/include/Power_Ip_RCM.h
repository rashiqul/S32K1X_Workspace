...
#define Call_Power_Ip_RCM_ResetInit(RCM_pResetConfigPtr) Power_Ip_RCM_ResetInit(RCM_pResetConfigPtr)
#endif
...
#define Call_Power_Ip_RCM_GetResetReason() OsIf_Trusted_Call_Return(Power_Ip_RCM_GetResetReason)
#else

#define Call_Power_Ip_RCM_GetResetReason() Power_Ip_RCM_GetResetReason()
#endif
#endif /* POWER_IP_ENABLE_USER_MODE_SUPPORT */
...
#define Call_Power_Ip_RCM_GetResetRawValue() OsIf_Trusted_Call_Return(Power_Ip_RCM_GetResetRawValue)
#else

#define Call_Power_Ip_RCM_GetResetRawValue() Power_Ip_RCM_GetResetRawValue()
#endif
#endif /* POWER_IP_ENABLE_USER_MODE_SUPPORT */
