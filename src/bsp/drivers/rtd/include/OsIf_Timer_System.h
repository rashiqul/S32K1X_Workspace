 ...
 * NOTE: When converting microseconds to system ticks based on the system frequency, precision loss
 * can occur due to integer division truncating any fractional parts. To minimize this loss,
 * consider to perform multiplication before division: uint32 ticks = (microseconds *
 * system_frequency) / 1000000;
 *
