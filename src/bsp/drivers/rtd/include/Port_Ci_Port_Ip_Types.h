...
#endif
/* Check if the files Port_Ci_Port_Ip_Types.h and Port_Ci_Port_Ip_Defines.h are of the same Autosar
 * version */
#if ((PORT_CI_PORT_IP_AR_RELEASE_MAJOR_VERSION_TYPES_H !=                                          \
...
#error                                                                                             \
    "AutoSar Version Numbers of Port_Ci_Port_Ip_Types.h and Port_Ci_Port_Ip_Defines.h are different"
#endif
/* Check if the files Port_Ci_Port_Ip_Types.h and Port_Ci_Port_Ip_Defines.h are of the same software
 * version */
...
#error                                                                                             \
    "Software Version Numbers of Port_Ci_Port_Ip_Types.h and Port_Ci_Port_Ip_Defines.h are different"
#endif
...
typedef enum {
    PORT_FAST_SLEW_RATE = 0U, /*!< Fast slew rate is configured on the corresponding pin, if the pin
                                 is configured as a digital output.  */
    PORT_SLOW_SLEW_RATE = 1U  /*!< Slow slew rate is configured on the corresponding pin, if the pin
                                 is configured as a digital output.  */
...
typedef enum {
    ...
    PORT_ANALOG_PAD_CONTROL_ENABLED =
        1U /*!< Enable (another module can control the state of the switch) */
