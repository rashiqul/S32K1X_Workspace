...
/* Check if Power_Ip_PMC_Types.h file and Power_Ip_Cfg_Defines.h file are of the same Autosar
 * version */
#if ((POWER_IP_PMC_TYPES_AR_RELEASE_MAJOR_VERSION !=                                               \
      POWER_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION) ||                                            \
     (POWER_IP_PMC_TYPES_AR_RELEASE_MINOR_VERSION !=                                               \
      POWER_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION) ||                                            \
     (POWER_IP_PMC_TYPES_AR_RELEASE_REVISION_VERSION !=                                            \
...
/* Check if Power_Ip_PMC_Types.h file and Power_Ip_Cfg_Defines.h file are of the same Software
 * version */
...
#define PMC_LVDSC1_RWBITS_MASK8                                                                    \
    ((uint8)PMC_142_LVDSC1_LVDRE_MASK | PMC_142_LVDSC1_LVDIE_MASK | PMC_142_LVDSC1_LVDACK_MASK |   \
     PMC_142_LVDSC1_LVDF_MASK)

#define PMC_LVDSC2_RWBITS_MASK8                                                                    \
    ((uint8)PMC_142_LVDSC2_LVWIE_MASK | PMC_142_LVDSC2_LVWACK_MASK | PMC_142_LVDSC2_LVWF_MASK)

#define PMC_REGSC_RWBITS_MASK8                                                                     \
    ((uint8)PMC_142_REGSC_BIASEN_MASK | PMC_142_REGSC_CLKBIASDIS_MASK |                            \
     PMC_142_REGSC_REGFPM_MASK | PMC_142_REGSC_LPOSTAT_MASK | PMC_142_REGSC_LPODIS_MASK)
...
#define PMC_LVDSC1_RWBITS_MASK8                                                                    \
    ((uint8)PMC_LVDSC1_LVDRE_MASK | PMC_LVDSC1_LVDIE_MASK | PMC_LVDSC1_LVDACK_MASK |               \
     PMC_LVDSC1_LVDF_MASK)

#define PMC_LVDSC2_RWBITS_MASK8                                                                    \
    ((uint8)PMC_LVDSC2_LVWIE_MASK | PMC_LVDSC2_LVWACK_MASK | PMC_LVDSC2_LVWF_MASK)

#define PMC_REGSC_RWBITS_MASK8                                                                     \
    ((uint8)PMC_REGSC_BIASEN_MASK | PMC_REGSC_CLKBIASDIS_MASK | PMC_REGSC_REGFPM_MASK |            \
     PMC_REGSC_LPOSTAT_MASK | PMC_REGSC_LPODIS_MASK)
...
#define PMC_AE_CONFIG_RWBITS_MASK32                                                                \
    ((uint32)PMC_AE_CONFIG_LINSUPEN_MASK | PMC_AE_CONFIG_LVDVLSSEL_MASK |                          \
     PMC_AE_CONFIG_LINSUPSEL_MASK | PMC_AE_CONFIG_VDDCEN_MASK | PMC_AE_CONFIG_VDDSEL5V_MASK)

#define PMC_AE_MONITOR_RWBITS_MASK32                                                               \
    ((uint32)PMC_AE_MONITOR_LVDVLSIE_MASK | PMC_AE_MONITOR_LVDCIE_MASK |                           \
     PMC_AE_MONITOR_HVDVDDIE_MASK | PMC_AE_MONITOR_HVDINT15IE_MASK)

#define PMC_AE_MONITOR_INTERRUPT_FLAGS_MASK32                                                      \
    ((uint32)PMC_AE_MONITOR_LVDVLSF_MASK | PMC_AE_MONITOR_LVDCF_MASK |                             \
     PMC_AE_MONITOR_HVDVDDF_MASK | PMC_AE_MONITOR_HVDINTF_MASK | PMC_AE_MONITOR_HVD15F_MASK)
...
typedef enum {
    ...
    POWER_IP_PMC_LOW_VOLTAGE_DETECT_AND_WARNING =
        0x02, /**< @brief Low Voltage Detect Flag (LVDF) and Low Voltage Warning Flag (LVWF) . */
#endif
