...
/* Check if Clock_Ip_Private.h file and Clock_Ip_Specific1.h file are of the same Autosar version */
     ...
     (CLOCK_IP_PRIVATE_AR_RELEASE_REVISION_VERSION !=                                              \
      CLOCK_IP_SPECIFIC1_AR_RELEASE_REVISION_VERSION))
...
/* Check if Clock_Ip_Private.h file and Clock_Ip_Specific2.h file are of the same Autosar version */
     ...
     (CLOCK_IP_PRIVATE_AR_RELEASE_REVISION_VERSION !=                                              \
      CLOCK_IP_SPECIFIC2_AR_RELEASE_REVISION_VERSION))
...
typedef enum {
    /* Generic error codes */
    UKNOWN_TYPE =
        0x00U, /*!< Clock path from source to this clock name has at least one selector. */
...
extern const Clock_Ip_DividerCallbackType
    Clock_Ip_axDividerCallbacks[CLOCK_IP_DIVIDER_CALLBACKS_COUNT];

extern const Clock_Ip_DividerTriggerCallbackType
    Clock_Ip_axDividerTriggerCallbacks[CLOCK_IP_DIVIDERTRIGGER_CALLBACKS_COUNT];

extern const Clock_Ip_FracDivCallbackType
...
extern const Clock_Ip_SelectorCallbackType
    Clock_Ip_axSelectorCallbacks[CLOCK_IP_SELECTOR_CALLBACKS_COUNT];

extern const Clock_Ip_IntOscCallbackType
    Clock_Ip_axIntOscCallbacks[CLOCK_IP_IRCOSC_CALLBACKS_COUNT];

extern const Clock_Ip_ClockMonitorCallbackType
