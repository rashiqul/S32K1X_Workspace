...
/* Check if Power_Ip_AEC_Types.h file and Power_Ip_Cfg_Defines.h file are of the same Autosar
 * version */
#if ((POWER_IP_AEC_TYPES_AR_RELEASE_MAJOR_VERSION !=                                               \
      POWER_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION) ||                                            \
     (POWER_IP_AEC_TYPES_AR_RELEASE_MINOR_VERSION !=                                               \
...
/* Check if Power_Ip_AEC_Types.h file and Power_Ip_Cfg_Defines.h file are of the same Software
 * version */
