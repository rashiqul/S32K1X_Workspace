 ...
 *
 *
 * @param[in] Port_ConfigType * ConfigPtr Pointer to configuration (NULL_PTR if only one variant is
 *used)
 *
 * @return void
 *
 ...
 *
 * @details configures the referenced pin with all the properties specified in the NotUsedPortPin
 *container.
 *
 * @return void
 *
 ...
 *
 * @details configures the referenced pin with all the properties that where set during the
 *Port_Init operation.
 *
 * @return void
 *
 ...
 *
 * @details reverts the port pin mode of the referenced pin to the value that was set by Port_Init
 *operation.
 *
 * @return void
 *
