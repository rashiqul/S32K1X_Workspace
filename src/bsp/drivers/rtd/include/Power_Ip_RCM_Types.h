...
/* Check if Power_Ip_RCM_Types.h file and Power_Ip_Cfg_Defines.h file are of the same Autosar
 * version */
#if ((POWER_IP_RCM_TYPES_AR_RELEASE_MAJOR_VERSION !=                                               \
      POWER_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION) ||                                            \
     (POWER_IP_RCM_TYPES_AR_RELEASE_MINOR_VERSION !=                                               \
...
/* Check if Power_Ip_RCM_Types.h file and Power_Ip_Cfg_Defines.h file are of the same Software
 * version */
...
#define RCM_SSRS_RWBITS_MASK32 ((uint32)0x00002FEEU)
     ...
     defined(POWER_IP_DERIVATIVE_011) || defined(POWER_IP_DERIVATIVE_012))
...
/*                     RCM_RPC                      */
/****************************************************/
#define RCM_RPC_RWBITS_MASK32                                                                      \
    ((uint32)RCM_RPC_RSTFLTSRW_MASK | RCM_RPC_RSTFLTSS_MASK | RCM_RPC_RSTFLTSEL_MASK)
