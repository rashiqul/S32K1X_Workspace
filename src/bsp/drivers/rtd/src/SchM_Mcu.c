...
#ifdef MCAL_PLATFORM_ARM
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
ASM_KEYWORD uint32 Mcu_schm_read_msr(void){mrs x0, S3_3_c4_c2_1}
#elif (MCAL_PLATFORM_ARM == MCAL_ARM_RARCH)
ASM_KEYWORD uint32 Mcu_schm_read_msr(void){mrs r0, CPSR}
#else
...
#else
#ifdef MCAL_PLATFORM_S12
ASM_KEYWORD uint32 Mcu_schm_read_msr(void){tfr ccr, d6}
#else
ASM_KEYWORD uint32 Mcu_schm_read_msr(void)
{
    mfmsr r3
...
void SchM_Exit_Mcu_MCU_EXCLUSIVE_AREA_00(void)
{
    ...
    reentry_guard_MCU_EXCLUSIVE_AREA_00[u32CoreId]--;
    if ((ISR_ON(msr_MCU_EXCLUSIVE_AREA_00[u32CoreId])) &&
        (0UL == reentry_guard_MCU_EXCLUSIVE_AREA_00[u32CoreId])) /*if interrupts were enabled*/
    {
...
void SchM_Exit_Mcu_MCU_EXCLUSIVE_AREA_01(void)
{
    ...
    reentry_guard_MCU_EXCLUSIVE_AREA_01[u32CoreId]--;
    if ((ISR_ON(msr_MCU_EXCLUSIVE_AREA_01[u32CoreId])) &&
        (0UL == reentry_guard_MCU_EXCLUSIVE_AREA_01[u32CoreId])) /*if interrupts were enabled*/
    {
        OsIf_ResumeAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
        ASM_KEYWORD(" nop "); /* Compiler fix - forces the CSPID instruction to be generated with
...
void SchM_Exit_Mcu_MCU_EXCLUSIVE_AREA_02(void)
{
    ...
    reentry_guard_MCU_EXCLUSIVE_AREA_02[u32CoreId]--;
    if ((ISR_ON(msr_MCU_EXCLUSIVE_AREA_02[u32CoreId])) &&
        (0UL == reentry_guard_MCU_EXCLUSIVE_AREA_02[u32CoreId])) /*if interrupts were enabled*/
    {
        OsIf_ResumeAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
        ASM_KEYWORD(" nop "); /* Compiler fix - forces the CSPID instruction to be generated with
...
void SchM_Check_mcu(void)
{
    ...
    reentry_guard_MCU_EXCLUSIVE_AREA_00[u32CoreId] =
        0UL; /*reset reentry_guard_MCU_EXCLUSIVE_AREA_00 for the next test in the suite*/

    EU_ASSERT(0UL == reentry_guard_MCU_EXCLUSIVE_AREA_01[u32CoreId]);
    reentry_guard_MCU_EXCLUSIVE_AREA_01[u32CoreId] =
        0UL; /*reset reentry_guard_MCU_EXCLUSIVE_AREA_01 for the next test in the suite*/

    EU_ASSERT(0UL == reentry_guard_MCU_EXCLUSIVE_AREA_02[u32CoreId]);
    reentry_guard_MCU_EXCLUSIVE_AREA_02[u32CoreId] =
        0UL; /*reset reentry_guard_MCU_EXCLUSIVE_AREA_02 for the next test in the suite*/
}
