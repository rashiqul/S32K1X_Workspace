...
#if ((CLOCK_IP_FREQUENCY_AR_RELEASE_MAJOR_VERSION_C !=                                             \
      CLOCK_IP_PRIVATE_AR_RELEASE_MAJOR_VERSION) ||                                                \
     (CLOCK_IP_FREQUENCY_AR_RELEASE_MINOR_VERSION_C !=                                             \
      CLOCK_IP_PRIVATE_AR_RELEASE_MINOR_VERSION) ||                                                \
     (CLOCK_IP_FREQUENCY_AR_RELEASE_REVISION_VERSION_C !=                                          \
...
static extSignalFreq Clock_Ip_axExtSignalFreqEntries[CLOCK_IP_EXT_SIGNALS_NO] = {
    {TCLK0_REF_CLK, 0U}, {TCLK1_REF_CLK, 0U}, {TCLK2_REF_CLK, 0U}, {RTC_CLKIN, 0U}};
...
static uint64 get_FIRC_CLK_Frequency(void)
{
    return (uint64)CLOCK_IP_FIRC_FREQUENCY &
           Clock_Ip_u32EnableClock[((IP_SCG->FIRCCSR & SCG_FIRCCSR_FIRCEN_MASK) >>
...
static uint64 get_SOSC_CLK_Frequency(void)
{
    return Clock_Ip_u32Sosc &
           Clock_Ip_u32EnableClock[((IP_SCG->SOSCCSR & SCG_SOSCCSR_SOSCEN_MASK) >>
...
static uint64 get_SIRC_CLK_Frequency(void)
{
    return (uint64)CLOCK_IP_SIRC_FREQUENCY &
           Clock_Ip_u32EnableClock[((IP_SCG->SIRCCSR & SCG_SIRCCSR_SIRCEN_MASK) >>
...
static uint64 get_SPLL_CLK_Frequency(void)
{
    if (SpllChecksum != IP_SCG->SPLLCFG) {
        ...
        SpllFreq &= Clock_Ip_u32EnableClock[((IP_SCG->SPLLCSR & SCG_SPLLCSR_SPLLEN_MASK) >>
                                             SCG_SPLLCSR_SPLLEN_SHIFT)];
    }

    return (((((IP_SCG->SPLLCSR & SCG_SPLLCSR_SPLLVLD_MASK) >> SCG_SPLLCSR_SPLLVLD_SHIFT)) != 0U)
                ? SpllFreq
                : 0U);
}
#endif
...
static uint64 get_SIRCDIV1_CLK_Frequency(void)
{
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[(
        (IP_SCG->SIRCDIV & SCG_SIRCDIV_SIRCDIV1_MASK) >> SCG_SIRCDIV_SIRCDIV1_SHIFT)];
...
{
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[(
        (IP_SCG->SIRCDIV & SCG_SIRCDIV_SIRCDIV2_MASK) >> SCG_SIRCDIV_SIRCDIV2_SHIFT)];
    return (DivValue != 0U) ? (get_SIRC_CLK_Frequency() / DivValue) : 0U;
}
...
{
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[(
        (IP_SCG->FIRCDIV & SCG_FIRCDIV_FIRCDIV1_MASK) >> SCG_FIRCDIV_FIRCDIV1_SHIFT)];
...
{
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[(
        (IP_SCG->FIRCDIV & SCG_FIRCDIV_FIRCDIV2_MASK) >> SCG_FIRCDIV_FIRCDIV2_SHIFT)];
    return (DivValue != 0U) ? (get_FIRC_CLK_Frequency() / DivValue) : 0U;
}
...
{
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[(
        (IP_SCG->SOSCDIV & SCG_SOSCDIV_SOSCDIV1_MASK) >> SCG_SOSCDIV_SOSCDIV1_SHIFT)];
...
{
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[(
        (IP_SCG->SOSCDIV & SCG_SOSCDIV_SOSCDIV2_MASK) >> SCG_SOSCDIV_SOSCDIV2_SHIFT)];
    return (DivValue != 0U) ? (get_SOSC_CLK_Frequency() / DivValue) : 0U;
}
...
{
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[(
        (IP_SCG->SPLLDIV & SCG_SPLLDIV_SPLLDIV1_MASK) >> SCG_SPLLDIV_SPLLDIV1_SHIFT)];
...
{
    uint64 DivValue = Clock_Ip_au8DividerMappingValue[(
        (IP_SCG->SPLLDIV & SCG_SPLLDIV_SPLLDIV2_MASK) >> SCG_SPLLDIV_SPLLDIV2_SHIFT)];
    return (DivValue != 0U) ? (get_SPLL_CLK_Frequency() / DivValue) : 0U;
}
#endif
...
static uint64 get_LPO_32K_CLK_Frequency(void)
{
    return (get_LPO_128K_CLK_Frequency() >> 2U) &
           Clock_Ip_u32EnableGate[((IP_SIM->LPOCLKS & SIM_LPOCLKS_LPO32KCLKEN_MASK) >>
...
static uint64 get_LPO_1K_CLK_Frequency(void)
{
    return (get_LPO_32K_CLK_Frequency() >> 5U) &
           Clock_Ip_u32EnableGate[((IP_SIM->LPOCLKS & SIM_LPOCLKS_LPO1KCLKEN_MASK) >>
...
static uint64 get_SCS_CLK_Frequency(void)
{
    return FreqTableSCS[((IP_SCG->CSR & SCG_CSR_SCS_MASK) >> SCG_CSR_SCS_SHIFT) &
                        0x7U](); /*  Selector value */
}
...
static uint64 get_CORE_CLK_Frequency(void)
{
    return get_SCS_CLK_Frequency() / ((((uint64)IP_SCG->CSR & (uint64)SCG_CSR_DIVCORE_MASK) >>
                                       (uint64)SCG_CSR_DIVCORE_SHIFT) +
                                      1U);
}
...
static uint64 get_BUS_CLK_Frequency(void)
{
    return get_CORE_CLK_Frequency() /
           ((((uint64)IP_SCG->CSR & (uint64)SCG_CSR_DIVBUS_MASK) >> (uint64)SCG_CSR_DIVBUS_SHIFT) +
            1U);
}
...
static uint64 get_SLOW_CLK_Frequency(void)
{
    return get_CORE_CLK_Frequency() / ((((uint64)IP_SCG->CSR & (uint64)SCG_CSR_DIVSLOW_MASK) >>
                                        (uint64)SCG_CSR_DIVSLOW_SHIFT) +
                                       1U);
}
...
static uint64 get_SCS_HSRUN_CLK_Frequency(void)
{
    return FreqTableSCS[((IP_SCG->HCCR & SCG_HCCR_SCS_MASK) >>
                         SCG_HCCR_SCS_SHIFT)](); /*  Selector value */
}
#endif
#if defined(CLOCK_IP_HAS_CORE_HSRUN_CLK)
...
static uint64 get_CORE_HSRUN_CLK_Frequency(void)
{
    return get_SCS_HSRUN_CLK_Frequency() /
           (((IP_SCG->HCCR & SCG_HCCR_DIVCORE_MASK) >> SCG_HCCR_DIVCORE_SHIFT) + 1U);
}
#endif
#if defined(CLOCK_IP_HAS_BUS_HSRUN_CLK)
...
static uint64 get_BUS_HSRUN_CLK_Frequency(void)
{
    return get_CORE_HSRUN_CLK_Frequency() /
           (((IP_SCG->HCCR & SCG_HCCR_DIVBUS_MASK) >> SCG_HCCR_DIVBUS_SHIFT) + 1U);
}
#endif
#if defined(CLOCK_IP_HAS_SLOW_HSRUN_CLK)
/* Return SLOW_HSRUN_CLK frequency */
...
{
    return get_CORE_HSRUN_CLK_Frequency() /
           (((IP_SCG->HCCR & SCG_HCCR_DIVSLOW_MASK) >> SCG_HCCR_DIVSLOW_SHIFT) + 1U);
}
#endif
...
static uint64 get_SCS_RUN_CLK_Frequency(void)
{
    return FreqTableSCS[((IP_SCG->RCCR & SCG_RCCR_SCS_MASK) >> SCG_RCCR_SCS_SHIFT) &
                        0x7U](); /*  Selector value */
}
...
static uint64 get_CORE_RUN_CLK_Frequency(void)
{
    return get_SCS_RUN_CLK_Frequency() / ((((uint64)IP_SCG->RCCR & (uint64)SCG_RCCR_DIVCORE_MASK) >>
                                           (uint64)SCG_RCCR_DIVCORE_SHIFT) +
                                          1U);
}
...
static uint64 get_BUS_RUN_CLK_Frequency(void)
{
    return get_CORE_CLK_Frequency() / ((((uint64)IP_SCG->RCCR & (uint64)SCG_RCCR_DIVBUS_MASK) >>
                                        (uint64)SCG_RCCR_DIVBUS_SHIFT) +
                                       1U);
}
...
static uint64 get_SLOW_RUN_CLK_Frequency(void)
{
    return get_CORE_CLK_Frequency() / ((((uint64)IP_SCG->RCCR & (uint64)SCG_RCCR_DIVSLOW_MASK) >>
                                        (uint64)SCG_RCCR_DIVSLOW_SHIFT) +
                                       1U);
}
...
static uint64 get_SCS_VLPR_CLK_Frequency(void)
{
    return FreqTableSCS[((IP_SCG->VCCR & SCG_VCCR_SCS_MASK) >> SCG_VCCR_SCS_SHIFT) &
                        0x7U](); /*  Selector value */
}
...
static uint64 get_CORE_VLPR_CLK_Frequency(void)
{
    return get_SCS_VLPR_CLK_Frequency() /
           ((((uint64)IP_SCG->VCCR & (uint64)SCG_VCCR_DIVCORE_MASK) >>
             (uint64)SCG_VCCR_DIVCORE_SHIFT) +
            1U);
}
...
static uint64 get_BUS_VLPR_CLK_Frequency(void)
{
    return get_CORE_VLPR_CLK_Frequency() /
           ((((uint64)IP_SCG->VCCR & (uint64)SCG_VCCR_DIVBUS_MASK) >>
             (uint64)SCG_VCCR_DIVBUS_SHIFT) +
            1U);
}
...
{
    return get_CORE_VLPR_CLK_Frequency() /
           ((((uint64)IP_SCG->VCCR & (uint64)SCG_VCCR_DIVSLOW_MASK) >>
             (uint64)SCG_VCCR_DIVSLOW_SHIFT) +
            1U);
}
...
static uint64 get_RTC_CLK_Frequency(void)
{
    return FreqTableRtc[((IP_SIM->LPOCLKS & SIM_LPOCLKS_RTCCLKSEL_MASK) >>
                         SIM_LPOCLKS_RTCCLKSEL_SHIFT)](); /*  Selector value */
}

/* Return LPO_CLK frequency */
static uint64 get_LPO_CLK_Frequency(void)
{
    return FreqTableLpo[((IP_SIM->LPOCLKS & SIM_LPOCLKS_LPOCLKSEL_MASK) >>
                         SIM_LPOCLKS_LPOCLKSEL_SHIFT)](); /*  Selector value */
}

/* Return SCG_CLKOUT_CL frequency */
static uint64 get_SCG_CLKOUT_CLK_Frequency(void)
{
    return FreqTableScg[((IP_SCG->CLKOUTCNFG & SCG_CLKOUTCNFG_CLKOUTSEL_MASK) >>
...
static uint64 get_FTM0_EXT_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableSimFtm[((IP_SIM->FTMOPT0 & SIM_FTMOPT0_FTM0CLKSEL_MASK) >>
                                        SIM_FTMOPT0_FTM0CLKSEL_SHIFT)](); /*  Selector value */
}

/* Return FTM1_EXT_CLK frequency */
static uint64 get_FTM1_EXT_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableSimFtm[((IP_SIM->FTMOPT0 & SIM_FTMOPT0_FTM1CLKSEL_MASK) >>
                                        SIM_FTMOPT0_FTM1CLKSEL_SHIFT)](); /*  Selector value */
}
...
static uint64 get_FTM2_EXT_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableSimFtm[((IP_SIM->FTMOPT0 & SIM_FTMOPT0_FTM2CLKSEL_MASK) >>
                                        SIM_FTMOPT0_FTM2CLKSEL_SHIFT)](); /*  Selector value */
}
#endif
...
static uint64 get_FTM3_EXT_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableSimFtm[((IP_SIM->FTMOPT0 & SIM_FTMOPT0_FTM3CLKSEL_MASK) >>
                                        SIM_FTMOPT0_FTM3CLKSEL_SHIFT)](); /*  Selector value */
}
#endif
...
static uint64 get_FTM4_EXT_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableSimFtm[((IP_SIM->FTMOPT0 & SIM_FTMOPT0_FTM4CLKSEL_MASK) >>
                                        SIM_FTMOPT0_FTM4CLKSEL_SHIFT)](); /*  Selector value */
}
#endif
...
static uint64 get_FTM5_EXT_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableSimFtm[((IP_SIM->FTMOPT0 & SIM_FTMOPT0_FTM5CLKSEL_MASK) >>
                                        SIM_FTMOPT0_FTM5CLKSEL_SHIFT)](); /*  Selector value */
}
#endif
...
static uint64 get_FTM6_EXT_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableSimFtm[((IP_SIM->FTMOPT0 & SIM_FTMOPT0_FTM6CLKSEL_MASK) >>
                                        SIM_FTMOPT0_FTM6CLKSEL_SHIFT)](); /*  Selector value */
}
#endif
...
static uint64 get_FTM7_EXT_CLK_Frequency(void)
{
    return Clock_Ip_apfFreqTableSimFtm[((IP_SIM->FTMOPT0 & SIM_FTMOPT0_FTM7CLKSEL_MASK) >>
                                        SIM_FTMOPT0_FTM7CLKSEL_SHIFT)](); /*  Selector value */
}
#endif
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[59U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[59U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[39U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[39U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_CLKOUT0_CLK_Frequency(void)
{
    ...
    uint64 Frequency = FreqTableClkOut[((IP_SIM->CHIPCTL & SIM_CHIPCTL_CLKOUTSEL_MASK) >>
                                        SIM_CHIPCTL_CLKOUTSEL_SHIFT)](); /*  Selector value */
    Frequency &= EnableDivider[((IP_SIM->CHIPCTL & SIM_CHIPCTL_CLKOUTEN_MASK) >>
                                SIM_CHIPCTL_CLKOUTEN_SHIFT)]; /*  Divider enable/disable */
    Frequency /= ((((uint64)IP_SIM->CHIPCTL & (uint64)SIM_CHIPCTL_CLKOUTDIV_MASK) >>
                   (uint64)SIM_CHIPCTL_CLKOUTDIV_SHIFT) +
                  1U); /*  Apply divider value */
    return Frequency;
}
...
static uint64 get_CMP0_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[115] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_CMU0_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[62] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_CMU1_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[63] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_CRC0_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[50] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_DMA0_CLK_Frequency(void)
{
    ...
    Frequency &= Clock_Ip_u32EnableGate[((IP_SIM->PLATCGC & SIM_PLATCGC_CGCDMA_MASK) >>
...
static uint64 get_DMAMUX0_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[33] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_EIM0_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency = get_CORE_CLK_Frequency();
    Frequency &= Clock_Ip_u32EnableGate[((IP_SIM->PLATCGC & SIM_PLATCGC_CGCEIM_MASK) >>
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs1[((IP_PCC->PCCn[121U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    ...
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[121U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
...
static uint64 get_ERM0_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency = get_CORE_CLK_Frequency();
    Frequency &= Clock_Ip_u32EnableGate[((IP_SIM->PLATCGC & SIM_PLATCGC_CGCERM_MASK) >>
...
static uint64 get_EWM0_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[97U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_FLEXCAN0_CLK_Frequency(void)
{
    ...
    Frequency = get_CORE_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[36U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_FLEXCAN1_CLK_Frequency(void)
{
    ...
    Frequency = get_CORE_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[37U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_FLEXCAN2_CLK_Frequency(void)
{
    ...
    Frequency = get_CORE_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[43U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_FTM0_CLK_Frequency(void)
{
    ...
    if (((IP_PCC->PCCn[56U] & PCC_PCCn_PCS_MASK) >> PCC_PCCn_PCS_SHIFT) != 0U) {
        Frequency = Clock_Ip_apfFreqTablePcs1[((IP_PCC->PCCn[56U] & PCC_PCCn_PCS_MASK) >>
                                               PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    } else {
        Frequency = get_FTM0_EXT_CLK_Frequency();
    }
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[56U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_FTM1_CLK_Frequency(void)
{
    ...
    if (((IP_PCC->PCCn[57U] & PCC_PCCn_PCS_MASK) >> PCC_PCCn_PCS_SHIFT) != 0U) {
        Frequency = Clock_Ip_apfFreqTablePcs1[((IP_PCC->PCCn[57U] & PCC_PCCn_PCS_MASK) >>
                                               PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    } else {
        Frequency = get_FTM1_EXT_CLK_Frequency();
    }
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[57U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_FTM2_CLK_Frequency(void)
{
    ...
    if (((IP_PCC->PCCn[58U] & PCC_PCCn_PCS_MASK) >> PCC_PCCn_PCS_SHIFT) != 0U) {
        Frequency = Clock_Ip_apfFreqTablePcs1[((IP_PCC->PCCn[58U] & PCC_PCCn_PCS_MASK) >>
                                               PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    } else {
        Frequency = get_FTM2_EXT_CLK_Frequency();
    }
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[58U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_FTM3_CLK_Frequency(void)
{
    ...
    if (((IP_PCC->PCCn[38U] & PCC_PCCn_PCS_MASK) >> PCC_PCCn_PCS_SHIFT) != 0U) {
        Frequency = Clock_Ip_apfFreqTablePcs1[((IP_PCC->PCCn[38U] & PCC_PCCn_PCS_MASK) >>
                                               PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    } else {
        Frequency = get_FTM3_EXT_CLK_Frequency();
    }
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[38U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_FTM4_CLK_Frequency(void)
{
    ...
    if (((IP_PCC->PCCn[110U] & PCC_PCCn_PCS_MASK) >> PCC_PCCn_PCS_SHIFT) != 0U) {
        Frequency = Clock_Ip_apfFreqTablePcs1[((IP_PCC->PCCn[110U] & PCC_PCCn_PCS_MASK) >>
                                               PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    } else {
        Frequency = get_FTM4_EXT_CLK_Frequency();
    }
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[110U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_FTM5_CLK_Frequency(void)
{
    ...
    if (((IP_PCC->PCCn[111U] & PCC_PCCn_PCS_MASK) >> PCC_PCCn_PCS_SHIFT) != 0U) {
        Frequency = Clock_Ip_apfFreqTablePcs1[((IP_PCC->PCCn[111U] & PCC_PCCn_PCS_MASK) >>
                                               PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    } else {
        Frequency = get_FTM5_EXT_CLK_Frequency();
    }
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[111U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_FTM6_CLK_Frequency(void)
{
    ...
    if (((IP_PCC->PCCn[112U] & PCC_PCCn_PCS_MASK) >> PCC_PCCn_PCS_SHIFT) != 0U) {
        Frequency = Clock_Ip_apfFreqTablePcs1[((IP_PCC->PCCn[112U] & PCC_PCCn_PCS_MASK) >>
                                               PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    } else {
        Frequency = get_FTM6_EXT_CLK_Frequency();
    }
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[112U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_FTM7_CLK_Frequency(void)
{
    ...
    if (((IP_PCC->PCCn[113U] & PCC_PCCn_PCS_MASK) >> PCC_PCCn_PCS_SHIFT) != 0U) {
        Frequency = Clock_Ip_apfFreqTablePcs1[((IP_PCC->PCCn[113U] & PCC_PCCn_PCS_MASK) >>
                                               PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    } else {
        Frequency = get_FTM7_EXT_CLK_Frequency();
    }
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[113U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_GPIO0_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency = get_CORE_CLK_Frequency();
    Frequency &= Clock_Ip_u32EnableGate[((IP_SIM->PLATCGC & SIM_PLATCGC_CGCGPIO_MASK) >>
                                         SIM_PLATCGC_CGCGPIO_SHIFT)];
    return Frequency;
}
#endif
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[90U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[90U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_FTFC_CLK_Frequency(void)
{
    ...
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[32U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[102U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[102U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[103U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[103U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[55U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[55U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[44U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[44U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[45U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[45U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[46U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[46U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_LPTMR0_CLK_Frequency(void)
{
    uint64 Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[64U] & PCC_PCCn_PCS_MASK) >>
                                                  PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    uint64 DivValue =
        (((uint64)IP_PCC->PCCn[64U] & (uint64)PCC_PCCn_PCD_MASK) >> (uint64)PCC_PCCn_PCD_SHIFT) +
        1U;
    uint64 MulValue =
        (((uint64)IP_PCC->PCCn[64U] & (uint64)PCC_PCCn_FRAC_MASK) >> (uint64)PCC_PCCn_FRAC_SHIFT) +
        1U;
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[64U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return ((Frequency * MulValue) / DivValue);
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[106U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[106U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[107U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[107U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
{
    uint64 Frequency;
    Frequency = Clock_Ip_apfFreqTablePcs2[((IP_PCC->PCCn[108U] & PCC_PCCn_PCS_MASK) >>
                                           PCC_PCCn_PCS_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[108U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_MPU0_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency = get_CORE_CLK_Frequency();
    Frequency &= Clock_Ip_u32EnableGate[((IP_SIM->PLATCGC & SIM_PLATCGC_CGCMPU_MASK) >>
...
static uint64 get_MSCM0_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency = get_CORE_CLK_Frequency();
    Frequency &= Clock_Ip_u32EnableGate[((IP_SIM->PLATCGC & SIM_PLATCGC_CGCMSCM_MASK) >>
...
static uint64 get_PDB0_CLK_Frequency(void)
{
    ...
    Frequency = get_CORE_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[54U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_PDB1_CLK_Frequency(void)
{
    ...
    Frequency = get_CORE_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[49U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_PORTA_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[73U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_PORTB_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[74U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_PORTC_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[75U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_PORTD_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[76U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_PORTE_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[77U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_QSPI_CLK_Frequency(void)
{
    ...
    if (Clock_Ip_u32EnableGate[((IP_PCC->PCCn[118U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)] ==
        CLOCK_IP_ENABLED) {
        Clkmodeselect =
            (uint8)((IP_QuadSPI->MCR & QuadSPI_MCR_SCLKCFG_6_MASK) >> QuadSPI_MCR_SCLKCFG_6_SHIFT);
        if (Clkmodeselect != 0U) {
            Frequency = get_BUS_CLK_Frequency();
        } else {
            Frequency = get_CORE_CLK_Frequency();
...
static uint64 get_QSPI_SFIF_CLK_HYP_PREMUX_CLK_Frequency(void)
{
    ...
    if (Clock_Ip_u32EnableGate[((IP_PCC->PCCn[118U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)] ==
        CLOCK_IP_ENABLED) {
        DivConfig = (uint8)((IP_QuadSPI->SOCCR & QuadSPI_SOCCR_SOCCFG_DIV_MASK) >>
                            QuadSPI_SOCCR_SOCCFG_DIV_SHIFT);
        Clkmodeselect =
            (uint8)((IP_QuadSPI->MCR & QuadSPI_MCR_SCLKCFG_4_MASK) >> QuadSPI_MCR_SCLKCFG_4_SHIFT);
        if (Clkmodeselect != 0U) {
        ...
        Frequency &=
            Clock_Ip_u32EnableGate[((IP_SIM->MISCTRL0 & SIM_MISCTRL0_QSPI_CLK_SEL_GATE_MASK) >>
                                    SIM_MISCTRL0_QSPI_CLK_SEL_GATE_SHIFT)];
    } else {
        Frequency = get_Zero_Frequency();
    }
...
static uint64 get_QSPI_SFIF_CLK_Frequency(void)
{
    ...
    if (Clock_Ip_u32EnableGate[((IP_PCC->PCCn[118U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)] ==
        CLOCK_IP_ENABLED) {
        Clkmodeselect =
            (uint8)((IP_QuadSPI->MCR & QuadSPI_MCR_SCLKCFG_5_MASK) >> QuadSPI_MCR_SCLKCFG_5_SHIFT);
        if (Clkmodeselect != 0U) {
...
{
    uint64 Frequency;
    Frequency = FreqTableRtc[((IP_SIM->LPOCLKS & SIM_LPOCLKS_RTCCLKSEL_MASK) >>
                              SIM_LPOCLKS_RTCCLKSEL_SHIFT)](); /*  Selector value */
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[61U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
...
static uint64 get_SAI0_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[84U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_SAI1_CLK_Frequency(void)
{
    ...
    Frequency = get_BUS_CLK_Frequency();
    Frequency &=
        Clock_Ip_u32EnableGate[((IP_PCC->PCCn[85U] & PCC_PCCn_CGC_MASK) >> PCC_PCCn_CGC_SHIFT)];
    return Frequency;
}
#endif
...
static uint64 get_TRACE_CLK_Frequency(void)
{
    uint64 Frequency;
    Frequency = get_CORE_CLK_Frequency();
    Frequency &= Clock_Ip_u32EnableGate[((IP_SIM->CLKDIV4 & SIM_CLKDIV4_TRACEDIVEN_MASK) >>
                                         SIM_CLKDIV4_TRACEDIVEN_SHIFT)];
    uint64 DivValue = (((uint64)IP_SIM->CLKDIV4 & (uint64)SIM_CLKDIV4_TRACEDIV_MASK) >>
                       (uint64)SIM_CLKDIV4_TRACEDIV_SHIFT) +
                      1U;
    uint64 MulValue = (((uint64)IP_SIM->CLKDIV4 & (uint64)SIM_CLKDIV4_TRACEFRAC_MASK) >>
                       (uint64)SIM_CLKDIV4_TRACEFRAC_SHIFT) +
                      1U;
    return ((Frequency * MulValue) / DivValue);
}
#endif
...
static uint64 PLL_VCO(SCG_Type const* Base)
{
...
#if (defined(CLOCK_IP_DERIVATIVE_004) || defined(CLOCK_IP_DERIVATIVE_006) ||                       \
     defined(CLOCK_IP_DERIVATIVE_012))
...
#endif
    Prediv = ((((uint64)Base->SPLLCFG & (uint64)SCG_SPLLCFG_PREDIV_MASK) >>
               (uint64)SCG_SPLLCFG_PREDIV_SHIFT) +
              1U)
             << 1U; /* Prediv * 2 */
    Mul = (((uint64)Base->SPLLCFG & (uint64)SCG_SPLLCFG_MULT_MASK) >>
           (uint64)SCG_SPLLCFG_MULT_SHIFT) +
          16U; /* mfi */
    ...
    if (0U != Fin) {
        ...
        if ((Var2 == ((uint64)(Fin * Var2) / Fin)) && (CLOCK_IP_PLL_VCO_MAX_FREQ >= Fout)) {
            Fout +=
                (Fin * Var2) / Prediv; /* Fin divide by (Prediv multiply by 2) multiply by Var2; */
        } else {
            Overflow = TRUE;
        }
    }
