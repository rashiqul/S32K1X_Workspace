...
/* Check if current file and Power_Ip_Private header file are of the same Autosar version */
     ...
     (POWER_IP_PRIVATE_AR_RELEASE_REVISION_VERSION_C !=                                            \
      POWER_IP_PRIVATE_AR_RELEASE_REVISION_VERSION))
 ...
 *
 *END**************************************************************************/
void Power_Ip_StartTimeout(uint32* StartTimeOut, uint32* ElapsedTimeOut, uint32* TimeoutTicksOut,
                           uint32 TimeoutUs)
{
 ...
 *
 *END**************************************************************************/
boolean Power_Ip_TimeoutExpired(uint32* StartTimeInOut, uint32* ElapsedTimeInOut,
                                uint32 TimeoutTicks)
{
