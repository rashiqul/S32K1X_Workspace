...
static inline Std_ReturnType Dio_ValidatePortForRead(Dio_PortType PortId, uint8 u8ServiceId);

static inline Std_ReturnType Dio_ValidatePortForWrite(Dio_PortType PortId, uint8 u8ServiceId);

static inline Std_ReturnType
Dio_ValidateChannelGroupForWrite(const Dio_ChannelGroupType* pChannelGroup, uint8 u8ServiceId);

static inline Std_ReturnType
Dio_ValidateChannelGroupForRead(const Dio_ChannelGroupType* pChannelGroup, uint8 u8ServiceId);
...
static inline Std_ReturnType Dio_ValidateChannelLevel(Dio_LevelType Level)
{
    ...
    if (((Dio_LevelType)STD_HIGH == Level) || ((Dio_LevelType)STD_LOW == Level)) {
        ...
        (void)Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, DIO_WRITECHANNEL_ID,
                              DIO_E_PARAM_LEVEL);
    }
                                                         ...
                                                         uint8 u8ServiceId)
{
    ...
    if (SIUL2_DIO_IP_MAX_MSCR_REGISTERS <= ChannelId) {
        maxChannelId =
            (Dio_ChannelType)(SIUL2_DIO_IP_MAX_MSCR_REGISTERS + SIUL2_DIO_IP_MAX_SIUL2_AE_CHANNELS);
    }
    ...
    if ((((Dio_ChannelType)(ChannelId) <= (Dio_ChannelType)maxChannelId)) &&
...
#ifdef SIUL2_DIO_IP_HAS_SIUL2_AE_INSTANCE
        if (SIUL2_DIO_IP_MAX_MSCR_REGISTERS <= ChannelId) {
            u32ChannelToPartitionMap =
                Dio_ConfigPC
                    .pau32Dio_ChannelAEToPartitionMap[(ChannelId)-SIUL2_DIO_IP_MAX_MSCR_REGISTERS];
        } else {
        ...
        if (DIO_MAX_PARTITION < PartitionId) {
            (void)Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, u8ServiceId,
                                  DIO_E_PARAM_CONFIG);
        } else {
#endif /* (STD_ON == DIO_MULTIPARTITION_ENABLED) */
            if ((uint32)1 ==
                ((u32ChannelToPartitionMap & ((uint32)1 << PartitionId)) >> PartitionId)) {
                Valid = (Std_ReturnType)E_OK;
            } else {
                (void)Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, u8ServiceId,
                                      DIO_E_PARAM_CONFIG);
...
#endif /* (STD_ON == DIO_MULTIPARTITION_ENABLED) */
            if ((uint32)1 ==
                ((Dio_ConfigPC.pau32Dio_PortToPartitionMap[PortId] & ((uint32)1 << PartitionId)) >>
                 PartitionId)) {
                Valid = (Std_ReturnType)E_OK;
            } else {
                (void)Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, u8ServiceId,
...
Dio_ValidateChannelGroupForWrite(const Dio_ChannelGroupType* pChannelGroup, uint8 u8ServiceId)
{
    ...
    /* Compiler_Warning: Pointer to channel group is converted to unsigned long in order for it to
        ...
        if ((((pointerSizeType)(pChannelGroup)) >=
             ((pointerSizeType)Dio_ConfigPC.pChannelGroupList)) &&
            (((pointerSizeType)(pChannelGroup)) <=
             (pointerSizeType)(&Dio_ConfigPC
                                    .pChannelGroupList[Dio_ConfigPC.u8NumChannelGroups - 1U])) &&
...
Dio_ValidateChannelGroupForRead(const Dio_ChannelGroupType* pChannelGroup, uint8 u8ServiceId)
{
    ...
    if (NULL_PTR == pChannelGroup) {
        ...
        u8ChannelGroup = pChannelGroup->port;
        /* Compiler_Warning: Pointer to channel group is converted to unsigned long in order for it
           to be compared with the boundaries of the channel group list. */
        if ((((pointerSizeType)(pChannelGroup)) >=
             ((pointerSizeType)Dio_ConfigPC.pChannelGroupList)) &&
            (((pointerSizeType)(pChannelGroup)) <=
             (pointerSizeType)(&Dio_ConfigPC
...
void Dio_GetVersionInfo(Std_VersionInfoType* VersionInfo)
{
    ...
    if (NULL_PTR == VersionInfo) {
        (void)Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, DIO_GETVERSIONINFO_ID,
                              DIO_E_PARAM_POINTER);
    } else
#endif /* (STD_ON == DIO_DEV_ERROR_DETECT) */
    {
...
#if (STD_ON == DIO_MULTIPARTITION_ENABLED)
    if (DIO_MAX_PARTITION < PartitionId) {
        (void)Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, DIO_READCHANNELGROUP_ID,
                              DIO_E_PARAM_CONFIG);
    } else {
#endif /* (STD_ON == DIO_MULTIPARTITION_ENABLED) */
#endif /* DIO_CHANNEL_GROUPS_AVAILABLE */
        if ((Std_ReturnType)E_OK == Valid) {
            ...
            for (GroupIndex = 0; GroupIndex < Dio_ConfigPC.u8NumChannelGroups; GroupIndex++) {
                if (Dio_pxChannelGroupsListForEachPartition[PartitionId][GroupIndex] ==
                    ChannelGroupIdPtr) {
                    GroupAlocated = 1;
                }
            }
            if ((uint8)1 == GroupAlocated) {
                ...
                (void)Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID,
                                      DIO_READCHANNELGROUP_ID, DIO_E_PARAM_CONFIG);
            }
#endif /* DIO_CHANNEL_GROUPS_AVAILABLE */
        }
#endif /* DIO_DEV_ERROR_DETECT */
...
#if (STD_ON == DIO_MULTIPARTITION_ENABLED)
    if (DIO_MAX_PARTITION < PartitionId) {
        (void)Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID, DIO_WRITECHANNELGROUP_ID,
                              DIO_E_PARAM_CONFIG);
    } else {
#endif /* (STD_ON == DIO_MULTIPARTITION_ENABLED) */
#endif /* DIO_CHANNEL_GROUPS_AVAILABLE */
        if ((Std_ReturnType)E_OK == Valid) {
            ...
            if ((uint8)1 == GroupAlocated) {
                ...
                (void)Det_ReportError((uint16)DIO_MODULE_ID, DIO_INSTANCE_ID,
                                      DIO_WRITECHANNELGROUP_ID, DIO_E_PARAM_CONFIG);
            }
#endif /* DIO_CHANNEL_GROUPS_AVAILABLE */
        }
#ifdef DIO_CHANNEL_GROUPS_AVAILABLE
