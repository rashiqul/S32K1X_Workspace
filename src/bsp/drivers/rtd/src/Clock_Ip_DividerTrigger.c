...
/* Check if Clock_Ip_DividerTrigger.c file and Clock_Ip_Private.h file are of the same Autosar
 * version */
#if ((CLOCK_IP_DIVIDERTRIGGER_AR_RELEASE_MAJOR_VERSION_C !=                                        \
      CLOCK_IP_PRIVATE_AR_RELEASE_MAJOR_VERSION) ||                                                \
     (CLOCK_IP_DIVIDERTRIGGER_AR_RELEASE_MINOR_VERSION_C !=                                        \
      CLOCK_IP_PRIVATE_AR_RELEASE_MINOR_VERSION) ||                                                \
     (CLOCK_IP_DIVIDERTRIGGER_AR_RELEASE_REVISION_VERSION_C !=                                     \
...
/* Check if Clock_Ip_DividerTrigger.c file and Clock_Ip_Private.h file are of the same Software
 * version */
...
const Clock_Ip_DividerTriggerCallbackType
