...
static Clock_Ip_PllStatusReturnType Clock_Ip_CompleteSpll(Clock_Ip_NameType PllName)
{
    ...
    if ((IP_SCG->SPLLCSR & SCG_SPLLCSR_SPLLEN_MASK) != 0U) {
        ...
        do {
            SpllStatus =
                (((IP_SCG->SPLLCSR & SCG_SPLLCSR_SPLLVLD_MASK) >> SCG_SPLLCSR_SPLLVLD_SHIFT));
    ...
    if (1U == Config->Enable) {
     ...
     defined(CLOCK_IP_DERIVATIVE_012))
        ...
        case CLOCK_IP_HAS_MONITOR_DISABLE: {
            IP_SCG->SPLLCSR = SCG_SPLLCSR_SPLLCM(0UL) | SCG_SPLLCSR_SPLLCMRE(0UL);
        } break;
#endif
#ifdef CLOCK_IP_HAS_MONITOR_INT
        case CLOCK_IP_HAS_MONITOR_INT: {
            IP_SCG->SPLLCSR = SCG_SPLLCSR_SPLLCM(1UL) | SCG_SPLLCSR_SPLLCMRE(0UL);
        } break;
#endif
#ifdef CLOCK_IP_HAS_MONITOR_RESET
        case CLOCK_IP_HAS_MONITOR_RESET: {
            IP_SCG->SPLLCSR = SCG_SPLLCSR_SPLLCM(1UL) | SCG_SPLLCSR_SPLLCMRE(1UL);
        } break;
#endif
        default:
