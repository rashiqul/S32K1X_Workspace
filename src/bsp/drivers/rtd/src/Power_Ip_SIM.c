 ...
 * @param[in] SRAMRetenConfig       The value will be configured to SRAML_RETEN and SRAMU_RETEN
 * bits. MCU_SRAML_RETEN - SRAML will be retain only. MCU_SRAMU_RETEN - SRAMU will be retain only.
