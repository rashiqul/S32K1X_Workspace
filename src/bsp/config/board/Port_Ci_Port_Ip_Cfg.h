...
#endif
/* Check if the files Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_Types.h are of the same Autosar
 * version */
#if ((PORT_CI_PORT_IP_AR_RELEASE_MAJOR_VERSION_CFG_H !=                                            \
...
#endif
/* Check if the files Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_Types.h are of the same software
 * version */
...
#endif
/* Check if the files Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_PBcfg.h are of the same Autosar
 * version */
#if ((PORT_CI_PORT_IP_AR_RELEASE_MAJOR_VERSION_CFG_H !=                                            \
      PORT_CI_PORT_IP_AR_RELEASE_MAJOR_VERSION_VS_0_PBCFG_H) ||                                    \
     (PORT_CI_PORT_IP_AR_RELEASE_MINOR_VERSION_CFG_H !=                                            \
      PORT_CI_PORT_IP_AR_RELEASE_MINOR_VERSION_VS_0_PBCFG_H) ||                                    \
     (PORT_CI_PORT_IP_AR_RELEASE_REVISION_VERSION_CFG_H !=                                         \
      PORT_CI_PORT_IP_AR_RELEASE_REVISION_VERSION_VS_0_PBCFG_H))
#error                                                                                             \
    "AutoSar Version Numbers of Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_VS_0_PBcfg.h are different"
#endif
/* Check if the files Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_PBcfg.h are of the same software
 * version */
...
#error                                                                                             \
    "Software Version Numbers of Port_Ci_Port_Ip_Cfg.h and Port_Ci_Port_Ip_VS_0_PBcfg.h are different"
#endif
