 ...
 * @details A port pin shall be configurable with a number of port pin modes (type
 * Port_PinModeType). The type Port_PinModeType shall be used with the function call Port_SetPinMode
...
/**
 * @brief Enable/Disable Port_SetPinMode function updating the output level of the pins configured
 * at runtime as GPIO
 */
...
typedef struct {
    ...
    const Port_Ci_Port_Ip_DigitalFilterConfigType*
        pDigitalFilterConfig;                  /**< @brief Digital filter ports configuration */
