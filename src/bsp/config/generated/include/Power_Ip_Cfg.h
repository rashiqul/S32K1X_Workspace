...
/* Check if Power_Ip_Cfg.h file and Power_Ip_VS_0_PBcfg.h file are of the same Autosar version */
     ...
     (POWER_IP_CFG_AR_RELEASE_REVISION_VERSION !=                                                  \
      POWER_IP_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION))
...
==================================================================================================*/
/**
 * @brief            Detection and reporting of development errors(API parameter checking) at IP
 * level shall be pre compile time configurable.
 ...
 *               If this parameter has been configured to 'TRUE' the Power can be executed from both
...
/***********************************************************/
/** @brief This is the corresponding bit of Stop Acknowledge Error reset in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_SACKERR ((uint32)0x00002000U)
/** @brief This is the corresponding bit of MDM-AP System Reset Request in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_MDM_AP ((uint32)0x00000800U)
/** @brief This is the corresponding bit of Software reset in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_SW ((uint32)0x00000400U)
/** @brief This is the corresponding bit of Stop Core Lockup reset in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_LOCKUP ((uint32)0x00000200U)
/** @brief This is the corresponding bit of JTAG generated reset in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_JTAG ((uint32)0x00000100U)
/** @brief This is the corresponding bit of Power-on reset in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_POR ((uint32)0x00000080U)
/** @brief This is the corresponding bit of external pin reset in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_PIN ((uint32)0x00000040U)
/** @brief This is the corresponding bit of watchdog reset in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_WDOG ((uint32)0x00000020U)
/** @brief This is the corresponding bit of CMU Loss-of-Lock reset in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_CMU_LOC ((uint32)0x00000010U)
/** @brief This is the corresponding bit of Loss-of-Lock reset in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_LOL ((uint32)0x00000008U)
/** @brief This is the corresponding bit of Loss-of-Clock reset in the returned value of
 * Mcu_GetResetRawReason */
#define MCU_RAW_RESET_LOC ((uint32)0x00000004U)
/** @brief This is the corresponding bit of Low-Voltage Detect reset or High-Voltage Detect reset in
 * the returned value of Mcu_GetResetRawReason */
...
==================================================================================================*/
/**
 * @brief            The type Power_Ip_ResetType, represents the different reset that a specified
 * POWER_IP can have.
 * @details          The POWER_IP shall provide at least the values MCU_POWER_ON_RESET and
 * MCU_RESET_UNDEFINED for the enumeration Power_Ip_ResetType.
 *
 * @implements Power_Ip_ResetType_Enumeration
 */
typedef enum {
    MCU_STOP_ACKNOWLEDGE_ERROR_RESET =
        McuConf_McuResetReasonConf_MCU_STOP_ACKNOWLEDGE_ERROR_RESET, /**< @brief Stop Acknowledge
                                                                        Error reset .
                                                                        RCM_SRS[SACKERR]. */
    MCU_MDM_AP_SYSTEM_RESET =
        McuConf_McuResetReasonConf_MCU_MDM_AP_SYSTEM_RESET, /**< @brief MDM-AP System Reset Request
                                                               . RCM_SRS[MDM_AP]. */
    MCU_SW_RESET =
        McuConf_McuResetReasonConf_MCU_SW_RESET, /**< @brief Software reset . RCM_SRS[SW]. */
    MCU_CORE_LOCKUP_RESET =
        McuConf_McuResetReasonConf_MCU_CORE_LOCKUP_RESET,       /**< @brief Core Lockup reset .
                                                                   RCM_SRS[LOCKUP]. */
    MCU_JTAG_RESET = McuConf_McuResetReasonConf_MCU_JTAG_RESET, /**< @brief JTAG generated reset .
                                                                   RCM_SRS[JTAG]. */
    MCU_POWER_ON_RESET =
        McuConf_McuResetReasonConf_MCU_POWER_ON_RESET, /**< @brief Power-on reset. RCM_SRS[POR]. */
    MCU_EXTERNAL_PIN_RESET =
        McuConf_McuResetReasonConf_MCU_EXTERNAL_PIN_RESET, /**< @brief External Reset Pin.
                                                              RCM_SRS[PIN]. */
    MCU_WATCHDOG_RESET = McuConf_McuResetReasonConf_MCU_WATCHDOG_RESET, /**< @brief Watchdog reset.
                                                                           RCM_SRS[Watchdog]. */
    MCU_CMU_LOSS_OF_CLOCK_RESET =
        McuConf_McuResetReasonConf_MCU_CMU_LOSS_OF_CLOCK_RESET, /**< @brief CMU Loss-of-Clock Reset.
                                                                   RCM_SRS[CMU_LOC]. */
    MCU_LOSS_OF_LOCK_RESET =
        McuConf_McuResetReasonConf_MCU_LOSS_OF_LOCK_RESET, /**< @brief Loss-of-Lock Reset.
                                                              RCM_SRS[LOL]. */
    MCU_LOSS_OF_CLOCK_RESET =
        McuConf_McuResetReasonConf_MCU_LOSS_OF_CLOCK_RESET, /**< @brief Loss-of-Clock Reset.
                                                               RCM_SRS[LOC]. */
    MCU_LOW_OR_HIGH_VOLTAGE_DETECT_RESET =
        McuConf_McuResetReasonConf_MCU_LOW_OR_HIGH_VOLTAGE_DETECT_RESET, /**< @brief Low-Voltage
                                                                            Detect Reset or
                                                                            High-Voltage Detect
                                                                            Reset. RCM_SRS[LVD]. */

    MCU_NO_RESET_REASON =
        McuConf_McuResetReasonConf_MCU_NO_RESET_REASON, /**< @brief No reset reason found */
    MCU_MULTIPLE_RESET_REASON =
        McuConf_McuResetReasonConf_MCU_MULTIPLE_RESET_REASON, /**< @brief More than one reset events
                                                                 are logged except "Power on event"
                                                               */
    MCU_RESET_UNDEFINED =
        McuConf_McuResetReasonConf_MCU_RESET_UNDEFINED /**< @brief Undefined reset source. */

} Power_Ip_ResetType;

/**
 * @brief            Type of parameter value of the function Mcu_SRAMRetentionConfig.
 * @details          The type of Power_Ip_SRAMRetenConfigType is an enumeration with the following
 * values: MCU_SRAML_RETEN, MCU_SRAMU_RETEN, MCU_SRAMLU_RETEN, MCU_NO_SRAMLU_RETEN.
 */
typedef enum {
    ...
    MCU_NO_SRAMLU_RETEN =
        (uint32)0x00300000U, /**< @brief Both SRAML and SRAMU will not be retain. */
