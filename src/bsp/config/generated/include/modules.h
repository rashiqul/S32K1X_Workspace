...
/**
 * @brief This constant used for other modules to check if CAN_43_CANEXCEL is present in the
 * project.
 */
...
/**
 * @brief This constant used for other modules to check if Lin_43_LPUART_FLEXIO is present in the
 * project.
 */
#define USE_LIN_43_LPUART_FLEXIO_MODULE (STD_OFF)

/**
 * @brief This constant used for other modules to check if Lin_43_LINFLEXD is present in the
 * project.
 */
...
/**
 * @brief This constant used for other modules to check if WDG Instance 10 is present in the
 * project.
 */
#define USE_WDG_INSTANCE10 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 11 is present in the
 * project.
 */
#define USE_WDG_INSTANCE11 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 12 is present in the
 * project.
 */
#define USE_WDG_INSTANCE12 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 13 is present in the
 * project.
 */
#define USE_WDG_INSTANCE13 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 14 is present in the
 * project.
 */
#define USE_WDG_INSTANCE14 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 15 is present in the
 * project.
 */
#define USE_WDG_INSTANCE15 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 16 is present in the
 * project.
 */
#define USE_WDG_INSTANCE16 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 17 is present in the
 * project.
 */
#define USE_WDG_INSTANCE17 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 18 is present in the
 * project.
 */
#define USE_WDG_INSTANCE18 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 19 is present in the
 * project.
 */
#define USE_WDG_INSTANCE19 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 20 is present in the
 * project.
 */
#define USE_WDG_INSTANCE20 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 21 is present in the
 * project.
 */
#define USE_WDG_INSTANCE21 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 22 is present in the
 * project.
 */
#define USE_WDG_INSTANCE22 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 23 is present in the
 * project.
 */
#define USE_WDG_INSTANCE23 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 24 is present in the
 * project.
 */
#define USE_WDG_INSTANCE24 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 25 is present in the
 * project.
 */
#define USE_WDG_INSTANCE25 (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG Instance 26 is present in the
 * project.
 */
#define USE_WDG_INSTANCE26 (STD_OFF)

/**
 * @brief This constant used for other modules to check if any WDG Instance is present in the
 * project.
 */
#define USE_WDG_INSTANCE_ANY (STD_OFF)

/**
 * @brief This constant used for other modules to check if WDG for chip vr5510 is present in the
 * project.
 */
