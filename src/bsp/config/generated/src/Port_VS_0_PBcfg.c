...
#define PORT_SW_MAJOR_VERSION_VS_0_PBCFG_C 3
 ...
 */
static const uint8 au8Port_PartitionList_VS_0[PORT_MAX_PARTITION] = {(uint8)1};
...
static const uint16 Port_au16NoUnUsedPadsArrayDefault_VS_0[PORT_MAX_UNUSED_PADS_U16] = {
    (uint16)0,   (uint16)1,   (uint16)2,   (uint16)3,   (uint16)6,   (uint16)7,   (uint16)8,
    (uint16)9,   (uint16)11,  (uint16)12,  (uint16)13,  (uint16)14,  (uint16)15,  (uint16)16,
    (uint16)17,  (uint16)32,  (uint16)33,  (uint16)34,  (uint16)35,  (uint16)36,  (uint16)37,
    (uint16)38,  (uint16)39,  (uint16)40,  (uint16)41,  (uint16)42,  (uint16)43,  (uint16)44,
    (uint16)45,  (uint16)46,  (uint16)47,  (uint16)48,  (uint16)49,  (uint16)64,  (uint16)65,
    (uint16)66,  (uint16)67,  (uint16)70,  (uint16)71,  (uint16)72,  (uint16)73,  (uint16)74,
    (uint16)75,  (uint16)76,  (uint16)77,  (uint16)78,  (uint16)79,  (uint16)80,  (uint16)81,
    (uint16)97,  (uint16)98,  (uint16)99,  (uint16)100, (uint16)101, (uint16)102, (uint16)103,
    (uint16)104, (uint16)105, (uint16)106, (uint16)107, (uint16)108, (uint16)109, (uint16)110,
    (uint16)111, (uint16)112, (uint16)113, (uint16)128, (uint16)129, (uint16)130, (uint16)131,
    (uint16)132, (uint16)133, (uint16)134, (uint16)135, (uint16)136, (uint16)137, (uint16)138,
    (uint16)139, (uint16)140, (uint16)141, (uint16)142, (uint16)143, (uint16)144};
#endif
...
static const Port_PinConfigType Port_aPinConfigDefault_VS_0[PORT_MAX_CONFIGURED_PADS_U16] = {
     ...
     */
    {(uint16)96, (uint32)0x00000100, (uint8)0, (Port_PinDirectionType)2, (boolean)TRUE,
     (boolean)TRUE, (boolean)TRUE}};

#if (0UL != PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_VS_0_U8)
static const Port_Ci_Port_Ip_DigitalFilterConfigType
    Port_aDigitalFilter_VS_0[PORT_MAX_CONFIGURED_DIGITAL_FILTER_PORTS_VS_0_U8] = {};
 ...
 */
const Port_ConfigType Port_Config = {PORT_MAX_CONFIGURED_PADS_U16,
