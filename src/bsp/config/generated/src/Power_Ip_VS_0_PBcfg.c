...
#if ((POWER_IP_VS_0_PBCFG_AR_RELEASE_MAJOR_VERSION_C !=                                            \
      POWER_IP_VS_0_PBCFG_AR_RELEASE_MAJOR_VERSION) ||                                             \
     (POWER_IP_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION_C !=                                            \
      POWER_IP_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION) ||                                             \
     (POWER_IP_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION_C !=                                         \
...
#error "AutoSar Version Numbers of Power_Ip_VS_0_PBcfg.c  and Std_Types.h are different"
#endif
 ...
 *
 */
static const Power_Ip_RCM_ConfigType Power_Ip_RCM_ConfigPB_VS_0 = {
    /* Reset Pin Control register (RCM_RPC) */
    (RCM_RPC_STOP_ALL_FILTERING_DISABLE_U32 | RCM_RPC_NORMAL_ALL_FILTERING_DISABLE_U32 |
     RCM_RPC_RSTFLTSEL((uint32)(0U))),
    /* System Reset Interrupt Enable Register (RCM_SRIE) */
    (RCM_SRIE_SACKERR_INT_DIS_U32 | RCM_SRIE_MDM_AP_INT_DIS_U32 | RCM_SRIE_SSW_INT_DIS_U32 |
     RCM_SRIE_LOCKUP_INT_DIS_U32 | RCM_SRIE_JTAG_INT_DIS_U32 | RCM_SRIE_GIE_INT_DIS_U32 |
     RCM_SRIE_PIN_INT_DIS_U32 | RCM_SRIE_WDOG_INT_DIS_U32 | RCM_SRIE_CMU_INT_DIS_U32 |
     RCM_SRIE_LOL_INT_DIS_U32 | RCM_SRIE_LOC_INT_DIS_U32 | RCM_SRIE_DELAY_10_LPO_CYCLES_U32)};
...
static const Power_Ip_AEC_ConfigType Power_Ip_AEC_ConfigPB_VS_0 = {
    (AEC_AE_RSTGEN_CFG_REGS_OTP_DISABLE_U16 | AEC_AE_RSTGEN_CFG_CANPHY_DISABLE_U16 |
     AEC_AE_RSTGEN_CFG_LINPHY_HP_DISABLE_U16 | AEC_AE_RSTGEN_CFG_LINPHY_LP_DISABLE_U16 |
     AEC_AE_RSTGEN_CFG_GDU_DISABLE_U16 | AEC_AE_RSTGEN_CFG_HVI_DISABLE_U16 |
     AEC_AE_RSTGEN_CFG_DPGA_DISABLE_U16 | AEC_AE_RSTGEN_CFG_TEMPSENSOR_DISABLE_U16 |
...
static const Power_Ip_PMC_ConfigType Power_Ip_PMC_ConfigPB_VS_0 = {
    /* Low Voltage Detect Status and Control 1 Register (PMC_LVDSC1). This register only exist on
       1xx series of devices */
    (PMC_LVDSC1_LVD_DISABLE_U8 | PMC_LVDSC1_LVDRE_DISABLE_U8),
    (PMC_LVDSC2_LVW_DISABLE_U8),
    /* Regulator Status and Control Register (PMC_REGSC) */
    (PMC_REGSC_LPO_ENABLE_U8 | PMC_REGSC_CLKBIAS_ENABLE_U8 | PMC_REGSC_BIAS_DISABLE_U8),
 ...
 *
 */
static const Power_Ip_SMC_ConfigType Power_Ip_SMC_ConfigPB_VS_0 = {
    /* Allowed modes */
