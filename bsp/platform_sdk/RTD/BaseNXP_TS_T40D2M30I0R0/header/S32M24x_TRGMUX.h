...
/*!
 * @file S32M24x_TRGMUX.h
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_TRGMUX
 *
...
#if !defined(S32M24x_TRGMUX_H_)  /* Check if memory map has not been already included */
#define S32M24x_TRGMUX_H_
...
typedef struct {
  __IO uint32_t TRGMUXn[TRGMUX_TRGMUXn_COUNT];     /**< TRGMUX DMAMUX0 Register..TRGMUX LPTMR0 Register, array offset: 0x0, array step: 0x4, valid indices: [0-4, 7, 10-15, 17-21, 23-25] */
...
#endif  /* #if !defined(S32M24x_TRGMUX_H_) */
