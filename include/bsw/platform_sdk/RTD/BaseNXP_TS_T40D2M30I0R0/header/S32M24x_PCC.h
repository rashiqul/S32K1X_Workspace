...
typedef struct {
  __IO uint32_t PCCn[PCC_PCCn_COUNT];              /**< PCC FTFM Register..PCC CMP0 Register, array offset: 0x0, array step: 0x4, valid indices: [32-33, 36-39, 44-46, 49-50, 54-59, 61, 64, 73-77, 90, 97, 102, 106-108, 115] */
