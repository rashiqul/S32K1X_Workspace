 ...
 * @version 1.5
 * @date 2024-08-01
 * @brief Peripheral Access Layer for S32M24x_PDB
 *
...
#if !defined(S32M24x_PDB_H_)  /* Check if memory map has not been already included */
#define S32M24x_PDB_H_
...
typedef struct {
  ...
  struct PDB_CH {                                  /* offset: 0x10, array step: 0x28 */
    __IO uint32_t C1;                                /**< Channel n Control register 1, array offset: 0x10, array step: 0x28, available only on: PDB0 (missing on PDB1) */
    __IO uint32_t S;                                 /**< Channel n Status register, array offset: 0x14, array step: 0x28, available only on: PDB0 (missing on PDB1) */
    __IO uint32_t DLY[PDB_DLY_COUNT];             /**< Channel n Delay 0 register..Channel n Delay 1 register, array offset: 0x18, array step: index*0x28, index2*0x4, available only on: PDB0 (missing on PDB1) */
    uint8_t RESERVED_0[24];
  } CH[PDB_CH_COUNT];
  uint8_t RESERVED_0[304];
  __IO uint32_t POEN;                              /**< Pulse-Out n Enable register, offset: 0x190 */
  union {                                          /* offset: 0x194, array step: 0x4 */
    struct PDB_POnDLY_ACCESS16BIT {                  /* offset: 0x194, array step: 0x4 */
      __IO uint16_t DLY2;                            /**< PDB_DLY2 register, array offset: 0x194, array step: 0x4 */
      __IO uint16_t DLY1;                            /**< PDB_DLY1 register, array offset: 0x196, array step: 0x4 */
    } ACCESS16BIT;
...
#endif  /* #if !defined(S32M24x_PDB_H_) */
